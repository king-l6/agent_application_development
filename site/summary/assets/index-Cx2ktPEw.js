...
* @license MIT
**/function Js(e){const t=Object.create(null);for(const s of e.split(","))t[s]=1;return s=>s in t}const z={},at=[],Ie=()=>{},Zn=()=>!1,us=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&(e.charCodeAt(2)>122||e.charCodeAt(2)<97),ds=e=>e.startsWith("onUpdate:"),ae=Object.assign,Ys=(e,t)=>{const s=e.indexOf(t);s>-1&&e.splice(s,1)},cr=Object.prototype.hasOwnProperty,B=(e,t)=>cr.call(e,t),O=Array.isArray,lt=e=>$t(e)==="[object Map]",ps=e=>$t(e)==="[object Set]",vn=e=>$t(e)==="[object Date]",j=e=>typeof e=="function",ee=e=>typeof e=="string",qe=e=>typeof e=="symbol",U=e=>e!==null&&typeof e=="object",ei=e=>(U(e)||j(e))&&j(e.then)&&j(e.catch),ti=Object.prototype.toString,$t=e=>ti.call(e),ur=e=>$t(e).slice(8,-1),si=e=>$t(e)==="[object Object]",Xs=e=>ee(e)&&e!=="NaN"&&e[0]!=="-"&&""+parseInt(e,10)===e,St=Js(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),fs=e=>{const t=Object.create(null);return(s=>t[s]||(t[s]=e(s)))},dr=/-\w/g,_e=fs(e=>e.replace(dr,t=>t.slice(1).toUpperCase())),pr=/\B([A-Z])/g,nt=fs(e=>e.replace(pr,"-$1").toLowerCase()),ni=fs(e=>e.charAt(0).toUpperCase()+e.slice(1)),Ss=fs(e=>e?`on${ni(e)}`:""),Re=(e,t)=>!Object.is(e,t),Qt=(e,...t)=>{for(let s=0;s<e.length;s++)e[s](...t)},ii=(e,t,s,n=!1)=>{Object.defineProperty(e,t,{configurable:!0,enumerable:!1,writable:n,value:s})},ms=e=>{const t=parseFloat(e);return isNaN(t)?e:t};let yn;const hs=()=>yn||(yn=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function Ft(e){if(O(e)){const t={};for(let s=0;s<e.length;s++){const n=e[s],i=ee(n)?gr(n):Ft(n);if(i)for(const r in i)t[r]=i[r]}return t}else if(ee(e)||U(e))return e}const fr=/;(?![^(]*\))/g,mr=/:([^]+)/,hr=/\/\*[^]*?\*\//g;function gr(e){const t={};return e.replace(hr,"").split(fr).forEach(s=>{if(s){const n=s.split(mr);n.length>1&&(t[n[0].trim()]=n[1].trim())}}),t}function Ee(e){let t="";if(ee(e))t=e;else if(O(e))for(let s=0;s<e.length;s++){const n=Ee(e[s]);n&&(t+=n+" ")}else if(U(e))for(const s in e)e[s]&&(t+=s+" ");return t.trim()}const _r="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",vr=Js(_r);function ri(e){return!!e||e===""}function yr(e,t){if(e.length!==t.length)return!1;let s=!0;for(let n=0;s&&n<e.length;n++)s=Gt(e[n],t[n]);return s}function Gt(e,t){if(e===t)return!0;let s=vn(e),n=vn(t);if(s||n)return s&&n?e.getTime()===t.getTime():!1;if(s=qe(e),n=qe(t),s||n)return e===t;if(s=O(e),n=O(t),s||n)return s&&n?yr(e,t):!1;if(s=U(e),n=U(t),s||n){if(!s||!n)return!1;const i=Object.keys(e).length,r=Object.keys(t).length;if(i!==r)return!1;for(const o in e){const a=e.hasOwnProperty(o),l=t.hasOwnProperty(o);if(a&&!l||!a&&l||!Gt(e[o],t[o]))return!1}}return String(e)===String(t)}function br(e,t){return e.findIndex(s=>Gt(s,t))}const oi=e=>!!(e&&e.__v_isRef===!0),M=e=>ee(e)?e:e==null?"":O(e)||U(e)&&(e.toString===ti||!j(e.toString))?oi(e)?M(e.value):JSON.stringify(e,ai,2):String(e),ai=(e,t)=>oi(t)?ai(e,t.value):lt(t)?{[`Map(${t.size})`]:[...t.entries()].reduce((s,[n,i],r)=>(s[Ts(n,r)+" =>"]=i,s),{})}:ps(t)?{[`Set(${t.size})`]:[...t.values()].map(s=>Ts(s))}:qe(t)?Ts(t):U(t)&&!O(t)&&!si(t)?String(t):t,Ts=(e,t="")=>{var s;return qe(e)?`Symbol(${(s=e.description)!=null?s:t})`:e};/**
* @vue/reactivity v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let ie;class xr{constructor(t=!1){this.detached=t,this._active=!0,this._on=0,this.effects=[],this.cleanups=[],this._isPaused=!1,this._warnOnRun=!0,this.__v_skip=!0,!t&&ie&&(ie.active?(this.parent=ie,this.index=(ie.scopes||(ie.scopes=[])).push(this)-1):(this._active=!1,this._warnOnRun=!1))}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let t,s;if(this.scopes)for(t=0,s=this.scopes.length;t<s;t++)this.scopes[t].pause();for(t=0,s=this.effects.length;t<s;t++)this.effects[t].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let t,s;if(this.scopes)for(t=0,s=this.scopes.length;t<s;t++)this.scopes[t].resume();for(t=0,s=this.effects.length;t<s;t++)this.effects[t].resume()}}run(t){if(this._active){const s=ie;try{return ie=this,t()}finally{ie=s}}}on(){++this._on===1&&(this.prevScope=ie,ie=this)}off(){if(this._on>0&&--this._on===0){if(ie===this)ie=this.prevScope;else{let t=ie;for(;t;){if(t.prevScope===this){t.prevScope=this.prevScope;break}t=t.prevScope}}this.prevScope=void 0}}stop(t){if(this._active){this._active=!1;let s,n;for(s=0,n=this.effects.length;s<n;s++)this.effects[s].stop();for(this.effects.length=0,s=0,n=this.cleanups.length;s<n;s++)this.cleanups[s]();if(this.cleanups.length=0,this.scopes){for(s=0,n=this.scopes.length;s<n;s++)this.scopes[s].stop(!0);this.scopes.length=0}if(!this.detached&&this.parent&&!t){const i=this.parent.scopes.pop();i&&i!==this&&(this.parent.scopes[this.index]=i,i.index=this.index)}this.parent=void 0}}}function kr(){return ie}let Y;const Ps=new WeakSet;class li{constructor(t){this.fn=t,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.next=void 0,this.cleanup=void 0,this.scheduler=void 0,ie&&(ie.active?ie.effects.push(this):this.flags&=-2)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,Ps.has(this)&&(Ps.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||ui(this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,bn(this),di(this);const t=Y,s=ve;Y=this,ve=!0;try{return this.fn()}finally{pi(this),Y=t,ve=s,this.flags&=-3}}stop(){if(this.flags&1){for(let t=this.deps;t;t=t.nextDep)en(t);this.deps=this.depsTail=void 0,bn(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?Ps.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){Ns(this)&&this.run()}get dirty(){return Ns(this)}}let ci=0,Tt,Pt;function ui(e,t=!1){if(e.flags|=8,t){e.next=Pt,Pt=e;return}e.next=Tt,Tt=e}function Qs(){ci++}function Zs(){if(--ci>0)return;if(Pt){let t=Pt;for(Pt=void 0;t;){const s=t.next;t.next=void 0,t.flags&=-9,t=s}}let e;for(;Tt;){let t=Tt;for(Tt=void 0;t;){const s=t.next;if(t.next=void 0,t.flags&=-9,t.flags&1)try{t.trigger()}catch(n){e||(e=n)}t=s}}if(e)throw e}function di(e){for(let t=e.deps;t;t=t.nextDep)t.version=-1,t.prevActiveLink=t.dep.activeLink,t.dep.activeLink=t}function pi(e){let t,s=e.depsTail,n=s;for(;n;){const i=n.prevDep;n.version===-1?(n===s&&(s=i),en(n),Lr(n)):t=n,n.dep.activeLink=n.prevActiveLink,n.prevActiveLink=void 0,n=i}e.deps=t,e.depsTail=s}function Ns(e){for(let t=e.deps;t;t=t.nextDep)if(t.dep.version!==t.version||t.dep.computed&&(fi(t.dep.computed)||t.dep.version!==t.version))return!0;return!!e._dirty}function fi(e){if(e.flags&4&&!(e.flags&16)||(e.flags&=-17,e.globalVersion===Ot)||(e.globalVersion=Ot,!e.isSSR&&e.flags&128&&(!e.deps&&!e._dirty||!Ns(e))))return;e.flags|=2;const t=e.dep,s=Y,n=ve;Y=e,ve=!0;try{di(e);const i=e.fn(e._value);(t.version===0||Re(i,e._value))&&(e.flags|=128,e._value=i,t.version++)}catch(i){throw t.version++,i}finally{Y=s,ve=n,pi(e),e.flags&=-3}}function en(e,t=!1){const{dep:s,prevSub:n,nextSub:i}=e;if(n&&(n.nextSub=i,e.prevSub=void 0),i&&(i.prevSub=n,e.nextSub=void 0),s.subs===e&&(s.subs=n,!n&&s.computed)){s.computed.flags&=-5;for(let r=s.computed.deps;r;r=r.nextDep)en(r,!0)}!t&&!--s.sc&&s.map&&s.map.delete(s.key)}function Lr(e){const{prevDep:t,nextDep:s}=e;t&&(t.nextDep=s,e.prevDep=void 0),s&&(s.prevDep=t,e.nextDep=void 0)}let ve=!0;const mi=[];function Ge(){mi.push(ve),ve=!1}function He(){const e=mi.pop();ve=e===void 0?!0:e}function bn(e){const{cleanup:t}=e;if(e.cleanup=void 0,t){const s=Y;Y=void 0;try{t()}finally{Y=s}}}let Ot=0;class Ar{constructor(t,s){this.sub=t,this.dep=s,this.version=s.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}}class tn{constructor(t){this.computed=t,this.version=0,this.activeLink=void 0,this.subs=void 0,this.map=void 0,this.key=void 0,this.sc=0,this.__v_skip=!0}track(t){if(!Y||!ve||Y===this.computed)return;let s=this.activeLink;if(s===void 0||s.sub!==Y)s=this.activeLink=new Ar(Y,this),Y.deps?(s.prevDep=Y.depsTail,Y.depsTail.nextDep=s,Y.depsTail=s):Y.deps=Y.depsTail=s,hi(s);else if(s.version===-1&&(s.version=this.version,s.nextDep)){const n=s.nextDep;n.prevDep=s.prevDep,s.prevDep&&(s.prevDep.nextDep=n),s.prevDep=Y.depsTail,s.nextDep=void 0,Y.depsTail.nextDep=s,Y.depsTail=s,Y.deps===s&&(Y.deps=n)}return s}trigger(t){this.version++,Ot++,this.notify(t)}notify(t){Qs();try{for(let s=this.subs;s;s=s.prevSub)s.sub.notify()&&s.sub.dep.notify()}finally{Zs()}}}function hi(e){if(e.dep.sc++,e.sub.flags&4){const t=e.dep.computed;if(t&&!e.dep.subs){t.flags|=20;for(let n=t.deps;n;n=n.nextDep)hi(n)}const s=e.dep.subs;s!==e&&(e.prevSub=s,s&&(s.nextSub=e)),e.dep.subs=e}}const Ds=new WeakMap,tt=Symbol(""),$s=Symbol(""),qt=Symbol("");function re(e,t,s){if(ve&&Y){let n=Ds.get(e);n||Ds.set(e,n=new Map);let i=n.get(s);i||(n.set(s,i=new tn),i.map=n,i.key=s),i.track()}}function $e(e,t,s,n,i,r){const o=Ds.get(e);if(!o){Ot++;return}const a=l=>{l&&l.trigger()};if(Qs(),t==="clear")o.forEach(a);else{const l=O(e),d=l&&Xs(s);if(l&&s==="length"){const u=Number(n);o.forEach((f,A)=>{(A==="length"||A===qt||!qe(A)&&A>=u)&&a(f)})}else switch((s!==void 0||o.has(void 0))&&a(o.get(s)),d&&a(o.get(qt)),t){case"add":l?d&&a(o.get("length")):(a(o.get(tt)),lt(e)&&a(o.get($s)));break;case"delete":l||(a(o.get(tt)),lt(e)&&a(o.get($s)));break;case"set":lt(e)&&a(o.get(tt));break}}Zs()}function it(e){const t=V(e);return t===e?t:(re(t,"iterate",qt),ge(e)?t:t.map(ye))}function gs(e){return re(e=V(e),"iterate",qt),e}function Me(e,t){return Ve(e)?pt(st(e)?ye(t):t):ye(t)}const Sr={__proto__:null,[Symbol.iterator](){return Cs(this,Symbol.iterator,e=>Me(this,e))},concat(...e){return it(this).concat(...e.map(t=>O(t)?it(t):t))},entries(){return Cs(this,"entries",e=>(e[1]=Me(this,e[1]),e))},every(e,t){return je(this,"every",e,t,void 0,arguments)},filter(e,t){return je(this,"filter",e,t,s=>s.map(n=>Me(this,n)),arguments)},find(e,t){return je(this,"find",e,t,s=>Me(this,s),arguments)},findIndex(e,t){return je(this,"findIndex",e,t,void 0,arguments)},findLast(e,t){return je(this,"findLast",e,t,s=>Me(this,s),arguments)},findLastIndex(e,t){return je(this,"findLastIndex",e,t,void 0,arguments)},forEach(e,t){return je(this,"forEach",e,t,void 0,arguments)},includes(...e){return Ms(this,"includes",e)},indexOf(...e){return Ms(this,"indexOf",e)},join(e){return it(this).join(e)},lastIndexOf(...e){return Ms(this,"lastIndexOf",e)},map(e,t){return je(this,"map",e,t,void 0,arguments)},pop(){return bt(this,"pop")},push(...e){return bt(this,"push",e)},reduce(e,...t){return xn(this,"reduce",e,t)},reduceRight(e,...t){return xn(this,"reduceRight",e,t)},shift(){return bt(this,"shift")},some(e,t){return je(this,"some",e,t,void 0,arguments)},splice(...e){return bt(this,"splice",e)},toReversed(){return it(this).toReversed()},toSorted(e){return it(this).toSorted(e)},toSpliced(...e){return it(this).toSpliced(...e)},unshift(...e){return bt(this,"unshift",e)},values(){return Cs(this,"values",e=>Me(this,e))}};function Cs(e,t,s){const n=gs(e),i=n[t]();return n!==e&&!ge(e)&&(i._next=i.next,i.next=()=>{const r=i._next();return r.done||(r.value=s(r.value)),r}),i}const Tr=Array.prototype;function je(e,t,s,n,i,r){const o=gs(e),a=o!==e&&!ge(e),l=o[t];if(l!==Tr[t]){const f=l.apply(e,r);return a?ye(f):f}let d=s;o!==e&&(a?d=function(f,A){return s.call(this,Me(e,f),A,e)}:s.length>2&&(d=function(f,A){return s.call(this,f,A,e)}));const u=l.call(o,d,n);return a&&i?i(u):u}function xn(e,t,s,n){const i=gs(e),r=i!==e&&!ge(e);let o=s,a=!1;i!==e&&(r?(a=n.length===0,o=function(d,u,f){return a&&(a=!1,d=Me(e,d)),s.call(this,d,Me(e,u),f,e)}):s.length>3&&(o=function(d,u,f){return s.call(this,d,u,f,e)}));const l=i[t](o,...n);return a?Me(e,l):l}function Ms(e,t,s){const n=V(e);re(n,"iterate",qt);const i=n[t](...s);return(i===-1||i===!1)&&rn(s[0])?(s[0]=V(s[0]),n[t](...s)):i}function bt(e,t,s=[]){Ge(),Qs();const n=V(e)[t].apply(e,s);return Zs(),He(),n}const Pr=Js("__proto__,__v_isRef,__isVue"),gi=new Set(Object.getOwnPropertyNames(Symbol).filter(e=>e!=="arguments"&&e!=="caller").map(e=>Symbol[e]).filter(qe));function Cr(e){qe(e)||(e=String(e));const t=V(this);return re(t,"has",e),t.hasOwnProperty(e)}class _i{constructor(t=!1,s=!1){this._isReadonly=t,this._isShallow=s}get(t,s,n){if(s==="__v_skip")return t.__v_skip;const i=this._isReadonly,r=this._isShallow;if(s==="__v_isReactive")return!i;if(s==="__v_isReadonly")return i;if(s==="__v_isShallow")return r;if(s==="__v_raw")return n===(i?r?Dr:xi:r?bi:yi).get(t)||Object.getPrototypeOf(t)===Object.getPrototypeOf(n)?t:void 0;const o=O(t);if(!i){let l;if(o&&(l=Sr[s]))return l;if(s==="hasOwnProperty")return Cr}const a=Reflect.get(t,s,oe(t)?t:n);if((qe(s)?gi.has(s):Pr(s))||(i||re(t,"get",s),r))return a;if(oe(a)){const l=o&&Xs(s)?a:a.value;return i&&U(l)?Gs(l):l}return U(a)?i?Gs(a):_s(a):a}}class vi extends _i{constructor(t=!1){super(!1,t)}set(t,s,n,i){let r=t[s];const o=O(t)&&Xs(s);if(!this._isShallow){const d=Ve(r);if(!ge(n)&&!Ve(n)&&(r=V(r),n=V(n)),!o&&oe(r)&&!oe(n))return d||(r.value=n),!0}const a=o?Number(s)<t.length:B(t,s),l=Reflect.set(t,s,n,oe(t)?t:i);return t===V(i)&&(a?Re(n,r)&&$e(t,"set",s,n):$e(t,"add",s,n)),l}deleteProperty(t,s){const n=B(t,s);t[s];const i=Reflect.deleteProperty(t,s);return i&&n&&$e(t,"delete",s,void 0),i}has(t,s){const n=Reflect.has(t,s);return(!qe(s)||!gi.has(s))&&re(t,"has",s),n}ownKeys(t){return re(t,"iterate",O(t)?"length":tt),Reflect.ownKeys(t)}}class Mr extends _i{constructor(t=!1){super(!0,t)}set(t,s){return!0}deleteProperty(t,s){return!0}}const wr=new vi,Rr=new Mr,Ir=new vi(!0);const Fs=e=>e,Jt=e=>Reflect.getPrototypeOf(e);function Er(e,t,s){return function(...n){const i=this.__v_raw,r=V(i),o=lt(r),a=e==="entries"||e===Symbol.iterator&&o,l=e==="keys"&&o,d=i[e](...n),u=s?Fs:t?pt:ye;return!t&&re(r,"iterate",l?$s:tt),ae(Object.create(d),{next(){const{value:f,done:A}=d.next();return A?{value:f,done:A}:{value:a?[u(f[0]),u(f[1])]:u(f),done:A}}})}}function Yt(e){return function(...t){return e==="delete"?!1:e==="clear"?void 0:this}}function Or(e,t){const s={get(i){const r=this.__v_raw,o=V(r),a=V(i);e||(Re(i,a)&&re(o,"get",i),re(o,"get",a));const{has:l}=Jt(o),d=t?Fs:e?pt:ye;if(l.call(o,i))return d(r.get(i));if(l.call(o,a))return d(r.get(a));r!==o&&r.get(i)},get size(){const i=this.__v_raw;return!e&&re(V(i),"iterate",tt),i.size},has(i){const r=this.__v_raw,o=V(r),a=V(i);return e||(Re(i,a)&&re(o,"has",i),re(o,"has",a)),i===a?r.has(i):r.has(i)||r.has(a)},forEach(i,r){const o=this,a=o.__v_raw,l=V(a),d=t?Fs:e?pt:ye;return!e&&re(l,"iterate",tt),a.forEach((u,f)=>i.call(r,d(u),d(f),o))}};return ae(s,e?{add:Yt("add"),set:Yt("set"),delete:Yt("delete"),clear:Yt("clear")}:{add(i){const r=V(this),o=Jt(r),a=V(i),l=!t&&!ge(i)&&!Ve(i)?a:i;return o.has.call(r,l)||Re(i,l)&&o.has.call(r,i)||Re(a,l)&&o.has.call(r,a)||(r.add(l),$e(r,"add",l,l)),this},set(i,r){!t&&!ge(r)&&!Ve(r)&&(r=V(r));const o=V(this),{has:a,get:l}=Jt(o);let d=a.call(o,i);d||(i=V(i),d=a.call(o,i));const u=l.call(o,i);return o.set(i,r),d?Re(r,u)&&$e(o,"set",i,r):$e(o,"add",i,r),this},delete(i){const r=V(this),{has:o,get:a}=Jt(r);let l=o.call(r,i);l||(i=V(i),l=o.call(r,i)),a&&a.call(r,i);const d=r.delete(i);return l&&$e(r,"delete",i,void 0),d},clear(){const i=V(this),r=i.size!==0,o=i.clear();return r&&$e(i,"clear",void 0,void 0),o}}),["keys","values","entries",Symbol.iterator].forEach(i=>{s[i]=Er(i,e,t)}),s}function sn(e,t){const s=Or(e,t);return(n,i,r)=>i==="__v_isReactive"?!e:i==="__v_isReadonly"?e:i==="__v_raw"?n:Reflect.get(B(s,i)&&i in n?s:n,i,r)}const qr={get:sn(!1,!1)},jr={get:sn(!1,!0)},Nr={get:sn(!0,!1)};const yi=new WeakMap,bi=new WeakMap,xi=new WeakMap,Dr=new WeakMap;function $r(e){switch(e){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function _s(e){return Ve(e)?e:nn(e,!1,wr,qr,yi)}function Fr(e){return nn(e,!1,Ir,jr,bi)}function Gs(e){return nn(e,!0,Rr,Nr,xi)}function nn(e,t,s,n,i){if(!U(e)||e.__v_raw&&!(t&&e.__v_isReactive)||e.__v_skip||!Object.isExtensible(e))return e;const r=i.get(e);if(r)return r;const o=$r(ur(e));if(o===0)return e;const a=new Proxy(e,o===2?n:s);return i.set(e,a),a}function st(e){return Ve(e)?st(e.__v_raw):!!(e&&e.__v_isReactive)}function Ve(e){return!!(e&&e.__v_isReadonly)}function ge(e){return!!(e&&e.__v_isShallow)}function rn(e){return e?!!e.__v_raw:!1}function V(e){const t=e&&e.__v_raw;return t?V(t):e}function Gr(e){return!B(e,"__v_skip")&&Object.isExtensible(e)&&ii(e,"__v_skip",!0),e}const ye=e=>U(e)?_s(e):e,pt=e=>U(e)?Gs(e):e;function oe(e){return e?e.__v_isRef===!0:!1}function ft(e){return Hr(e,!1)}function Hr(e,t){return oe(e)?e:new Vr(e,t)}class Vr{constructor(t,s){this.dep=new tn,this.__v_isRef=!0,this.__v_isShallow=!1,this._rawValue=s?t:V(t),this._value=s?t:ye(t),this.__v_isShallow=s}get value(){return this.dep.track(),this._value}set value(t){const s=this._rawValue,n=this.__v_isShallow||ge(t)||Ve(t);t=n?t:V(t),Re(t,s)&&(this._rawValue=t,this._value=n?t:ye(t),this.dep.trigger())}}function mt(e){return oe(e)?e.value:e}const Br={get:(e,t,s)=>t==="__v_raw"?e:mt(Reflect.get(e,t,s)),set:(e,t,s,n)=>{const i=e[t];return oe(i)&&!oe(s)?(i.value=s,!0):Reflect.set(e,t,s,n)}};function ki(e){return st(e)?e:new Proxy(e,Br)}class Wr{constructor(t,s,n){this.fn=t,this.setter=s,this._value=void 0,this.dep=new tn(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=Ot-1,this.next=void 0,this.effect=this,this.__v_isReadonly=!s,this.isSSR=n}notify(){if(this.flags|=16,!(this.flags&8)&&Y!==this)return ui(this,!0),!0}get value(){const t=this.dep.track();return fi(this),t&&(t.version=this.dep.version),this._value}set value(t){this.setter&&this.setter(t)}}function Ur(e,t,s=!1){let n,i;return j(e)?n=e:(n=e.get,i=e.set),new Wr(n,i,s)}const Xt={},ts=new WeakMap;let Ze;function Kr(e,t=!1,s=Ze){if(s){let n=ts.get(s);n||ts.set(s,n=[]),n.push(e)}}function zr(e,t,s=z){const{immediate:n,deep:i,once:r,scheduler:o,augmentJob:a,call:l}=s,d=C=>i?C:ge(C)||i===!1||i===0?Fe(C,1):Fe(C);let u,f,A,P,$=!1,I=!1;if(oe(e)?(f=()=>e.value,$=ge(e)):st(e)?(f=()=>d(e),$=!0):O(e)?(I=!0,$=e.some(C=>st(C)||ge(C)),f=()=>e.map(C=>{if(oe(C))return C.value;if(st(C))return d(C);if(j(C))return l?l(C,2):C()})):j(e)?t?f=l?()=>l(e,2):e:f=()=>{if(A){Ge();try{A()}finally{He()}}const C=Ze;Ze=u;try{return l?l(e,3,[P]):e(P)}finally{Ze=C}}:f=Ie,t&&i){const C=f,te=i===!0?1/0:i;f=()=>Fe(C(),te)}const G=kr(),q=()=>{u.stop(),G&&G.active&&Ys(G.effects,u)};if(r&&t){const C=t;t=(...te)=>{const xe=C(...te);return q(),xe}}let F=I?new Array(e.length).fill(Xt):Xt;const N=C=>{if(!(!(u.flags&1)||!u.dirty&&!C))if(t){const te=u.run();if(C||i||$||(I?te.some((xe,ke)=>Re(xe,F[ke])):Re(te,F))){A&&A();const xe=Ze;Ze=u;try{const ke=[te,F===Xt?void 0:I&&F[0]===Xt?[]:F,P];F=te,l?l(t,3,ke):t(...ke)}finally{Ze=xe}}}else u.run()};return a&&a(N),u=new li(f),u.scheduler=o?()=>o(N,!1):N,P=C=>Kr(C,!1,u),A=u.onStop=()=>{const C=ts.get(u);if(C){if(l)l(C,4);else for(const te of C)te();ts.delete(u)}},t?n?N(!0):F=u.run():o?o(N.bind(null,!0),!0):u.run(),q.pause=u.pause.bind(u),q.resume=u.resume.bind(u),q.stop=q,q}function Fe(e,t=1/0,s){if(t<=0||!U(e)||e.__v_skip||(s=s||new Map,(s.get(e)||0)>=t))return e;if(s.set(e,t),t--,oe(e))Fe(e.value,t,s);else if(O(e))for(let n=0;n<e.length;n++)Fe(e[n],t,s);else if(ps(e)||lt(e))e.forEach(n=>{Fe(n,t,s)});else if(si(e)){for(const n in e)Fe(e[n],t,s);for(const n of Object.getOwnPropertySymbols(e))Object.prototype.propertyIsEnumerable.call(e,n)&&Fe(e[n],t,s)}return e}/**
* @vue/runtime-core v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function Ht(e,t,s,n){try{return n?e(...n):e()}catch(i){vs(i,t,s)}}function be(e,t,s,n){if(j(e)){const i=Ht(e,t,s,n);return i&&ei(i)&&i.catch(r=>{vs(r,t,s)}),i}if(O(e)){const i=[];for(let r=0;r<e.length;r++)i.push(be(e[r],t,s,n));return i}}function vs(e,t,s,n=!0){const i=t?t.vnode:null,{errorHandler:r,throwUnhandledErrorInProduction:o}=t&&t.appContext.config||z;if(t){let a=t.parent;const l=t.proxy,d=`https://vuejs.org/error-reference/#runtime-${s}`;for(;a;){const u=a.ec;if(u){for(let f=0;f<u.length;f++)if(u[f](e,l,d)===!1)return}a=a.parent}if(r){Ge(),Ht(r,null,10,[e,l,d]),He();return}}Jr(e,s,i,n,o)}function Jr(e,t,s,n=!0,i=!1){if(i)throw e;console.error(e)}const ue=[];let Ce=-1;const ct=[];let Ue=null,rt=0;const Li=Promise.resolve();let ss=null;function Ai(e){const t=ss||Li;return e?t.then(this?e.bind(this):e):t}function Yr(e){let t=Ce+1,s=ue.length;for(;t<s;){const n=t+s>>>1,i=ue[n],r=jt(i);r<e||r===e&&i.flags&2?t=n+1:s=n}return t}function on(e){if(!(e.flags&1)){const t=jt(e),s=ue[ue.length-1];!s||!(e.flags&2)&&t>=jt(s)?ue.push(e):ue.splice(Yr(t),0,e),e.flags|=1,Si()}}function Si(){ss||(ss=Li.then(Pi))}function Xr(e){O(e)?ct.push(...e):Ue&&e.id===-1?Ue.splice(rt+1,0,e):e.flags&1||(ct.push(e),e.flags|=1),Si()}function kn(e,t,s=Ce+1){for(;s<ue.length;s++){const n=ue[s];if(n&&n.flags&2){if(e&&n.id!==e.uid)continue;ue.splice(s,1),s--,n.flags&4&&(n.flags&=-2),n(),n.flags&4||(n.flags&=-2)}}}function Ti(e){if(ct.length){const t=[...new Set(ct)].sort((s,n)=>jt(s)-jt(n));if(ct.length=0,Ue){Ue.push(...t);return}for(Ue=t,rt=0;rt<Ue.length;rt++){const s=Ue[rt];s.flags&4&&(s.flags&=-2),s.flags&8||s(),s.flags&=-2}Ue=null,rt=0}}const jt=e=>e.id==null?e.flags&2?-1:1/0:e.id;function Pi(e){try{for(Ce=0;Ce<ue.length;Ce++){const t=ue[Ce];t&&!(t.flags&8)&&(t.flags&4&&(t.flags&=-2),Ht(t,t.i,t.i?15:14),t.flags&4||(t.flags&=-2))}}finally{for(;Ce<ue.length;Ce++){const t=ue[Ce];t&&(t.flags&=-2)}Ce=-1,ue.length=0,Ti(),ss=null,(ue.length||ct.length)&&Pi()}}let he=null,Ci=null;function ns(e){const t=he;return he=e,Ci=e&&e.type.__scopeId||null,t}function Qr(e,t=he,s){if(!t||e._n)return e;const n=(...i)=>{n._d&&En(-1);const r=ns(t);let o;try{o=e(...i)}finally{ns(r),n._d&&En(1)}return o};return n._n=!0,n._c=!0,n._d=!0,n}function Ct(e,t){if(he===null)return e;const s=ks(he),n=e.dirs||(e.dirs=[]);for(let i=0;i<t.length;i++){let[r,o,a,l=z]=t[i];r&&(j(r)&&(r={mounted:r,updated:r}),r.deep&&Fe(o),n.push({dir:r,instance:s,value:o,oldValue:void 0,arg:a,modifiers:l}))}return e}function Xe(e,t,s,n){const i=e.dirs,r=t&&t.dirs;for(let o=0;o<i.length;o++){const a=i[o];r&&(a.oldValue=r[o].value);let l=a.dir[n];l&&(Ge(),be(l,s,8,[e.el,a,e,t]),He())}}function Zr(e,t){if(de){let s=de.provides;const n=de.parent&&de.parent.provides;n===s&&(s=de.provides=Object.create(n)),s[e]=t}}function Zt(e,t,s=!1){const n=Qo();if(n||ut){let i=ut?ut._context.provides:n?n.parent==null||n.ce?n.vnode.appContext&&n.vnode.appContext.provides:n.parent.provides:void 0;if(i&&e in i)return i[e];if(arguments.length>1)return s&&j(t)?t.call(n&&n.proxy):t}}const eo=Symbol.for("v-scx"),to=()=>Zt(eo);function ws(e,t,s){return Mi(e,t,s)}function Mi(e,t,s=z){const{immediate:n,deep:i,flush:r,once:o}=s,a=ae({},s),l=t&&n||!t&&r!=="post";let d;if(Dt){if(r==="sync"){const P=to();d=P.__watcherHandles||(P.__watcherHandles=[])}else if(!l){const P=()=>{};return P.stop=Ie,P.resume=Ie,P.pause=Ie,P}}const u=de;a.call=(P,$,I)=>be(P,u,$,I);let f=!1;r==="post"?a.scheduler=P=>{pe(P,u&&u.suspense)}:r!=="sync"&&(f=!0,a.scheduler=(P,$)=>{$?P():on(P)}),a.augmentJob=P=>{t&&(P.flags|=4),f&&(P.flags|=2,u&&(P.id=u.uid,P.i=u))};const A=zr(e,t,a);return Dt&&(d?d.push(A):l&&A()),A}function so(e,t,s){const n=this.proxy,i=ee(e)?e.includes(".")?wi(n,e):()=>n[e]:e.bind(n,n);let r;j(t)?r=t:(r=t.handler,s=t);const o=Vt(this),a=Mi(i,r.bind(n),s);return o(),a}function wi(e,t){const s=t.split(".");return()=>{let n=e;for(let i=0;i<s.length&&n;i++)n=n[s[i]];return n}}const no=Symbol("_vte"),io=e=>e.__isTeleport,Rs=Symbol("_leaveCb");function an(e,t){e.shapeFlag&6&&e.component?(e.transition=t,an(e.component.subTree,t)):e.shapeFlag&128?(e.ssContent.transition=t.clone(e.ssContent),e.ssFallback.transition=t.clone(e.ssFallback)):e.transition=t}function Ri(e){e.ids=[e.ids[0]+e.ids[2]+++"-",0,0]}function Ln(e,t){let s;return!!((s=Object.getOwnPropertyDescriptor(e,t))&&!s.configurable)}const is=new WeakMap;function Mt(e,t,s,n,i=!1){if(O(e)){e.forEach((I,G)=>Mt(I,t&&(O(t)?t[G]:t),s,n,i));return}if(wt(n)&&!i){n.shapeFlag&512&&n.type.__asyncResolved&&n.component.subTree.component&&Mt(e,t,s,n.component.subTree);return}const r=n.shapeFlag&4?ks(n.component):n.el,o=i?null:r,{i:a,r:l}=e,d=t&&t.r,u=a.refs===z?a.refs={}:a.refs,f=a.setupState,A=V(f),P=f===z?Zn:I=>Ln(u,I)?!1:B(A,I),$=(I,G)=>!(G&&Ln(u,G));if(d!=null&&d!==l){if(An(t),ee(d))u[d]=null,P(d)&&(f[d]=null);else if(oe(d)){const I=t;$(d,I.k)&&(d.value=null),I.k&&(u[I.k]=null)}}if(j(l))Ht(l,a,12,[o,u]);else{const I=ee(l),G=oe(l);if(I||G){const q=()=>{if(e.f){const F=I?P(l)?f[l]:u[l]:$()||!e.k?l.value:u[e.k];if(i)O(F)&&Ys(F,r);else if(O(F))F.includes(r)||F.push(r);else if(I)u[l]=[r],P(l)&&(f[l]=u[l]);else{const N=[r];$(l,e.k)&&(l.value=N),e.k&&(u[e.k]=N)}}else I?(u[l]=o,P(l)&&(f[l]=o)):G&&($(l,e.k)&&(l.value=o),e.k&&(u[e.k]=o))};if(o){const F=()=>{q(),is.delete(e)};F.id=-1,is.set(e,F),pe(F,s)}else An(e),q()}}}function An(e){const t=is.get(e);t&&(t.flags|=8,is.delete(e))}hs().requestIdleCallback;hs().cancelIdleCallback;const wt=e=>!!e.type.__asyncLoader,Ii=e=>e.type.__isKeepAlive;function ro(e,t){Ei(e,"a",t)}function oo(e,t){Ei(e,"da",t)}function Ei(e,t,s=de){const n=e.__wdc||(e.__wdc=()=>{let i=s;for(;i;){if(i.isDeactivated)return;i=i.parent}return e()});if(ys(t,n,s),s){let i=s.parent;for(;i&&i.parent;)Ii(i.parent.vnode)&&ao(n,t,s,i),i=i.parent}}function ao(e,t,s,n){const i=ys(t,e,n,!0);Oi(()=>{Ys(n[t],i)},s)}function ys(e,t,s=de,n=!1){if(s){const i=s[e]||(s[e]=[]),r=t.__weh||(t.__weh=(...o)=>{Ge();const a=Vt(s),l=be(t,s,e,o);return a(),He(),l});return n?i.unshift(r):i.push(r),r}}const Be=e=>(t,s=de)=>{(!Dt||e==="sp")&&ys(e,(...n)=>t(...n),s)},lo=Be("bm"),co=Be("m"),uo=Be("bu"),po=Be("u"),fo=Be("bum"),Oi=Be("um"),mo=Be("sp"),ho=Be("rtg"),go=Be("rtc");function _o(e,t=de){ys("ec",e,t)}const vo=Symbol.for("v-ndc");function X(e,t,s,n){let i;const r=s,o=O(e);if(o||ee(e)){const a=o&&st(e);let l=!1,d=!1;a&&(l=!ge(e),d=Ve(e),e=gs(e)),i=new Array(e.length);for(let u=0,f=e.length;u<f;u++)i[u]=t(l?d?pt(ye(e[u])):ye(e[u]):e[u],u,void 0,r)}else if(typeof e=="number"){i=new Array(e);for(let a=0;a<e;a++)i[a]=t(a+1,a,void 0,r)}else if(U(e))if(e[Symbol.iterator])i=Array.from(e,(a,l)=>t(a,l,void 0,r));else{const a=Object.keys(e);i=new Array(a.length);for(let l=0,d=a.length;l<d;l++){const u=a[l];i[l]=t(e[u],u,l,r)}}else i=[];return i}const Hs=e=>e?tr(e)?ks(e):Hs(e.parent):null,Rt=ae(Object.create(null),{$:e=>e,$el:e=>e.vnode.el,$data:e=>e.data,$props:e=>e.props,$attrs:e=>e.attrs,$slots:e=>e.slots,$refs:e=>e.refs,$parent:e=>Hs(e.parent),$root:e=>Hs(e.root),$host:e=>e.ce,$emit:e=>e.emit,$options:e=>ji(e),$forceUpdate:e=>e.f||(e.f=()=>{on(e.update)}),$nextTick:e=>e.n||(e.n=Ai.bind(e.proxy)),$watch:e=>so.bind(e)}),Is=(e,t)=>e!==z&&!e.__isScriptSetup&&B(e,t),yo={get({_:e},t){if(t==="__v_skip")return!0;const{ctx:s,setupState:n,data:i,props:r,accessCache:o,type:a,appContext:l}=e;if(t[0]!=="$"){const A=o[t];if(A!==void 0)switch(A){case 1:return n[t];case 2:return i[t];case 4:return s[t];case 3:return r[t]}else{if(Is(n,t))return o[t]=1,n[t];if(i!==z&&B(i,t))return o[t]=2,i[t];if(B(r,t))return o[t]=3,r[t];if(s!==z&&B(s,t))return o[t]=4,s[t];Vs&&(o[t]=0)}}const d=Rt[t];let u,f;if(d)return t==="$attrs"&&re(e.attrs,"get",""),d(e);if((u=a.__cssModules)&&(u=u[t]))return u;if(s!==z&&B(s,t))return o[t]=4,s[t];if(f=l.config.globalProperties,B(f,t))return f[t]},set({_:e},t,s){const{data:n,setupState:i,ctx:r}=e;return Is(i,t)?(i[t]=s,!0):n!==z&&B(n,t)?(n[t]=s,!0):B(e.props,t)||t[0]==="$"&&t.slice(1)in e?!1:(r[t]=s,!0)},has({_:{data:e,setupState:t,accessCache:s,ctx:n,appContext:i,props:r,type:o}},a){let l;return!!(s[a]||e!==z&&a[0]!=="$"&&B(e,a)||Is(t,a)||B(r,a)||B(n,a)||B(Rt,a)||B(i.config.globalProperties,a)||(l=o.__cssModules)&&l[a])},defineProperty(e,t,s){return s.get!=null?e._.accessCache[t]=0:B(s,"value")&&this.set(e,t,s.value,null),Reflect.defineProperty(e,t,s)}};function Sn(e){return O(e)?e.reduce((t,s)=>(t[s]=null,t),{}):e}let Vs=!0;function bo(e){const t=ji(e),s=e.proxy,n=e.ctx;Vs=!1,t.beforeCreate&&Tn(t.beforeCreate,e,"bc");const{data:i,computed:r,methods:o,watch:a,provide:l,inject:d,created:u,beforeMount:f,mounted:A,beforeUpdate:P,updated:$,activated:I,deactivated:G,beforeDestroy:q,beforeUnmount:F,destroyed:N,unmounted:C,render:te,renderTracked:xe,renderTriggered:ke,errorCaptured:We,serverPrefetch:Bt,expose:ze,inheritAttrs:gt,components:Wt,directives:Ut,filters:Ls}=t;if(d&&xo(d,n,null),o)for(const Z in o){const J=o[Z];j(J)&&(n[Z]=J.bind(s))}if(i){const Z=i.call(s,s);U(Z)&&(e.data=_s(Z))}if(Vs=!0,r)for(const Z in r){const J=r[Z],Je=j(J)?J.bind(s,s):j(J.get)?J.get.bind(s,s):Ie,Kt=!j(J)&&j(J.set)?J.set.bind(s):Ie,Ye=ot({get:Je,set:Kt});Object.defineProperty(n,Z,{enumerable:!0,configurable:!0,get:()=>Ye.value,set:Le=>Ye.value=Le})}if(a)for(const Z in a)qi(a[Z],n,s,Z);if(l){const Z=j(l)?l.call(s):l;Reflect.ownKeys(Z).forEach(J=>{Zr(J,Z[J])})}u&&Tn(u,e,"c");function le(Z,J){O(J)?J.forEach(Je=>Z(Je.bind(s))):J&&Z(J.bind(s))}if(le(lo,f),le(co,A),le(uo,P),le(po,$),le(ro,I),le(oo,G),le(_o,We),le(go,xe),le(ho,ke),le(fo,F),le(Oi,C),le(mo,Bt),O(ze))if(ze.length){const Z=e.exposed||(e.exposed={});ze.forEach(J=>{Object.defineProperty(Z,J,{get:()=>s[J],set:Je=>s[J]=Je,enumerable:!0})})}else e.exposed||(e.exposed={});te&&e.render===Ie&&(e.render=te),gt!=null&&(e.inheritAttrs=gt),Wt&&(e.components=Wt),Ut&&(e.directives=Ut),Bt&&Ri(e)}function xo(e,t,s=Ie){O(e)&&(e=Bs(e));for(const n in e){const i=e[n];let r;U(i)?"default"in i?r=Zt(i.from||n,i.default,!0):r=Zt(i.from||n):r=Zt(i),oe(r)?Object.defineProperty(t,n,{enumerable:!0,configurable:!0,get:()=>r.value,set:o=>r.value=o}):t[n]=r}}function Tn(e,t,s){be(O(e)?e.map(n=>n.bind(t.proxy)):e.bind(t.proxy),t,s)}function qi(e,t,s,n){let i=n.includes(".")?wi(s,n):()=>s[n];if(ee(e)){const r=t[e];j(r)&&ws(i,r)}else if(j(e))ws(i,e.bind(s));else if(U(e))if(O(e))e.forEach(r=>qi(r,t,s,n));else{const r=j(e.handler)?e.handler.bind(s):t[e.handler];j(r)&&ws(i,r,e)}}function ji(e){const t=e.type,{mixins:s,extends:n}=t,{mixins:i,optionsCache:r,config:{optionMergeStrategies:o}}=e.appContext,a=r.get(t);let l;return a?l=a:!i.length&&!s&&!n?l=t:(l={},i.length&&i.forEach(d=>rs(l,d,o,!0)),rs(l,t,o)),U(t)&&r.set(t,l),l}function rs(e,t,s,n=!1){const{mixins:i,extends:r}=t;r&&rs(e,r,s,!0),i&&i.forEach(o=>rs(e,o,s,!0));for(const o in t)if(!(n&&o==="expose")){const a=ko[o]||s&&s[o];e[o]=a?a(e[o],t[o]):t[o]}return e}const ko={data:Pn,props:Cn,emits:Cn,methods:Lt,computed:Lt,beforeCreate:ce,created:ce,beforeMount:ce,mounted:ce,beforeUpdate:ce,updated:ce,beforeDestroy:ce,beforeUnmount:ce,destroyed:ce,unmounted:ce,activated:ce,deactivated:ce,errorCaptured:ce,serverPrefetch:ce,components:Lt,directives:Lt,watch:Ao,provide:Pn,inject:Lo};function Pn(e,t){return t?e?function(){return ae(j(e)?e.call(this,this):e,j(t)?t.call(this,this):t)}:t:e}function Lo(e,t){return Lt(Bs(e),Bs(t))}function Bs(e){if(O(e)){const t={};for(let s=0;s<e.length;s++)t[e[s]]=e[s];return t}return e}function ce(e,t){return e?[...new Set([].concat(e,t))]:t}function Lt(e,t){return e?ae(Object.create(null),e,t):t}function Cn(e,t){return e?O(e)&&O(t)?[...new Set([...e,...t])]:ae(Object.create(null),Sn(e),Sn(t??{})):t}function Ao(e,t){if(!e)return t;if(!t)return e;const s=ae(Object.create(null),e);for(const n in t)s[n]=ce(e[n],t[n]);return s}function Ni(){return{app:null,config:{isNativeTag:Zn,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let So=0;function To(e,t){return function(n,i=null){j(n)||(n=ae({},n)),i!=null&&!U(i)&&(i=null);const r=Ni(),o=new WeakSet,a=[];let l=!1;const d=r.app={_uid:So++,_component:n,_props:i,_container:null,_context:r,_instance:null,version:ia,get config(){return r.config},set config(u){},use(u,...f){return o.has(u)||(u&&j(u.install)?(o.add(u),u.install(d,...f)):j(u)&&(o.add(u),u(d,...f))),d},mixin(u){return r.mixins.includes(u)||r.mixins.push(u),d},component(u,f){return f?(r.components[u]=f,d):r.components[u]},directive(u,f){return f?(r.directives[u]=f,d):r.directives[u]},mount(u,f,A){if(!l){const P=d._ceVNode||Oe(n,i);return P.appContext=r,A===!0?A="svg":A===!1&&(A=void 0),e(P,u,A),l=!0,d._container=u,u.__vue_app__=d,ks(P.component)}},onUnmount(u){a.push(u)},unmount(){l&&(be(a,d._instance,16),e(null,d._container),delete d._container.__vue_app__)},provide(u,f){return r.provides[u]=f,d},runWithContext(u){const f=ut;ut=d;try{return u()}finally{ut=f}}};return d}}let ut=null;const Po=(e,t)=>t==="modelValue"||t==="model-value"?e.modelModifiers:e[`${t}Modifiers`]||e[`${_e(t)}Modifiers`]||e[`${nt(t)}Modifiers`];function Co(e,t,...s){if(e.isUnmounted)return;const n=e.vnode.props||z;let i=s;const r=t.startsWith("update:"),o=r&&Po(n,t.slice(7));o&&(o.trim&&(i=s.map(u=>ee(u)?u.trim():u)),o.number&&(i=s.map(ms)));let a,l=n[a=Ss(t)]||n[a=Ss(_e(t))];!l&&r&&(l=n[a=Ss(nt(t))]),l&&be(l,e,6,i);const d=n[a+"Once"];if(d){if(!e.emitted)e.emitted={};else if(e.emitted[a])return;e.emitted[a]=!0,be(d,e,6,i)}}const Mo=new WeakMap;function Di(e,t,s=!1){const n=s?Mo:t.emitsCache,i=n.get(e);if(i!==void 0)return i;const r=e.emits;let o={},a=!1;if(!j(e)){const l=d=>{const u=Di(d,t,!0);u&&(a=!0,ae(o,u))};!s&&t.mixins.length&&t.mixins.forEach(l),e.extends&&l(e.extends),e.mixins&&e.mixins.forEach(l)}return!r&&!a?(U(e)&&n.set(e,null),null):(O(r)?r.forEach(l=>o[l]=null):ae(o,r),U(e)&&n.set(e,o),o)}function bs(e,t){return!e||!us(t)?!1:(t=t.slice(2).replace(/Once$/,""),B(e,t[0].toLowerCase()+t.slice(1))||B(e,nt(t))||B(e,t))}function Mn(e){const{type:t,vnode:s,proxy:n,withProxy:i,propsOptions:[r],slots:o,attrs:a,emit:l,render:d,renderCache:u,props:f,data:A,setupState:P,ctx:$,inheritAttrs:I}=e,G=ns(e);let q,F;try{if(s.shapeFlag&4){const C=i||n,te=C;q=we(d.call(te,C,u,f,P,A,$)),F=a}else{const C=t;q=we(C.length>1?C(f,{attrs:a,slots:o,emit:l}):C(f,null)),F=t.props?a:wo(a)}}catch(C){It.length=0,vs(C,e,1),q=Oe(Ke)}let N=q;if(F&&I!==!1){const C=Object.keys(F),{shapeFlag:te}=N;C.length&&te&7&&(r&&C.some(ds)&&(F=Ro(F,r)),N=ht(N,F,!1,!0))}return s.dirs&&(N=ht(N,null,!1,!0),N.dirs=N.dirs?N.dirs.concat(s.dirs):s.dirs),s.transition&&an(N,s.transition),q=N,ns(G),q}const wo=e=>{let t;for(const s in e)(s==="class"||s==="style"||us(s))&&((t||(t={}))[s]=e[s]);return t},Ro=(e,t)=>{const s={};for(const n in e)(!ds(n)||!(n.slice(9)in t))&&(s[n]=e[n]);return s};function Io(e,t,s){const{props:n,children:i,component:r}=e,{props:o,children:a,patchFlag:l}=t,d=r.emitsOptions;if(t.dirs||t.transition)return!0;if(s&&l>=0){if(l&1024)return!0;if(l&16)return n?wn(n,o,d):!!o;if(l&8){const u=t.dynamicProps;for(let f=0;f<u.length;f++){const A=u[f];if($i(o,n,A)&&!bs(d,A))return!0}}}else return(i||a)&&(!a||!a.$stable)?!0:n===o?!1:n?o?wn(n,o,d):!0:!!o;return!1}function wn(e,t,s){const n=Object.keys(t);if(n.length!==Object.keys(e).length)return!0;for(let i=0;i<n.length;i++){const r=n[i];if($i(t,e,r)&&!bs(s,r))return!0}return!1}function $i(e,t,s){const n=e[s],i=t[s];return s==="style"&&U(n)&&U(i)?!Gt(n,i):n!==i}function Eo({vnode:e,parent:t,suspense:s},n){for(;t;){const i=t.subTree;if(i.suspense&&i.suspense.activeBranch===e&&(i.suspense.vnode.el=i.el=n,e=i),i===e)(e=t.vnode).el=n,t=t.parent;else break}s&&s.activeBranch===e&&(s.vnode.el=n)}const Fi={},Gi=()=>Object.create(Fi),Hi=e=>Object.getPrototypeOf(e)===Fi;function Oo(e,t,s,n=!1){const i={},r=Gi();e.propsDefaults=Object.create(null),Vi(e,t,i,r);for(const o in e.propsOptions[0])o in i||(i[o]=void 0);s?e.props=n?i:Fr(i):e.type.props?e.props=i:e.props=r,e.attrs=r}function qo(e,t,s,n){const{props:i,attrs:r,vnode:{patchFlag:o}}=e,a=V(i),[l]=e.propsOptions;let d=!1;if((n||o>0)&&!(o&16)){if(o&8){const u=e.vnode.dynamicProps;for(let f=0;f<u.length;f++){let A=u[f];if(bs(e.emitsOptions,A))continue;const P=t[A];if(l)if(B(r,A))P!==r[A]&&(r[A]=P,d=!0);else{const $=_e(A);i[$]=Ws(l,a,$,P,e,!1)}else P!==r[A]&&(r[A]=P,d=!0)}}}else{Vi(e,t,i,r)&&(d=!0);let u;for(const f in a)(!t||!B(t,f)&&((u=nt(f))===f||!B(t,u)))&&(l?s&&(s[f]!==void 0||s[u]!==void 0)&&(i[f]=Ws(l,a,f,void 0,e,!0)):delete i[f]);if(r!==a)for(const f in r)(!t||!B(t,f))&&(delete r[f],d=!0)}d&&$e(e.attrs,"set","")}function Vi(e,t,s,n){const[i,r]=e.propsOptions;let o=!1,a;if(t)for(let l in t){if(St(l))continue;const d=t[l];let u;i&&B(i,u=_e(l))?!r||!r.includes(u)?s[u]=d:(a||(a={}))[u]=d:bs(e.emitsOptions,l)||(!(l in n)||d!==n[l])&&(n[l]=d,o=!0)}if(r){const l=V(s),d=a||z;for(let u=0;u<r.length;u++){const f=r[u];s[f]=Ws(i,l,f,d[f],e,!B(d,f))}}return o}function Ws(e,t,s,n,i,r){const o=e[s];if(o!=null){const a=B(o,"default");if(a&&n===void 0){const l=o.default;if(o.type!==Function&&!o.skipFactory&&j(l)){const{propsDefaults:d}=i;if(s in d)n=d[s];else{const u=Vt(i);n=d[s]=l.call(null,t),u()}}else n=l;i.ce&&i.ce._setProp(s,n)}o[0]&&(r&&!a?n=!1:o[1]&&(n===""||n===nt(s))&&(n=!0))}return n}const jo=new WeakMap;function Bi(e,t,s=!1){const n=s?jo:t.propsCache,i=n.get(e);if(i)return i;const r=e.props,o={},a=[];let l=!1;if(!j(e)){const u=f=>{l=!0;const[A,P]=Bi(f,t,!0);ae(o,A),P&&a.push(...P)};!s&&t.mixins.length&&t.mixins.forEach(u),e.extends&&u(e.extends),e.mixins&&e.mixins.forEach(u)}if(!r&&!l)return U(e)&&n.set(e,at),at;if(O(r))for(let u=0;u<r.length;u++){const f=_e(r[u]);Rn(f)&&(o[f]=z)}else if(r)for(const u in r){const f=_e(u);if(Rn(f)){const A=r[u],P=o[f]=O(A)||j(A)?{type:A}:ae({},A),$=P.type;let I=!1,G=!0;if(O($))for(let q=0;q<$.length;++q){const F=$[q],N=j(F)&&F.name;if(N==="Boolean"){I=!0;break}else N==="String"&&(G=!1)}else I=j($)&&$.name==="Boolean";P[0]=I,P[1]=G,(I||B(P,"default"))&&a.push(f)}}const d=[o,a];return U(e)&&n.set(e,d),d}function Rn(e){return e[0]!=="$"&&!St(e)}const ln=e=>e==="_"||e==="_ctx"||e==="$stable",cn=e=>O(e)?e.map(we):[we(e)],No=(e,t,s)=>{if(t._n)return t;const n=Qr((...i)=>cn(t(...i)),s);return n._c=!1,n},Wi=(e,t,s)=>{const n=e._ctx;for(const i in e){if(ln(i))continue;const r=e[i];if(j(r))t[i]=No(i,r,n);else if(r!=null){const o=cn(r);t[i]=()=>o}}},Ui=(e,t)=>{const s=cn(t);e.slots.default=()=>s},Ki=(e,t,s)=>{for(const n in t)(s||!ln(n))&&(e[n]=t[n])},Do=(e,t,s)=>{const n=e.slots=Gi();if(e.vnode.shapeFlag&32){const i=t._;i?(Ki(n,t,s),s&&ii(n,"_",i,!0)):Wi(t,n)}else t&&Ui(e,t)},$o=(e,t,s)=>{const{vnode:n,slots:i}=e;let r=!0,o=z;if(n.shapeFlag&32){const a=t._;a?s&&a===1?r=!1:Ki(i,t,s):(r=!t.$stable,Wi(t,i)),o=t}else t&&(Ui(e,t),o={default:1});if(r)for(const a in i)!ln(a)&&o[a]==null&&delete i[a]},pe=Bo;function Fo(e){return Go(e)}function Go(e,t){const s=hs();s.__VUE__=!0;const{insert:n,remove:i,patchProp:r,createElement:o,createText:a,createComment:l,setText:d,setElementText:u,parentNode:f,nextSibling:A,setScopeId:P=Ie,insertStaticContent:$}=e,I=(c,p,m,v=null,g=null,h=null,S=void 0,L=null,k=!!p.dynamicChildren)=>{if(c===p)return;c&&!xt(c,p)&&(v=zt(c),Le(c,g,h,!0),c=null),p.patchFlag===-2&&(k=!1,p.dynamicChildren=null);const{type:_,ref:R,shapeFlag:T}=p;switch(_){case xs:G(c,p,m,v);break;case Ke:q(c,p,m,v);break;case Os:c==null&&F(p,m,v,S);break;case D:Wt(c,p,m,v,g,h,S,L,k);break;default:T&1?te(c,p,m,v,g,h,S,L,k):T&6?Ut(c,p,m,v,g,h,S,L,k):(T&64||T&128)&&_.process(c,p,m,v,g,h,S,L,k,vt)}R!=null&&g?Mt(R,c&&c.ref,h,p||c,!p):R==null&&c&&c.ref!=null&&Mt(c.ref,null,h,c,!0)},G=(c,p,m,v)=>{if(c==null)n(p.el=a(p.children),m,v);else{const g=p.el=c.el;p.children!==c.children&&d(g,p.children)}},q=(c,p,m,v)=>{c==null?n(p.el=l(p.children||""),m,v):p.el=c.el},F=(c,p,m,v)=>{[c.el,c.anchor]=$(c.children,p,m,v,c.el,c.anchor)},N=({el:c,anchor:p},m,v)=>{let g;for(;c&&c!==p;)g=A(c),n(c,m,v),c=g;n(p,m,v)},C=({el:c,anchor:p})=>{let m;for(;c&&c!==p;)m=A(c),i(c),c=m;i(p)},te=(c,p,m,v,g,h,S,L,k)=>{if(p.type==="svg"?S="svg":p.type==="math"&&(S="mathml"),c==null)xe(p,m,v,g,h,S,L,k);else{const _=c.el&&c.el._isVueCE?c.el:null;try{_&&_._beginPatch(),Bt(c,p,g,h,S,L,k)}finally{_&&_._endPatch()}}},xe=(c,p,m,v,g,h,S,L)=>{let k,_;const{props:R,shapeFlag:T,transition:w,dirs:E}=c;if(k=c.el=o(c.type,h,R&&R.is,R),T&8?u(k,c.children):T&16&&We(c.children,k,null,v,g,Es(c,h),S,L),E&&Xe(c,null,v,"created"),ke(k,c,c.scopeId,S,v),R){for(const K in R)K!=="value"&&!St(K)&&r(k,K,null,R[K],h,v);"value"in R&&r(k,"value",null,R.value,h),(_=R.onVnodeBeforeMount)&&Pe(_,v,c)}E&&Xe(c,null,v,"beforeMount");const H=Ho(g,w);H&&w.beforeEnter(k),n(k,p,m),((_=R&&R.onVnodeMounted)||H||E)&&pe(()=>{try{_&&Pe(_,v,c),H&&w.enter(k),E&&Xe(c,null,v,"mounted")}finally{}},g)},ke=(c,p,m,v,g)=>{if(m&&P(c,m),v)for(let h=0;h<v.length;h++)P(c,v[h]);if(g){let h=g.subTree;if(p===h||Xi(h.type)&&(h.ssContent===p||h.ssFallback===p)){const S=g.vnode;ke(c,S,S.scopeId,S.slotScopeIds,g.parent)}}},We=(c,p,m,v,g,h,S,L,k=0)=>{for(let _=k;_<c.length;_++){const R=c[_]=L?De(c[_]):we(c[_]);I(null,R,p,m,v,g,h,S,L)}},Bt=(c,p,m,v,g,h,S)=>{const L=p.el=c.el;let{patchFlag:k,dynamicChildren:_,dirs:R}=p;k|=c.patchFlag&16;const T=c.props||z,w=p.props||z;let E;if(m&&Qe(m,!1),(E=w.onVnodeBeforeUpdate)&&Pe(E,m,p,c),R&&Xe(p,c,m,"beforeUpdate"),m&&Qe(m,!0),(T.innerHTML&&w.innerHTML==null||T.textContent&&w.textContent==null)&&u(L,""),_?ze(c.dynamicChildren,_,L,m,v,Es(p,g),h):S||J(c,p,L,null,m,v,Es(p,g),h,!1),k>0){if(k&16)gt(L,T,w,m,g);else if(k&2&&T.class!==w.class&&r(L,"class",null,w.class,g),k&4&&r(L,"style",T.style,w.style,g),k&8){const H=p.dynamicProps;for(let K=0;K<H.length;K++){const W=H[K],se=T[W],ne=w[W];(ne!==se||W==="value")&&r(L,W,se,ne,g,m)}}k&1&&c.children!==p.children&&u(L,p.children)}else!S&&_==null&&gt(L,T,w,m,g);((E=w.onVnodeUpdated)||R)&&pe(()=>{E&&Pe(E,m,p,c),R&&Xe(p,c,m,"updated")},v)},ze=(c,p,m,v,g,h,S)=>{for(let L=0;L<p.length;L++){const k=c[L],_=p[L],R=k.el&&(k.type===D||!xt(k,_)||k.shapeFlag&198)?f(k.el):m;I(k,_,R,null,v,g,h,S,!0)}},gt=(c,p,m,v,g)=>{if(p!==m){if(p!==z)for(const h in p)!St(h)&&!(h in m)&&r(c,h,p[h],null,g,v);for(const h in m){if(St(h))continue;const S=m[h],L=p[h];S!==L&&h!=="value"&&r(c,h,L,S,g,v)}"value"in m&&r(c,"value",p.value,m.value,g)}},Wt=(c,p,m,v,g,h,S,L,k)=>{const _=p.el=c?c.el:a(""),R=p.anchor=c?c.anchor:a("");let{patchFlag:T,dynamicChildren:w,slotScopeIds:E}=p;E&&(L=L?L.concat(E):E),c==null?(n(_,m,v),n(R,m,v),We(p.children||[],m,R,g,h,S,L,k)):T>0&&T&64&&w&&c.dynamicChildren&&c.dynamicChildren.length===w.length?(ze(c.dynamicChildren,w,m,g,h,S,L),(p.key!=null||g&&p===g.subTree)&&zi(c,p,!0)):J(c,p,m,R,g,h,S,L,k)},Ut=(c,p,m,v,g,h,S,L,k)=>{p.slotScopeIds=L,c==null?p.shapeFlag&512?g.ctx.activate(p,m,v,S,k):Ls(p,m,v,g,h,S,k):pn(c,p,k)},Ls=(c,p,m,v,g,h,S)=>{const L=c.component=Xo(c,v,g);if(Ii(c)&&(L.ctx.renderer=vt),Zo(L,!1,S),L.asyncDep){if(g&&g.registerDep(L,le,S),!c.el){const k=L.subTree=Oe(Ke);q(null,k,p,m),c.placeholder=k.el}}else le(L,c,p,m,g,h,S)},pn=(c,p,m)=>{const v=p.component=c.component;if(Io(c,p,m))if(v.asyncDep&&!v.asyncResolved){Z(v,p,m);return}else v.next=p,v.update();else p.el=c.el,v.vnode=p},le=(c,p,m,v,g,h,S)=>{const L=()=>{if(c.isMounted){let{next:T,bu:w,u:E,parent:H,vnode:K}=c;{const Se=Ji(c);if(Se){T&&(T.el=K.el,Z(c,T,S)),Se.asyncDep.then(()=>{pe(()=>{c.isUnmounted||_()},g)});return}}let W=T,se;Qe(c,!1),T?(T.el=K.el,Z(c,T,S)):T=K,w&&Qt(w),(se=T.props&&T.props.onVnodeBeforeUpdate)&&Pe(se,H,T,K),Qe(c,!0);const ne=Mn(c),Ae=c.subTree;c.subTree=ne,I(Ae,ne,f(Ae.el),zt(Ae),c,g,h),T.el=ne.el,W===null&&Eo(c,ne.el),E&&pe(E,g),(se=T.props&&T.props.onVnodeUpdated)&&pe(()=>Pe(se,H,T,K),g)}else{let T;const{el:w,props:E}=p,{bm:H,m:K,parent:W,root:se,type:ne}=c,Ae=wt(p);Qe(c,!1),H&&Qt(H),!Ae&&(T=E&&E.onVnodeBeforeMount)&&Pe(T,W,p),Qe(c,!0);{se.ce&&se.ce._hasShadowRoot()&&se.ce._injectChildStyle(ne,c.parent?c.parent.type:void 0);const Se=c.subTree=Mn(c);I(null,Se,m,v,c,g,h),p.el=Se.el}if(K&&pe(K,g),!Ae&&(T=E&&E.onVnodeMounted)){const Se=p;pe(()=>Pe(T,W,Se),g)}(p.shapeFlag&256||W&&wt(W.vnode)&&W.vnode.shapeFlag&256)&&c.a&&pe(c.a,g),c.isMounted=!0,p=m=v=null}};c.scope.on();const k=c.effect=new li(L);c.scope.off();const _=c.update=k.run.bind(k),R=c.job=k.runIfDirty.bind(k);R.i=c,R.id=c.uid,k.scheduler=()=>on(R),Qe(c,!0),_()},Z=(c,p,m)=>{p.component=c;const v=c.vnode.props;c.vnode=p,c.next=null,qo(c,p.props,v,m),$o(c,p.children,m),Ge(),kn(c),He()},J=(c,p,m,v,g,h,S,L,k=!1)=>{const _=c&&c.children,R=c?c.shapeFlag:0,T=p.children,{patchFlag:w,shapeFlag:E}=p;if(w>0){if(w&128){Kt(_,T,m,v,g,h,S,L,k);return}else if(w&256){Je(_,T,m,v,g,h,S,L,k);return}}E&8?(R&16&&_t(_,g,h),T!==_&&u(m,T)):R&16?E&16?Kt(_,T,m,v,g,h,S,L,k):_t(_,g,h,!0):(R&8&&u(m,""),E&16&&We(T,m,v,g,h,S,L,k))},Je=(c,p,m,v,g,h,S,L,k)=>{c=c||at,p=p||at;const _=c.length,R=p.length,T=Math.min(_,R);let w;for(w=0;w<T;w++){const E=p[w]=k?De(p[w]):we(p[w]);I(c[w],E,m,null,g,h,S,L,k)}_>R?_t(c,g,h,!0,!1,T):We(p,m,v,g,h,S,L,k,T)},Kt=(c,p,m,v,g,h,S,L,k)=>{let _=0;const R=p.length;let T=c.length-1,w=R-1;for(;_<=T&&_<=w;){const E=c[_],H=p[_]=k?De(p[_]):we(p[_]);if(xt(E,H))I(E,H,m,null,g,h,S,L,k);else break;_++}for(;_<=T&&_<=w;){const E=c[T],H=p[w]=k?De(p[w]):we(p[w]);if(xt(E,H))I(E,H,m,null,g,h,S,L,k);else break;T--,w--}if(_>T){if(_<=w){const E=w+1,H=E<R?p[E].el:v;for(;_<=w;)I(null,p[_]=k?De(p[_]):we(p[_]),m,H,g,h,S,L,k),_++}}else if(_>w)for(;_<=T;)Le(c[_],g,h,!0),_++;else{const E=_,H=_,K=new Map;for(_=H;_<=w;_++){const fe=p[_]=k?De(p[_]):we(p[_]);fe.key!=null&&K.set(fe.key,_)}let W,se=0;const ne=w-H+1;let Ae=!1,Se=0;const yt=new Array(ne);for(_=0;_<ne;_++)yt[_]=0;for(_=E;_<=T;_++){const fe=c[_];if(se>=ne){Le(fe,g,h,!0);continue}let Te;if(fe.key!=null)Te=K.get(fe.key);else for(W=H;W<=w;W++)if(yt[W-H]===0&&xt(fe,p[W])){Te=W;break}Te===void 0?Le(fe,g,h,!0):(yt[Te-H]=_+1,Te>=Se?Se=Te:Ae=!0,I(fe,p[Te],m,null,g,h,S,L,k),se++)}const hn=Ae?Vo(yt):at;for(W=hn.length-1,_=ne-1;_>=0;_--){const fe=H+_,Te=p[fe],gn=p[fe+1],_n=fe+1<R?gn.el||Yi(gn):v;yt[_]===0?I(null,Te,m,_n,g,h,S,L,k):Ae&&(W<0||_!==hn[W]?Ye(Te,m,_n,2):W--)}}},Ye=(c,p,m,v,g=null)=>{const{el:h,type:S,transition:L,children:k,shapeFlag:_}=c;if(_&6){Ye(c.component.subTree,p,m,v);return}if(_&128){c.suspense.move(p,m,v);return}if(_&64){S.move(c,p,m,vt);return}if(S===D){n(h,p,m);for(let T=0;T<k.length;T++)Ye(k[T],p,m,v);n(c.anchor,p,m);return}if(S===Os){N(c,p,m);return}if(v!==2&&_&1&&L)if(v===0)L.persisted&&!h[Rs]?n(h,p,m):(L.beforeEnter(h),n(h,p,m),pe(()=>L.enter(h),g));else{const{leave:T,delayLeave:w,afterLeave:E}=L,H=()=>{c.ctx.isUnmounted?i(h):n(h,p,m)},K=()=>{const W=h._isLeaving||!!h[Rs];h._isLeaving&&h[Rs](!0),L.persisted&&!W?H():T(h,()=>{H(),E&&E()})};w?w(h,H,K):K()}else n(h,p,m)},Le=(c,p,m,v=!1,g=!1)=>{const{type:h,props:S,ref:L,children:k,dynamicChildren:_,shapeFlag:R,patchFlag:T,dirs:w,cacheIndex:E,memo:H}=c;if(T===-2&&(g=!1),L!=null&&(Ge(),Mt(L,null,m,c,!0),He()),E!=null&&(p.renderCache[E]=void 0),R&256){p.ctx.deactivate(c);return}const K=R&1&&w,W=!wt(c);let se;if(W&&(se=S&&S.onVnodeBeforeUnmount)&&Pe(se,p,c),R&6)lr(c.component,m,v);else{if(R&128){c.suspense.unmount(m,v);return}K&&Xe(c,null,p,"beforeUnmount"),R&64?c.type.remove(c,p,m,vt,v):_&&!_.hasOnce&&(h!==D||T>0&&T&64)?_t(_,p,m,!1,!0):(h===D&&T&384||!g&&R&16)&&_t(k,p,m),v&&fn(c)}const ne=H!=null&&E==null;(W&&(se=S&&S.onVnodeUnmounted)||K||ne)&&pe(()=>{se&&Pe(se,p,c),K&&Xe(c,null,p,"unmounted"),ne&&(c.el=null)},m)},fn=c=>{const{type:p,el:m,anchor:v,transition:g}=c;if(p===D){ar(m,v);return}if(p===Os){C(c);return}const h=()=>{i(m),g&&!g.persisted&&g.afterLeave&&g.afterLeave()};if(c.shapeFlag&1&&g&&!g.persisted){const{leave:S,delayLeave:L}=g,k=()=>S(m,h);L?L(c.el,h,k):k()}else h()},ar=(c,p)=>{let m;for(;c!==p;)m=A(c),i(c),c=m;i(p)},lr=(c,p,m)=>{const{bum:v,scope:g,job:h,subTree:S,um:L,m:k,a:_}=c;In(k),In(_),v&&Qt(v),g.stop(),h&&(h.flags|=8,Le(S,c,p,m)),L&&pe(L,p),pe(()=>{c.isUnmounted=!0},p)},_t=(c,p,m,v=!1,g=!1,h=0)=>{for(let S=h;S<c.length;S++)Le(c[S],p,m,v,g)},zt=c=>{if(c.shapeFlag&6)return zt(c.component.subTree);if(c.shapeFlag&128)return c.suspense.next();const p=A(c.anchor||c.el),m=p&&p[no];return m?A(m):p};let As=!1;const mn=(c,p,m)=>{let v;c==null?p._vnode&&(Le(p._vnode,null,null,!0),v=p._vnode.component):I(p._vnode||null,c,p,null,null,null,m),p._vnode=c,As||(As=!0,kn(v),Ti(),As=!1)},vt={p:I,um:Le,m:Ye,r:fn,mt:Ls,mc:We,pc:J,pbc:ze,n:zt,o:e};return{render:mn,hydrate:void 0,createApp:To(mn)}}function Es({type:e,props:t},s){return s==="svg"&&e==="foreignObject"||s==="mathml"&&e==="annotation-xml"&&t&&t.encoding&&t.encoding.includes("html")?void 0:s}function Qe({effect:e,job:t},s){s?(e.flags|=32,t.flags|=4):(e.flags&=-33,t.flags&=-5)}function Ho(e,t){return(!e||e&&!e.pendingBranch)&&t&&!t.persisted}function zi(e,t,s=!1){const n=e.children,i=t.children;if(O(n)&&O(i))for(let r=0;r<n.length;r++){const o=n[r];let a=i[r];a.shapeFlag&1&&!a.dynamicChildren&&((a.patchFlag<=0||a.patchFlag===32)&&(a=i[r]=De(i[r]),a.el=o.el),!s&&a.patchFlag!==-2&&zi(o,a)),a.type===xs&&(a.patchFlag===-1&&(a=i[r]=De(a)),a.el=o.el),a.type===Ke&&!a.el&&(a.el=o.el)}}function Vo(e){const t=e.slice(),s=[0];let n,i,r,o,a;const l=e.length;for(n=0;n<l;n++){const d=e[n];if(d!==0){if(i=s[s.length-1],e[i]<d){t[n]=i,s.push(n);continue}for(r=0,o=s.length-1;r<o;)a=r+o>>1,e[s[a]]<d?r=a+1:o=a;d<e[s[r]]&&(r>0&&(t[n]=s[r-1]),s[r]=n)}}for(r=s.length,o=s[r-1];r-- >0;)s[r]=o,o=t[o];return s}function Ji(e){const t=e.subTree.component;if(t)return t.asyncDep&&!t.asyncResolved?t:Ji(t)}function In(e){if(e)for(let t=0;t<e.length;t++)e[t].flags|=8}function Yi(e){if(e.placeholder)return e.placeholder;const t=e.component;return t?Yi(t.subTree):null}const Xi=e=>e.__isSuspense;function Bo(e,t){t&&t.pendingBranch?O(e)?t.effects.push(...e):t.effects.push(e):Xr(e)}const D=Symbol.for("v-fgt"),xs=Symbol.for("v-txt"),Ke=Symbol.for("v-cmt"),Os=Symbol.for("v-stc"),It=[];let me=null;function y(e=!1){It.push(me=e?null:[])}function Wo(){It.pop(),me=It[It.length-1]||null}let Nt=1;function En(e,t=!1){Nt+=e,e<0&&me&&t&&(me.hasOnce=!0)}function Qi(e){return e.dynamicChildren=Nt>0?me||at:null,Wo(),Nt>0&&me&&me.push(e),e}function b(e,t,s,n,i,r){return Qi(x(e,t,s,n,i,r,!0))}function Et(e,t,s,n,i){return Qi(Oe(e,t,s,n,i,!0))}function Zi(e){return e?e.__v_isVNode===!0:!1}function xt(e,t){return e.type===t.type&&e.key===t.key}const er=({key:e})=>e??null,es=({ref:e,ref_key:t,ref_for:s})=>(typeof e=="number"&&(e=""+e),e!=null?ee(e)||oe(e)||j(e)?{i:he,r:e,k:t,f:!!s}:e:null);function x(e,t=null,s=null,n=0,i=null,r=e===D?0:1,o=!1,a=!1){const l={__v_isVNode:!0,__v_skip:!0,type:e,props:t,key:t&&er(t),ref:t&&es(t),scopeId:Ci,slotScopeIds:null,children:s,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:r,patchFlag:n,dynamicProps:i,dynamicChildren:null,appContext:null,ctx:he};return a?(dn(l,s),r&128&&e.normalize(l)):s&&(l.shapeFlag|=ee(s)?8:16),Nt>0&&!o&&me&&(l.patchFlag>0||r&6)&&l.patchFlag!==32&&me.push(l),l}const Oe=Uo;function Uo(e,t=null,s=null,n=0,i=null,r=!1){if((!e||e===vo)&&(e=Ke),Zi(e)){const a=ht(e,t,!0);return s&&dn(a,s),Nt>0&&!r&&me&&(a.shapeFlag&6?me[me.indexOf(e)]=a:me.push(a)),a.patchFlag=-2,a}if(na(e)&&(e=e.__vccOpts),t){t=Ko(t);let{class:a,style:l}=t;a&&!ee(a)&&(t.class=Ee(a)),U(l)&&(rn(l)&&!O(l)&&(l=ae({},l)),t.style=Ft(l))}const o=ee(e)?1:Xi(e)?128:io(e)?64:U(e)?4:j(e)?2:0;return x(e,t,s,n,i,o,r,!0)}function Ko(e){return e?rn(e)||Hi(e)?ae({},e):e:null}function ht(e,t,s=!1,n=!1){const{props:i,ref:r,patchFlag:o,children:a,transition:l}=e,d=t?zo(i||{},t):i,u={__v_isVNode:!0,__v_skip:!0,type:e.type,props:d,key:d&&er(d),ref:t&&t.ref?s&&r?O(r)?r.concat(es(t)):[r,es(t)]:es(t):r,scopeId:e.scopeId,slotScopeIds:e.slotScopeIds,children:a,target:e.target,targetStart:e.targetStart,targetAnchor:e.targetAnchor,staticCount:e.staticCount,shapeFlag:e.shapeFlag,patchFlag:t&&e.type!==D?o===-1?16:o|16:o,dynamicProps:e.dynamicProps,dynamicChildren:e.dynamicChildren,appContext:e.appContext,dirs:e.dirs,transition:l,component:e.component,suspense:e.suspense,ssContent:e.ssContent&&ht(e.ssContent),ssFallback:e.ssFallback&&ht(e.ssFallback),placeholder:e.placeholder,el:e.el,anchor:e.anchor,ctx:e.ctx,ce:e.ce};return l&&n&&an(u,l.clone(u)),u}function un(e=" ",t=0){return Oe(xs,null,e,t)}function Q(e="",t=!1){return t?(y(),Et(Ke,null,e)):Oe(Ke,null,e)}function we(e){return e==null||typeof e=="boolean"?Oe(Ke):O(e)?Oe(D,null,e.slice()):Zi(e)?De(e):Oe(xs,null,String(e))}function De(e){return e.el===null&&e.patchFlag!==-1||e.memo?e:ht(e)}function dn(e,t){let s=0;const{shapeFlag:n}=e;if(t==null)t=null;else if(O(t))s=16;else if(typeof t=="object")if(n&65){const i=t.default;i&&(i._c&&(i._d=!1),dn(e,i()),i._c&&(i._d=!0));return}else{s=32;const i=t._;!i&&!Hi(t)?t._ctx=he:i===3&&he&&(he.slots._===1?t._=1:(t._=2,e.patchFlag|=1024))}else j(t)?(t={default:t,_ctx:he},s=32):(t=String(t),n&64?(s=16,t=[un(t)]):s=8);e.children=t,e.shapeFlag|=s}function zo(...e){const t={};for(let s=0;s<e.length;s++){const n=e[s];for(const i in n)if(i==="class")t.class!==n.class&&(t.class=Ee([t.class,n.class]));else if(i==="style")t.style=Ft([t.style,n.style]);else if(us(i)){const r=t[i],o=n[i];o&&r!==o&&!(O(r)&&r.includes(o))?t[i]=r?[].concat(r,o):o:o==null&&r==null&&!ds(i)&&(t[i]=o)}else i!==""&&(t[i]=n[i])}return t}function Pe(e,t,s,n=null){be(e,t,7,[s,n])}const Jo=Ni();let Yo=0;function Xo(e,t,s){const n=e.type,i=(t?t.appContext:e.appContext)||Jo,r={uid:Yo++,vnode:e,type:n,parent:t,appContext:i,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new xr(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:t?t.provides:Object.create(i.provides),ids:t?t.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:Bi(n,i),emitsOptions:Di(n,i),emit:null,emitted:null,propsDefaults:z,inheritAttrs:n.inheritAttrs,ctx:z,data:z,props:z,attrs:z,slots:z,refs:z,setupState:z,setupContext:null,suspense:s,suspenseId:s?s.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return r.ctx={_:r},r.root=t?t.root:r,r.emit=Co.bind(null,r),e.ce&&e.ce(r),r}let de=null;const Qo=()=>de||he;let os,Us;{const e=hs(),t=(s,n)=>{let i;return(i=e[s])||(i=e[s]=[]),i.push(n),r=>{i.length>1?i.forEach(o=>o(r)):i[0](r)}};os=t("__VUE_INSTANCE_SETTERS__",s=>de=s),Us=t("__VUE_SSR_SETTERS__",s=>Dt=s)}const Vt=e=>{const t=de;return os(e),e.scope.on(),()=>{e.scope.off(),os(t)}},On=()=>{de&&de.scope.off(),os(null)};function tr(e){return e.vnode.shapeFlag&4}let Dt=!1;function Zo(e,t=!1,s=!1){t&&Us(t);const{props:n,children:i}=e.vnode,r=tr(e);Oo(e,n,r,t),Do(e,i,s||t);const o=r?ea(e,t):void 0;return t&&Us(!1),o}function ea(e,t){const s=e.type;e.accessCache=Object.create(null),e.proxy=new Proxy(e.ctx,yo);const{setup:n}=s;if(n){Ge();const i=e.setupContext=n.length>1?sa(e):null,r=Vt(e),o=Ht(n,e,0,[e.props,i]),a=ei(o);if(He(),r(),(a||e.sp)&&!wt(e)&&Ri(e),a){if(o.then(On,On),t)return o.then(l=>{qn(e,l)}).catch(l=>{vs(l,e,0)});e.asyncDep=o}else qn(e,o)}else sr(e)}function qn(e,t,s){j(t)?e.type.__ssrInlineRender?e.ssrRender=t:e.render=t:U(t)&&(e.setupState=ki(t)),sr(e)}function sr(e,t,s){const n=e.type;e.render||(e.render=n.render||Ie);{const i=Vt(e);Ge();try{bo(e)}finally{He(),i()}}}const ta={get(e,t){return re(e,"get",""),e[t]}};function sa(e){const t=s=>{e.exposed=s||{}};return{attrs:new Proxy(e.attrs,ta),slots:e.slots,emit:e.emit,expose:t}}function ks(e){return e.exposed?e.exposeProxy||(e.exposeProxy=new Proxy(ki(Gr(e.exposed)),{get(t,s){if(s in t)return t[s];if(s in Rt)return Rt[s](e)},has(t,s){return s in t||s in Rt}})):e.proxy}function na(e){return j(e)&&"__vccOpts"in e}const ot=(e,t)=>Ur(e,t,Dt),ia="3.5.38";/**
* @vue/runtime-dom v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let Ks;const jn=typeof window<"u"&&window.trustedTypes;if(jn)try{Ks=jn.createPolicy("vue",{createHTML:e=>e})}catch{}const nr=Ks?e=>Ks.createHTML(e):e=>e,ra="http://www.w3.org/2000/svg",oa="http://www.w3.org/1998/Math/MathML",Ne=typeof document<"u"?document:null,Nn=Ne&&Ne.createElement("template"),aa={insert:(e,t,s)=>{t.insertBefore(e,s||null)},remove:e=>{const t=e.parentNode;t&&t.removeChild(e)},createElement:(e,t,s,n)=>{const i=t==="svg"?Ne.createElementNS(ra,e):t==="mathml"?Ne.createElementNS(oa,e):s?Ne.createElement(e,{is:s}):Ne.createElement(e);return e==="select"&&n&&n.multiple!=null&&i.setAttribute("multiple",n.multiple),i},createText:e=>Ne.createTextNode(e),createComment:e=>Ne.createComment(e),setText:(e,t)=>{e.nodeValue=t},setElementText:(e,t)=>{e.textContent=t},parentNode:e=>e.parentNode,nextSibling:e=>e.nextSibling,querySelector:e=>Ne.querySelector(e),setScopeId(e,t){e.setAttribute(t,"")},insertStaticContent(e,t,s,n,i,r){const o=s?s.previousSibling:t.lastChild;if(i&&(i===r||i.nextSibling))for(;t.insertBefore(i.cloneNode(!0),s),!(i===r||!(i=i.nextSibling)););else{Nn.innerHTML=nr(n==="svg"?`<svg>${e}</svg>`:n==="mathml"?`<math>${e}</math>`:e);const a=Nn.content;if(n==="svg"||n==="mathml"){const l=a.firstChild;for(;l.firstChild;)a.appendChild(l.firstChild);a.removeChild(l)}t.insertBefore(a,s)}return[o?o.nextSibling:t.firstChild,s?s.previousSibling:t.lastChild]}},la=Symbol("_vtc");function ca(e,t,s){const n=e[la];n&&(t=(t?[t,...n]:[...n]).join(" ")),t==null?e.removeAttribute("class"):s?e.setAttribute("class",t):e.className=t}const as=Symbol("_vod"),ir=Symbol("_vsh"),rr={name:"show",beforeMount(e,{value:t},{transition:s}){e[as]=e.style.display==="none"?"":e.style.display,s&&t?s.beforeEnter(e):kt(e,t)},mounted(e,{value:t},{transition:s}){s&&t&&s.enter(e)},updated(e,{value:t,oldValue:s},{transition:n}){!t!=!s&&(n?t?(n.beforeEnter(e),kt(e,!0),n.enter(e)):n.leave(e,()=>{kt(e,!1)}):kt(e,t))},beforeUnmount(e,{value:t}){kt(e,t)}};function kt(e,t){e.style.display=t?e[as]:"none",e[ir]=!t}const ua=Symbol(""),da=/(?:^|;)\s*display\s*:/;function pa(e,t,s){const n=e.style,i=ee(s);let r=!1;if(s&&!i){if(t)if(ee(t))for(const o of t.split(";")){const a=o.slice(0,o.indexOf(":")).trim();s[a]==null&&At(n,a,"")}else for(const o in t)s[o]==null&&At(n,o,"");for(const o in s){o==="display"&&(r=!0);const a=s[o];a!=null?ma(e,o,!ee(t)&&t?t[o]:void 0,a)||At(n,o,a):At(n,o,"")}}else if(i){if(t!==s){const o=n[ua];o&&(s+=";"+o),n.cssText=s,r=da.test(s)}}else t&&e.removeAttribute("style");as in e&&(e[as]=r?n.display:"",e[ir]&&(n.display="none"))}const Dn=/\s*!important$/;function At(e,t,s){if(O(s))s.forEach(n=>At(e,t,n));else if(s==null&&(s=""),t.startsWith("--"))e.setProperty(t,s);else{const n=fa(e,t);Dn.test(s)?e.setProperty(nt(n),s.replace(Dn,""),"important"):e[n]=s}}const $n=["Webkit","Moz","ms"],qs={};function fa(e,t){const s=qs[t];if(s)return s;let n=_e(t);if(n!=="filter"&&n in e)return qs[t]=n;n=ni(n);for(let i=0;i<$n.length;i++){const r=$n[i]+n;if(r in e)return qs[t]=r}return t}function ma(e,t,s,n){return e.tagName==="TEXTAREA"&&(t==="width"||t==="height")&&ee(n)&&s===n}const Fn="http://www.w3.org/1999/xlink";function Gn(e,t,s,n,i,r=vr(t)){n&&t.startsWith("xlink:")?s==null?e.removeAttributeNS(Fn,t.slice(6,t.length)):e.setAttributeNS(Fn,t,s):s==null||r&&!ri(s)?e.removeAttribute(t):e.setAttribute(t,r?"":qe(s)?String(s):s)}function Hn(e,t,s,n,i){if(t==="innerHTML"||t==="textContent"){s!=null&&(e[t]=t==="innerHTML"?nr(s):s);return}const r=e.tagName;if(t==="value"&&r!=="PROGRESS"&&!r.includes("-")){const a=r==="OPTION"?e.getAttribute("value")||"":e.value,l=s==null?e.type==="checkbox"?"on":"":String(s);(a!==l||!("_value"in e))&&(e.value=l),s==null&&e.removeAttribute(t),e._value=s;return}let o=!1;if(s===""||s==null){const a=typeof e[t];a==="boolean"?s=ri(s):s==null&&a==="string"?(s="",o=!0):a==="number"&&(s=0,o=!0)}try{e[t]=s}catch{}o&&e.removeAttribute(i||t)}function et(e,t,s,n){e.addEventListener(t,s,n)}function ha(e,t,s,n){e.removeEventListener(t,s,n)}const Vn=Symbol("_vei");function ga(e,t,s,n,i=null){const r=e[Vn]||(e[Vn]={}),o=r[t];if(n&&o)o.value=n;else{const[a,l]=_a(t);if(n){const d=r[t]=ba(n,i);et(e,a,d,l)}else o&&(ha(e,a,o,l),r[t]=void 0)}}const Bn=/(?:Once|Passive|Capture)$/;function _a(e){let t;if(Bn.test(e)){t={};let n;for(;n=e.match(Bn);)e=e.slice(0,e.length-n[0].length),t[n[0].toLowerCase()]=!0}return[e[2]===":"?e.slice(3):nt(e.slice(2)),t]}let js=0;const va=Promise.resolve(),ya=()=>js||(va.then(()=>js=0),js=Date.now());function ba(e,t){const s=n=>{if(!n._vts)n._vts=Date.now();else if(n._vts<=s.attached)return;const i=s.value;if(O(i)){const r=n.stopImmediatePropagation;n.stopImmediatePropagation=()=>{r.call(n),n._stopped=!0};const o=i.slice(),a=[n];for(let l=0;l<o.length&&!n._stopped;l++){const d=o[l];d&&be(d,t,5,a)}}else be(i,t,5,[n])};return s.value=e,s.attached=ya(),s}const Wn=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&e.charCodeAt(2)>96&&e.charCodeAt(2)<123,xa=(e,t,s,n,i,r)=>{const o=i==="svg";t==="class"?ca(e,n,o):t==="style"?pa(e,s,n):us(t)?ds(t)||ga(e,t,s,n,r):(t[0]==="."?(t=t.slice(1),!0):t[0]==="^"?(t=t.slice(1),!1):ka(e,t,n,o))?(Hn(e,t,n),!e.tagName.includes("-")&&(t==="value"||t==="checked"||t==="selected")&&Gn(e,t,n,o,r,t!=="value")):e._isVueCE&&(La(e,t)||e._def.__asyncLoader&&(/[A-Z]/.test(t)||!ee(n)))?Hn(e,_e(t),n,r,t):(t==="true-value"?e._trueValue=n:t==="false-value"&&(e._falseValue=n),Gn(e,t,n,o))};function ka(e,t,s,n){if(n)return!!(t==="innerHTML"||t==="textContent"||t in e&&Wn(t)&&j(s));if(t==="spellcheck"||t==="draggable"||t==="translate"||t==="autocorrect"||t==="sandbox"&&e.tagName==="IFRAME"||t==="form"||t==="list"&&e.tagName==="INPUT"||t==="type"&&e.tagName==="TEXTAREA")return!1;if(t==="width"||t==="height"){const i=e.tagName;if(i==="IMG"||i==="VIDEO"||i==="CANVAS"||i==="SOURCE")return!1}return Wn(t)&&ee(s)?!1:t in e}function La(e,t){const s=e._def.props;if(!s)return!1;const n=_e(t);return Array.isArray(s)?s.some(i=>_e(i)===n):Object.keys(s).some(i=>_e(i)===n)}const ls=e=>{const t=e.props["onUpdate:modelValue"]||!1;return O(t)?s=>Qt(t,s):t};function Aa(e){e.target.composing=!0}function Un(e){const t=e.target;t.composing&&(t.composing=!1,t.dispatchEvent(new Event("input")))}const dt=Symbol("_assign");function Kn(e,t,s){return t&&(e=e.trim()),s&&(e=ms(e)),e}const zn={created(e,{modifiers:{lazy:t,trim:s,number:n}},i){e[dt]=ls(i);const r=n||i.props&&i.props.type==="number";et(e,t?"change":"input",o=>{o.target.composing||e[dt](Kn(e.value,s,r))}),(s||r)&&et(e,"change",()=>{e.value=Kn(e.value,s,r)}),t||(et(e,"compositionstart",Aa),et(e,"compositionend",Un),et(e,"change",Un))},mounted(e,{value:t}){e.value=t??""},beforeUpdate(e,{value:t,oldValue:s,modifiers:{lazy:n,trim:i,number:r}},o){if(e[dt]=ls(o),e.composing)return;const a=(r||e.type==="number")&&!/^0\d/.test(e.value)?ms(e.value):e.value,l=t??"";if(a===l)return;const d=e.getRootNode();(d instanceof Document||d instanceof ShadowRoot)&&d.activeElement===e&&e.type!=="range"&&(n&&t===s||i&&e.value.trim()===l)||(e.value=l)}},Sa={deep:!0,created(e,{value:t,modifiers:{number:s}},n){const i=ps(t);et(e,"change",()=>{const r=Array.prototype.filter.call(e.options,o=>o.selected).map(o=>s?ms(cs(o)):cs(o));e[dt](e.multiple?i?new Set(r):r:r[0]),e._assigning=!0,Ai(()=>{e._assigning=!1})}),e[dt]=ls(n)},mounted(e,{value:t}){Jn(e,t)},beforeUpdate(e,t,s){e[dt]=ls(s)},updated(e,{value:t}){e._assigning||Jn(e,t)}};function Jn(e,t){const s=e.multiple,n=O(t);if(!(s&&!n&&!ps(t))){for(let i=0,r=e.options.length;i<r;i++){const o=e.options[i],a=cs(o);if(s)if(n){const l=typeof a;l==="string"||l==="number"?o.selected=t.some(d=>String(d)===String(a)):o.selected=br(t,a)>-1}else o.selected=t.has(a);else if(Gt(cs(o),t)){e.selectedIndex!==i&&(e.selectedIndex=i);return}}!s&&e.selectedIndex!==-1&&(e.selectedIndex=-1)}}function cs(e){return"_value"in e?e._value:e.value}const Ta=ae({patchProp:xa},aa);let Yn;function Pa(){return Yn||(Yn=Fo(Ta))}const Ca=((...e)=>{const t=Pa().createApp(...e),{mount:s}=t;return t.mount=n=>{const i=wa(n);if(!i)return;const r=t._component;!j(r)&&!r.render&&!r.template&&(r.template=i.innerHTML),i.nodeType===1&&(i.textContent="");const o=s(i,!1,Ma(i));return i instanceof Element&&(i.removeAttribute("v-cloak"),i.setAttribute("data-v-app","")),o},t});function Ma(e){if(e instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&e instanceof MathMLElement)return"mathml"}function wa(e){return ee(e)?document.querySelector(e):e}const zs={header:{title:"AI 学习笔记",subtitle:"AI Engineering from Scratch · 从零开始"},days:[{id:1,label:"Day 1",date:"2026年6月17日 · 基础入门",locked:!0,footer:"Day 1 · 2026-06-17 · 🔒 已锁定",progress:{label:"当前进度",detail:"Phase 11 · 已学 6/22 课",percent:28,text:"~30h / 209h",desc:"环境搭建 → LLM 工程 → 工具协议 → Agent → 多智能体 → 生产部署"},sections:[{emoji:"🛠",title:"1. 环境搭建",tag:"完成",blocks:[{type:"list",items:['配置了公司的 Anthropic 兼容 API：<span class="highlight">base_url=http://llmapi.bilibili.co</span>',"安装了 Python 包：anthropic, openai, sentence-transformers, numpy","跑通了第一次 API 调用"]},{type:"code",code:'client = anthropic.Anthropic(api_key="...", base_url="http://llmapi.bilibili.co")'}]},{emoji:"📝",title:"2. Prompt 工程",tag:"Phase 11-01",blocks:[{type:"list",items:["<strong>System Message</strong> — 设置身份和全局规则","<strong>User Message</strong> — 具体任务","<strong>Assistant Prefill</strong> — 预先写回复开头，控制输出格式","角色越具体，输出质量越高"]}]},{emoji:"💡",title:"3. Few-Shot & 思维链",tag:"Phase 11-02",blocks:[{type:"table",headers:["技术","做法","适用场景"],rows:[["Few-Shot","先给 3-5 个例子再问","格式敏感任务"],["Chain-of-Thought",'加"请一步一步思考"',"数学、逻辑推理"],["Self-Consistency","跑多次取多数答案","高准确率要求"],["Tree-of-Thought","多条路径探索评估选最优","复杂规划问题"]]}]},{emoji:"📋",title:"4. 结构化输出",tag:"Phase 11-03",blocks:[{type:"list",items:["应用需要 JSON，模型给的是自然语言 → 需要告诉模型格式",'3 种方式：Prompt 说"返回JSON" → 给 JSON 模板 → JSON 模板 + try/except','<span class="highlight">try/except</span> 捕获 JSON 解析失败，兜底处理']}]},{emoji:"🔢",title:"5. Embeddings",tag:"Phase 11-04",blocks:[{type:"list",items:["<strong>Embedding</strong> = 把文字转成一串数字（向量）","意思相近的文字 → 向量距离近 → 余弦相似度高",'中文用 <span class="highlight">shibing624/text2vec-base-chinese</span>']},{type:"code",code:"相似度 = (向量A · 向量B) / (|向量A| × |向量B|)"}]},{emoji:"📐",title:"6. 上下文工程",tag:"Phase 11-05",blocks:[{type:"list",items:["上下文窗口是稀缺资源，不是越大越好","<strong>Lost-in-the-Middle</strong> — 模型最关注开头和结尾","<strong>三明治原则：</strong>重要信息放开头和结尾"]},{type:"code",code:"System → 工具定义 → 检索文档 → 对话历史 → 当前问题 → 最后指令"}]},{emoji:"📚",title:"7. RAG 检索增强生成",tag:"Phase 11-06",blocks:[{type:"list",items:["<strong>RAG 四步：</strong>文档向量化 → 问题转向量 → 搜索最相似文档 → 文档+问题一起给模型","比微调便宜百倍，数据随时更新，可追溯来源"]},{type:"code",code:"相似度 = (doc_vectors @ q_vec.T).flatten() / (norm_doc * norm_q)"}]},{emoji:"⚡",title:"8. 高级 RAG",tag:"Phase 11-07",blocks:[{type:"table",headers:["改进","做法"],rows:[["关键词提权","向量相似度 + 命中关键词加分"],["兜底搜索","向量搜不到就换关键词搜"],["误判过滤","相似度低于阈值的文档不用"]]}]},{emoji:"⚙️",title:"9. Function Calling",tag:"Phase 11-09",blocks:[{type:"list",items:['模型输出结构化 JSON 说"我要调什么函数、参数是什么"',"<strong>你的代码执行工具，模型只做决策</strong>","完整 6 步循环：定义工具 → 传给模型 → 模型决定用哪个 → 代码执行 → 结果还回 → 模型最终回答"]}]},{emoji:"💰",title:"10. 缓存与成本优化",tag:"Phase 11-11",blocks:[{type:"list",items:["40-60% 的提问是同一意思换说法 → <strong>语义缓存</strong>","问题转向量，相似度超过阈值就返回缓存结果，不调 API"]}]},{emoji:"🐍",title:"Python 基础语法（Day 1 遇到的）",blocks:[{type:"table",headers:["语法","作用","例子"],rows:[["def","定义函数","def 加法(a,b): return a+b"],["for x in 列表","遍历",'for 水果 in ["苹果"]:'],["if/else","条件判断","if 分数 > 0.8:"],["try/except","捕获错误","try: json.loads(x)"],['f"你好{名字}"',"字符串嵌入变量",'f"温度是{度}度"']]}]}]},{id:2,label:"Day 2",date:"2026年6月18日 · RAG 文档管理 + PDF 处理 + LoRA 微调",locked:!1,footer:"Day 2 · 2026-06-18 · PDF 处理 + LoRA 微调实战",keyPoint:{title:"今日核心问题",highlights:["文档中的表格和图片怎么存到 RAG 里？","怎么用 LoRA 微调模型改变它的回答风格？"],desc:"上午跑通了 RAG 文档更新方案的完整链路，下午从原理到手写代码到 Colab 实战，完整跑通了 LoRA 微调。"},sections:[{emoji:"🔄",title:"1. 文档更新了怎么办？",blocks:[{type:"table",headers:["方案","做法","适合场景"],rows:[["删旧重新编","更新文档 → 删旧向量 → 重新 encode","单篇更新，最常用"],["定时全量重建","每天凌晨全部重新向量化","文档稳定，实时性不高"],["事件驱动","文档系统主动通知（webhook）","有飞书/语雀平台"]]}]},{emoji:"🔍",title:"2. 怎么知道文档变没变？",blocks:[{type:"table",headers:["方法","粒度","速度","原理"],rows:[['<span class="highlight">mtime</span>',"整个文件","几毫秒","读文件修改时间戳"],['<span class="highlight">MD5</span>',"每个内容块","需要读内容","算文本哈希值"]]}]},{emoji:"🧩",title:'3. 文档怎么"切块"存？',blocks:[{type:"code",code:`原始文档（3000字）
...
if __name__ == "__main__":
    run_demo()
`,error:"",lineCount:511,truncated:!1}},qa={class:"emoji"},ja={key:0,class:"tag"},Na=["innerHTML"],Da={key:1,class:"section-subtitle"},$a={key:2},Fa=["innerHTML"],Ga=["innerHTML"],Ha={key:4,class:"code-ref"},Va=["onClick"],Ba={class:"code-ref-arrow"},Wa={class:"code-ref-file"},Ua={key:0,class:"code-ref-meta"},Ka={key:1,class:"code-ref-label"},za={class:"code-ref-body"},Ja={key:0,class:"code-ref-error"},Ya={class:"code-ref-pre"},Xa={key:0,class:"code-ref-trunc"},Qa={key:5,class:"table-wrap"},Za=["innerHTML"],el=["innerHTML"],tl={key:6,class:"flow"},sl={class:"label"},nl={class:"desc"},il={key:7},rl={class:"qa-q"},ol={class:"qa-a"},al={__name:"SectionCard",props:{section:{type:Object,required:!0}},setup(e){const t=ft({});function s(i){t.value[i]=!t.value[i]}function n(i){const r=i.lines?`${i.file}#${i.lines}`:i.file;return Oa[r]||{code:"",error:`未找到源码：${i.file}（重新 build 试试）`,lineCount:0}}return(i,r)=>(y(),b("div",{class:Ee(["section",{"accent-border":e.section.accentBorder}])},[x("h2",null,[x("span",qa,M(e.section.emoji),1),un(" "+M(e.section.title)+" ",1),e.section.tag?(y(),b("span",ja,M(e.section.tag),1)):Q("",!0)]),(y(!0),b(D,null,X(e.section.blocks,(o,a)=>(y(),b(D,{key:a},[o.type==="text"?(y(),b("p",{key:0,class:Ee(o.style||""),innerHTML:o.text},null,10,Na)):Q("",!0),o.type==="subtitle"?(y(),b("p",Da,M(o.text),1)):Q("",!0),o.type==="list"?(y(),b("ul",$a,[(y(!0),b(D,null,X(o.items,(l,d)=>(y(),b("li",{key:d,innerHTML:l},null,8,Fa))),128))])):Q("",!0),o.type==="code"?(y(),b("div",{key:3,class:"code",innerHTML:o.code},null,8,Ga)):Q("",!0),o.type==="codeRef"?(y(),b("div",Ha,[x("button",{class:"code-ref-head",onClick:l=>s(a)},[x("span",Ba,M(t.value[a]?"▼":"▶"),1),x("span",Wa,M(o.file),1),n(o).lineCount?(y(),b("span",Ua,M(n(o).lineCount)+" 行",1)):Q("",!0),o.label?(y(),b("span",Ka,"— "+M(o.label),1)):Q("",!0)],8,Va),Ct(x("div",za,[n(o).error?(y(),b("p",Ja,M(n(o).error),1)):(y(),b(D,{key:1},[x("pre",Ya,[x("code",null,M(n(o).code),1)]),n(o).truncated?(y(),b("p",Xa,"… 仅显示前若干行，完整源码见仓库 "+M(o.file),1)):Q("",!0)],64))],512),[[rr,t.value[a]]])])):Q("",!0),o.type==="table"?(y(),b("div",Qa,[x("table",null,[x("tr",null,[(y(!0),b(D,null,X(o.headers,(l,d)=>(y(),b("th",{key:d,innerHTML:l},null,8,Za))),128))]),(y(!0),b(D,null,X(o.rows,(l,d)=>(y(),b("tr",{key:d},[(y(!0),b(D,null,X(l,(u,f)=>(y(),b("td",{key:f,innerHTML:u},null,8,el))),128))]))),128))])])):Q("",!0),o.type==="flow"?(y(),b("div",tl,[(y(!0),b(D,null,X(o.steps,(l,d)=>(y(),b("div",{key:d,class:"flow-step"},[x("span",sl,M(l.label),1),r[0]||(r[0]=x("br",null,null,-1)),x("span",nl,M(l.desc),1)]))),128))])):Q("",!0),o.type==="qa"?(y(),b("div",il,[(y(!0),b(D,null,X(o.items,(l,d)=>(y(),b("div",{key:d,class:"qa-item"},[x("p",rl,[x("strong",null,"Q: "+M(l.q),1)]),x("p",ol,M(l.a),1)]))),128))])):Q("",!0)],64))),128))],2))}},ll={class:"day-content"},cl={class:"day-header"},ul={class:"date"},dl={key:0,class:"lock-badge"},pl={key:0,class:"progress-container"},fl={class:"progress-header"},ml={class:"progress-bar"},hl={class:"progress-desc"},gl={key:1,class:"key-point"},_l={class:"highlight"},vl={class:"footer"},yl={__name:"DayContent",props:{day:{type:Object,required:!0},active:{type:Boolean,default:!1}},setup(e){return(t,s)=>Ct((y(),b("div",ll,[x("div",cl,[x("span",ul,M(e.day.date),1),e.day.locked?(y(),b("span",dl,"🔒 已锁定")):Q("",!0)]),e.day.progress?(y(),b("div",pl,[x("div",fl,[x("span",null,M(e.day.progress.label),1),x("span",null,M(e.day.progress.detail),1)]),x("div",ml,[x("div",{class:"progress-fill",style:Ft({width:e.day.progress.percent+"%"})},M(e.day.progress.text),5)]),x("div",hl,M(e.day.progress.desc),1)])):Q("",!0),e.day.keyPoint?(y(),b("div",gl,[x("p",null,[x("strong",null,M(e.day.keyPoint.title),1)]),(y(!0),b(D,null,X(e.day.keyPoint.highlights,(n,i)=>(y(),b("p",{key:i,style:{"font-size":"1.05rem","text-align":"center",padding:"12px 0"}},[x("span",_l,M(n),1)]))),128)),x("p",null,M(e.day.keyPoint.desc),1)])):Q("",!0),(y(!0),b(D,null,X(e.day.sections,(n,i)=>(y(),Et(al,{key:i,section:n},null,8,["section"]))),128)),x("div",vl,M(e.day.footer),1)],512)),[[rr,e.active]])}},Xn=[{id:"rag-basic",title:"RAG 基本流程",description:"从文档库到 LLM 回答的完整 RAG 流程",steps:[{name:"初始化文档库",description:"准备要检索的文档列表，每个文档是一段知识",code:`文档库 = [
...
阈值 0.95 → 1条自动(10%) 9条人工   # 只放行最确定的`,highlightLines:[1,2,3],variables:[{name:"一级客服",value:"分错代价低→阈值可低(0.6~0.7)"},{name:"退款/账户",value:"分错代价高→阈值调高(0.9)"}],output:"阈值↑ 转人工↑(准但贵)；阈值↓ 自动↑(省但险)"},{name:"4. 生产级分类是分层的",description:'LLM 会"自信地错"(高置信但答错)，所以路由主力不是 LLM，而是便宜可靠的小模型 + 分层兜底。',code:`消息进来：
  ...
  仍低于阈值      → 升级人工`,highlightLines:[2,3,4,5],variables:[{name:"为啥不都用LLM",value:"路由高频调用，大LLM太贵太慢"},{name:"置信度谁更可信",value:"embedding+小模型 > LLM自报"}],output:"✅ 规则→小模型→LLM→人工，分层组合；置信度阈值是最后一道分流闸"}]}],or=(e,t)=>{const s=e.__vccOpts||e;for(const[n,i]of t)s[n]=i;return s},bl={class:"practice-view"},xl={class:"experiment-tabs"},kl=["onClick"],Ll={key:0,class:"debugger"},Al={class:"step-indicator"},Sl=["onClick"],Tl={class:"step-label"},Pl={class:"debugger-main"},Cl={class:"code-panel"},Ml={class:"code-block"},wl={class:"cursor-line",ref:"cursorRef"},Rl={class:"right-sidebar"},Il={class:"state-panel"},El={class:"state-body"},Ol={class:"state-name"},ql={class:"state-value"},jl={key:0,class:"params-panel"},Nl={class:"params-body"},Dl={class:"param-name"},$l={class:"param-val"},Fl={class:"param-desc"},Gl={key:1,class:"sidebar-output"},Hl={class:"output-text"},Vl={class:"step-desc"},Bl={class:"debug-controls"},Wl=["disabled"],Ul=["disabled"],Kl=["disabled"],zl=["disabled"],Jl={key:1,class:"empty-state"},Yl={__name:"PracticeView",setup(e){const t=ft(null),s=ft(0);function n(G){t.value=Xn.find(q=>q.id===G),s.value=0}const i=ot(()=>t.value?t.value.steps[s.value]:{variables:[],output:null,name:"",description:""}),r=ot(()=>t.value?i.value.code.split(`
`):[]);function o(G){const q=i.value.highlightLines;return q&&q.includes(G)}const a=ot(()=>t.value?t.value.steps.length-1:0),l=ot(()=>s.value+1<=a.value),d=ot(()=>s.value>0);function u(){s.value<a.value&&s.value++}function f(){s.value>0&&s.value--}function A(G){G>=0&&G<=a.value&&(s.value=G)}function P(){const G=Math.min(s.value+3,a.value);s.value=G}function $(){const G=Math.max(s.value-3,0);s.value=G}function I(){s.value=0}return(G,q)=>{var F;return y(),b("div",bl,[x("div",xl,[(y(!0),b(D,null,X(mt(Xn),N=>{var C;return y(),b("button",{key:N.id,class:Ee(["exp-btn",{active:((C=t.value)==null?void 0:C.id)===N.id}]),onClick:te=>n(N.id)},M(N.title),11,kl)}),128))]),t.value?(y(),b("div",Ll,[x("div",Al,[(y(!0),b(D,null,X(t.value.steps,(N,C)=>(y(),b("div",{key:C,class:Ee(["step-dot",{active:s.value===C,done:s.value>C}]),onClick:te=>A(C)},null,10,Sl))),128)),x("span",Tl,M(s.value+1)+" / "+M(t.value.steps.length),1)]),x("div",Pl,[x("div",Cl,[q[0]||(q[0]=x("div",{class:"panel-header"},"📄 代码",-1)),x("pre",Ml,[(y(!0),b(D,null,X(r.value,(N,C)=>(y(),b("code",{key:C,class:Ee({highlight:o(C+1)})},M(N),3))),128)),x("span",wl,null,512)])]),x("div",Rl,[x("div",Il,[q[2]||(q[2]=x("div",{class:"panel-header"},"📊 变量状态",-1)),x("div",El,[(y(!0),b(D,null,X(i.value.variables,(N,C)=>(y(),b("div",{key:C,class:"state-row"},[x("span",Ol,M(N.name),1),q[1]||(q[1]=x("span",{class:"state-eq"},"=",-1)),x("span",ql,M(N.value),1)]))),128))])]),(F=i.value.params)!=null&&F.length?(y(),b("div",jl,[q[3]||(q[3]=x("div",{class:"panel-header"},"💡 参数说明",-1)),x("div",Nl,[(y(!0),b(D,null,X(i.value.params,(N,C)=>(y(),b("div",{key:C,class:"param-row"},[x("span",Dl,M(N.name),1),x("span",$l,M(N.value),1),x("span",Fl,M(N.desc),1)]))),128))])])):Q("",!0),i.value.output?(y(),b("div",Gl,[q[4]||(q[4]=x("div",{class:"panel-header"},"📋 输出",-1)),x("pre",Hl,M(i.value.output),1)])):Q("",!0),x("div",Vl,[x("strong",null,M(i.value.name),1),x("p",null,M(i.value.description),1)]),x("div",Bl,[x("button",{class:"ctrl-btn",disabled:s.value===0,onClick:f},"◀ 上一步",8,Wl),x("button",{class:"ctrl-btn",disabled:!d.value,onClick:$},"⏪ 回退",8,Ul),x("button",{class:"ctrl-btn",onClick:I},"🔄 重置"),x("button",{class:"ctrl-btn",disabled:!l.value,onClick:P},"⏭ 跳过",8,Kl),x("button",{class:"ctrl-btn primary",disabled:s.value===a.value,onClick:u},"下一步 ▶",8,zl)])])])])):(y(),b("div",Jl,[...q[5]||(q[5]=[x("p",null,"选择一个实验开始 👆",-1)])]))])}}},Xl=or(Yl,[["__scopeId","data-v-d294aa85"]]),Qn=[["我要退款！！！订单还没发就不想要了","退款",.96],["这个 App 一打开就闪退，安卓 14","bug报告",.93],["你们企业版怎么收费，能开发票吗","销售",.91],["怎么修改收货地址","一级支持",.88],["密码忘了登不进去","一级支持",.84],["那个……之前那个事儿到底咋整啊","一级支持",.41],["钱","退款",.38],["？？？","一级支持",.22],["我想把上次买的会员退了顺便问下新套餐","退款",.55],["系统是不是又崩了我朋友也进不去","bug报告",.79]];function Ql(e){let t=parseFloat(e.threshold);isNaN(t)&&(t=.7),t=Math.max(0,Math.min(t,1));const s=[];let n=0,i=0;const r={};for(const[u,f,A]of Qn){let P,$;A>=t?(P=`自动 → ${f}队列`,$="✓ 自动",n++,r[f]=(r[f]||0)+1):(P="转人工（没把握）",$="⚠ 人工",i++);const I=u.length<=20?u:u.slice(0,20)+"…";s.push([I,f,A.toFixed(2),$,P])}const o=Qn.length,a=n/o,l=Object.entries(r).sort((u,f)=>f[1]-u[1]).map(([u,f])=>[u,String(f)]),d=[{type:"keyvalue",label:"路由结果（当前阈值）",items:{当前阈值:t.toFixed(2),消息总数:o,自动处理:`${n} 条（${Math.round(a*100)}%）`,转人工:`${i} 条（${Math.round(i/o*100)}%）`,省人工程度:a>=.7?"高（机器多担待）":a>=.4?"中":"低（大量转人工）"}},{type:"table",label:"逐条路由（置信度 ≥ 阈值才自动，否则转人工）",headers:["消息","分类器判类别","置信度","决策","去向"],rows:s},l.length?{type:"table",label:"自动处理的按类别分发",headers:["自动分发队列","条数"],rows:l}:{type:"text",label:"自动分发",content:"（当前阈值下无消息自动处理，全转人工）"},{type:"list",label:"要点",items:["置信度 = 分类器'我有多确定'的分数(0~1)；阈值 = 你划的线，低于线就别自动、交人工","阈值越高→转人工越多(准但贵慢)；越低→自动越多(省但错的多)。按“分错的代价”定","一级客服分错代价低→阈值可低(0.6~0.7)；退款/账户安全分错代价高→调高(0.9)","坑：LLM 会'自信地错'(高置信但答错)，置信度更信 embedding+小分类模型，而非 LLM 自报","生产分类分层：规则匹配→小分类模型(主力)→LLM(兜底)→低于阈值升人工"]},{type:"text",label:"怎么玩",content:"试试把阈值从 0.3 拖到 0.95：低阈值几乎全自动(但含糊消息也被硬分)，高阈值只放行最确定的、其余全转人工。这就是练习题1的权衡——没有万能数字，看业务错误代价。"}];return{summary:`阈值 ${t.toFixed(2)}：${n} 条自动（${Math.round(a*100)}%）、${i} 条转人工（${Math.round(i/o*100)}%）`,blocks:d}}const Zl=[{id:"confidence-router",title:"置信度阈值路由（客服分流）",phase:"Phase 14 · Agent 工程",lesson:"12 工作流模式",description:"路由模式落地：分类器给每条消息判类别+置信度，低于阈值转人工。调阈值看自动率/人工率权衡（练习题1）。",inputs:[{name:"threshold",label:"置信度阈值 (0~1)",type:"number",default:.7,help:"低于此值＝分类器没把握→转人工。一级客服可低(0.6~0.7)，高风险业务调高(0.9)"}],run:Ql}],ec={class:"playground-view"},tc={class:"experiment-tabs"},sc=["onClick"],nc={key:0,class:"pg-main"},ic={class:"input-panel"},rc={class:"pg-desc"},oc={class:"pg-tag"},ac={class:"form-body"},lc=["onUpdate:modelValue"],cc=["value"],uc=["onUpdate:modelValue"],dc=["onUpdate:modelValue"],pc={key:3,class:"form-help"},fc={class:"result-panel"},mc={key:0,class:"result-body"},hc={class:"result-summary"},gc={key:0,class:"block-label"},_c={key:1,class:"kv"},vc={class:"kv-key"},yc={class:"kv-val"},bc={key:2,class:"pg-table"},xc={key:3,class:"pg-list"},kc={key:4,class:"score"},Lc={class:"score-bar"},Ac={class:"score-num"},Sc={key:0},Tc={key:5,class:"pg-text"},Pc={key:1,class:"empty-state"},Cc={key:1,class:"empty-state"},Mc={__name:"PlaygroundView",setup(e){const t=Zl,s=ft(null),n=_s({}),i=ft(null);function r(a){s.value=t.find(l=>l.id===a),Object.keys(n).forEach(l=>delete n[l]);for(const l of s.value.inputs)n[l.name]=l.default;i.value=s.value.run({...n})}function o(){s.value&&(i.value=s.value.run({...n}))}return(a,l)=>(y(),b("div",ec,[x("div",tc,[(y(!0),b(D,null,X(mt(t),d=>{var u;return y(),b("button",{key:d.id,class:Ee(["exp-btn",{active:((u=s.value)==null?void 0:u.id)===d.id}]),onClick:f=>r(d.id)},M(d.title),11,sc)}),128))]),s.value?(y(),b("div",nc,[x("div",ic,[l[0]||(l[0]=x("div",{class:"panel-header"},"🎛 输入参数",-1)),x("div",rc,[x("span",oc,M(s.value.phase)+" · "+M(s.value.lesson),1),x("p",null,M(s.value.description),1)]),x("div",ac,[(y(!0),b(D,null,X(s.value.inputs,d=>(y(),b("div",{key:d.name,class:"form-row"},[x("label",null,M(d.label),1),d.type==="select"?Ct((y(),b("select",{key:0,"onUpdate:modelValue":u=>n[d.name]=u},[(y(!0),b(D,null,X(d.options,u=>(y(),b("option",{key:u,value:u},M(u),9,cc))),128))],8,lc)),[[Sa,n[d.name]]]):d.type==="number"?Ct((y(),b("input",{key:1,type:"number",step:"0.05","onUpdate:modelValue":u=>n[d.name]=u},null,8,uc)),[[zn,n[d.name]]]):Ct((y(),b("input",{key:2,type:"text","onUpdate:modelValue":u=>n[d.name]=u},null,8,dc)),[[zn,n[d.name]]]),d.help?(y(),b("p",pc,M(d.help),1)):Q("",!0)]))),128)),x("button",{class:"run-btn",onClick:o},"▶ 运行")])]),x("div",fc,[l[1]||(l[1]=x("div",{class:"panel-header"},"📊 运行结果",-1)),i.value?(y(),b("div",mc,[x("div",hc,M(i.value.summary),1),(y(!0),b(D,null,X(i.value.blocks,(d,u)=>(y(),b("div",{key:u,class:"block"},[d.label?(y(),b("div",gc,M(d.label),1)):Q("",!0),d.type==="keyvalue"?(y(),b("div",_c,[(y(!0),b(D,null,X(d.items,(f,A)=>(y(),b("div",{key:A,class:"kv-row"},[x("span",vc,M(A),1),x("span",yc,M(f),1)]))),128))])):d.type==="table"?(y(),b("table",bc,[x("thead",null,[x("tr",null,[(y(!0),b(D,null,X(d.headers,(f,A)=>(y(),b("th",{key:A},M(f),1))),128))])]),x("tbody",null,[(y(!0),b(D,null,X(d.rows,(f,A)=>(y(),b("tr",{key:A},[(y(!0),b(D,null,X(f,(P,$)=>(y(),b("td",{key:$},M(P),1))),128))]))),128))])])):d.type==="list"?(y(),b("ul",xc,[(y(!0),b(D,null,X(d.items,(f,A)=>(y(),b("li",{key:A},M(f),1))),128))])):d.type==="score"?(y(),b("div",kc,[x("div",Lc,[x("div",{class:"score-fill",style:Ft({width:d.value/(d.max||1)*100+"%"})},null,4)]),x("div",Ac,[un(M(d.value),1),d.hint?(y(),b("span",Sc," · "+M(d.hint),1)):Q("",!0)])])):d.type==="text"?(y(),b("p",Tc,M(d.content),1)):Q("",!0)]))),128))])):(y(),b("div",Pc,"调好参数，点「运行」看结果 👈"))])])):(y(),b("div",Cc,"选择一个实验开始 👆"))]))}},wc=or(Mc,[["__scopeId","data-v-4383edfd"]]),Rc={class:"container"},Ic={class:"tabs-wrap"},Ec={class:"tabs"},Oc=["onClick"],qc={__name:"App",setup(e){const t=zs.days,s=ft(t[t.length-1].id),n=[...t.map(i=>({id:i.id,label:i.label})),{id:"practice",label:"实践"},{id:"playground",label:"🧪 实验台"}];return(i,r)=>(y(),b("div",Rc,[Oe(Ea),x("div",Ic,[x("div",Ec,[(y(),b(D,null,X(n,o=>x("button",{key:o.id,class:Ee(["tab-btn",{active:s.value===o.id}]),onClick:a=>s.value=o.id},M(o.label),11,Oc)),64))])]),(y(!0),b(D,null,X(mt(t),o=>(y(),b(D,{key:o.id},[s.value===o.id?(y(),Et(yl,{key:0,day:o,active:!0},null,8,["day"])):Q("",!0)],64))),128)),s.value==="practice"?(y(),Et(Xl,{key:0})):Q("",!0),s.value==="playground"?(y(),Et(wc,{key:1})):Q("",!0)]))}};Ca(qc).mount("#app");
