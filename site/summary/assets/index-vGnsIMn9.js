...
if __name__ == "__main__":
    run_demo()
`,error:"",lineCount:511,truncated:!1}},La={class:"emoji"},Aa={key:0,class:"tag"},Sa=["innerHTML"],Pa={key:1,class:"section-subtitle"},Ta={key:2},Ca=["innerHTML"],Ma=["innerHTML"],Ra={key:4,class:"code-ref"},wa=["onClick"],Ia={class:"code-ref-arrow"},Ea={class:"code-ref-file"},Oa={key:0,class:"code-ref-meta"},qa={key:1,class:"code-ref-label"},ja={class:"code-ref-body"},Da={key:0,class:"code-ref-error"},Na={class:"code-ref-pre"},Fa={key:0,class:"code-ref-trunc"},Ga={key:5,class:"table-wrap"},$a=["innerHTML"],Ha=["innerHTML"],Va={key:6,class:"flow"},Ba={class:"label"},Wa={class:"desc"},Ka={key:7},Ua={class:"qa-q"},za={class:"qa-a"},Ja={__name:"SectionCard",props:{section:{type:Object,required:!0}},setup(e){const t=Ut({});function s(i){t.value[i]=!t.value[i]}function n(i){const r=i.lines?`${i.file}#${i.lines}`:i.file;return ka[r]||{code:"",error:`未找到源码：${i.file}（重新 build 试试）`,lineCount:0}}return(i,r)=>(P(),C("div",{class:Ge(["section",{"accent-border":e.section.accentBorder}])},[L("h2",null,[L("span",La,D(e.section.emoji),1),Vi(" "+D(e.section.title)+" ",1),e.section.tag?(P(),C("span",Aa,D(e.section.tag),1)):te("",!0)]),(P(!0),C(W,null,ie(e.section.blocks,(o,a)=>(P(),C(W,{key:a},[o.type==="text"?(P(),C("p",{key:0,class:Ge(o.style||""),innerHTML:o.text},null,10,Sa)):te("",!0),o.type==="subtitle"?(P(),C("p",Pa,D(o.text),1)):te("",!0),o.type==="list"?(P(),C("ul",Ta,[(P(!0),C(W,null,ie(o.items,(c,d)=>(P(),C("li",{key:d,innerHTML:c},null,8,Ca))),128))])):te("",!0),o.type==="code"?(P(),C("div",{key:3,class:"code",innerHTML:o.code},null,8,Ma)):te("",!0),o.type==="codeRef"?(P(),C("div",Ra,[L("button",{class:"code-ref-head",onClick:c=>s(a)},[L("span",Ia,D(t.value[a]?"▼":"▶"),1),L("span",Ea,D(o.file),1),n(o).lineCount?(P(),C("span",Oa,D(n(o).lineCount)+" 行",1)):te("",!0),o.label?(P(),C("span",qa,"— "+D(o.label),1)):te("",!0)],8,wa),gi(L("div",ja,[n(o).error?(P(),C("p",Da,D(n(o).error),1)):(P(),C(W,{key:1},[L("pre",Na,[L("code",null,D(n(o).code),1)]),n(o).truncated?(P(),C("p",Fa,"… 仅显示前若干行，完整源码见仓库 "+D(o.file),1)):te("",!0)],64))],512),[[zi,t.value[a]]])])):te("",!0),o.type==="table"?(P(),C("div",Ga,[L("table",null,[L("tr",null,[(P(!0),C(W,null,ie(o.headers,(c,d)=>(P(),C("th",{key:d,innerHTML:c},null,8,$a))),128))]),(P(!0),C(W,null,ie(o.rows,(c,d)=>(P(),C("tr",{key:d},[(P(!0),C(W,null,ie(c,(f,m)=>(P(),C("td",{key:m,innerHTML:f},null,8,Ha))),128))]))),128))])])):te("",!0),o.type==="flow"?(P(),C("div",Va,[(P(!0),C(W,null,ie(o.steps,(c,d)=>(P(),C("div",{key:d,class:"flow-step"},[L("span",Ba,D(c.label),1),r[0]||(r[0]=L("br",null,null,-1)),L("span",Wa,D(c.desc),1)]))),128))])):te("",!0),o.type==="qa"?(P(),C("div",Ka,[(P(!0),C(W,null,ie(o.items,(c,d)=>(P(),C("div",{key:d,class:"qa-item"},[L("p",Ua,[L("strong",null,"Q: "+D(c.q),1)]),L("p",za,D(c.a),1)]))),128))])):te("",!0)],64))),128))],2))}},Ya={class:"day-content"},Xa={class:"day-header"},Qa={class:"date"},Za={key:0,class:"lock-badge"},el={key:0,class:"progress-container"},tl={class:"progress-header"},sl={class:"progress-bar"},nl={class:"progress-desc"},il={key:1,class:"key-point"},rl={class:"highlight"},ol={class:"footer"},al={__name:"DayContent",props:{day:{type:Object,required:!0},active:{type:Boolean,default:!1}},setup(e){return(t,s)=>gi((P(),C("div",Ya,[L("div",Xa,[L("span",Qa,D(e.day.date),1),e.day.locked?(P(),C("span",Za,"🔒 已锁定")):te("",!0)]),e.day.progress?(P(),C("div",el,[L("div",tl,[L("span",null,D(e.day.progress.label),1),L("span",null,D(e.day.progress.detail),1)]),L("div",sl,[L("div",{class:"progress-fill",style:os({width:e.day.progress.percent+"%"})},D(e.day.progress.text),5)]),L("div",nl,D(e.day.progress.desc),1)])):te("",!0),e.day.keyPoint?(P(),C("div",il,[L("p",null,[L("strong",null,D(e.day.keyPoint.title),1)]),(P(!0),C(W,null,ie(e.day.keyPoint.highlights,(n,i)=>(P(),C("p",{key:i,style:{"font-size":"1.05rem","text-align":"center",padding:"12px 0"}},[L("span",rl,D(n),1)]))),128)),L("p",null,D(e.day.keyPoint.desc),1)])):te("",!0),(P(!0),C(W,null,ie(e.day.sections,(n,i)=>(P(),Zt(Ja,{key:i,section:n},null,8,["section"]))),128)),L("div",ol,D(e.day.footer),1)],512)),[[zi,e.active]])}},Fn=[{id:"rag-basic",title:"RAG 基本流程",description:"从文档库到 LLM 回答的完整 RAG 流程",steps:[{name:"初始化文档库",description:"准备要检索的文档列表，每个文档是一段知识",code:`文档库 = [
...
# 3 分层缓存: KV精确→向量→LLM 串行回退(为了省钱提速)`,highlightLines:[1,2,3],variables:[{name:"本实验",value:"过滤+向量，缩范围保准确"},{name:"Mem0",value:"三库并行融合，覆盖三类查询"},{name:"分层缓存",value:"KV→向量→LLM，省钱提速"}],output:'✅ 生产级是"过滤+向量"，不是"KV+向量"两步走'}]}],ll=(e,t)=>{const s=e.__vccOpts||e;for(const[n,i]of t)s[n]=i;return s},cl={class:"practice-view"},ul={class:"experiment-tabs"},fl=["onClick"],dl={key:0,class:"debugger"},pl={class:"step-indicator"},ml=["onClick"],hl={class:"step-label"},gl={class:"debugger-main"},_l={class:"code-panel"},vl={class:"code-block"},yl={class:"cursor-line",ref:"cursorRef"},bl={class:"right-sidebar"},xl={class:"state-panel"},kl={class:"state-body"},Ll={class:"state-name"},Al={class:"state-value"},Sl={key:0,class:"params-panel"},Pl={class:"params-body"},Tl={class:"param-name"},Cl={class:"param-val"},Ml={class:"param-desc"},Rl={key:1,class:"sidebar-output"},wl={class:"output-text"},Il={class:"step-desc"},El={class:"debug-controls"},Ol=["disabled"],ql=["disabled"],jl=["disabled"],Dl=["disabled"],Nl={key:1,class:"empty-state"},Fl={__name:"PracticeView",setup(e){const t=Ut(null),s=Ut(0);function n(F){t.value=Fn.find(O=>O.id===F),s.value=0}const i=rt(()=>t.value?t.value.steps[s.value]:{variables:[],output:null,name:"",description:""}),r=rt(()=>t.value?i.value.code.split(`
`):[]);function o(F){const O=i.value.highlightLines;return O&&O.includes(F)}const a=rt(()=>t.value?t.value.steps.length-1:0),c=rt(()=>s.value+1<=a.value),d=rt(()=>s.value>0);function f(){s.value<a.value&&s.value++}function m(){s.value>0&&s.value--}function A(F){F>=0&&F<=a.value&&(s.value=F)}function T(){const F=Math.min(s.value+3,a.value);s.value=F}function $(){const F=Math.max(s.value-3,0);s.value=F}function I(){s.value=0}return(F,O)=>{var N;return P(),C("div",cl,[L("div",ul,[(P(!0),C(W,null,ie(Rt(Fn),j=>{var S;return P(),C("button",{key:j.id,class:Ge(["exp-btn",{active:((S=t.value)==null?void 0:S.id)===j.id}]),onClick:Z=>n(j.id)},D(j.title),11,fl)}),128))]),t.value?(P(),C("div",dl,[L("div",pl,[(P(!0),C(W,null,ie(t.value.steps,(j,S)=>(P(),C("div",{key:S,class:Ge(["step-dot",{active:s.value===S,done:s.value>S}]),onClick:Z=>A(S)},null,10,ml))),128)),L("span",hl,D(s.value+1)+" / "+D(t.value.steps.length),1)]),L("div",gl,[L("div",_l,[O[0]||(O[0]=L("div",{class:"panel-header"},"📄 代码",-1)),L("pre",vl,[(P(!0),C(W,null,ie(r.value,(j,S)=>(P(),C("code",{key:S,class:Ge({highlight:o(S+1)})},D(j),3))),128)),L("span",yl,null,512)])]),L("div",bl,[L("div",xl,[O[2]||(O[2]=L("div",{class:"panel-header"},"📊 变量状态",-1)),L("div",kl,[(P(!0),C(W,null,ie(i.value.variables,(j,S)=>(P(),C("div",{key:S,class:"state-row"},[L("span",Ll,D(j.name),1),O[1]||(O[1]=L("span",{class:"state-eq"},"=",-1)),L("span",Al,D(j.value),1)]))),128))])]),(N=i.value.params)!=null&&N.length?(P(),C("div",Sl,[O[3]||(O[3]=L("div",{class:"panel-header"},"💡 参数说明",-1)),L("div",Pl,[(P(!0),C(W,null,ie(i.value.params,(j,S)=>(P(),C("div",{key:S,class:"param-row"},[L("span",Tl,D(j.name),1),L("span",Cl,D(j.value),1),L("span",Ml,D(j.desc),1)]))),128))])])):te("",!0),i.value.output?(P(),C("div",Rl,[O[4]||(O[4]=L("div",{class:"panel-header"},"📋 输出",-1)),L("pre",wl,D(i.value.output),1)])):te("",!0),L("div",Il,[L("strong",null,D(i.value.name),1),L("p",null,D(i.value.description),1)]),L("div",El,[L("button",{class:"ctrl-btn",disabled:s.value===0,onClick:m},"◀ 上一步",8,Ol),L("button",{class:"ctrl-btn",disabled:!d.value,onClick:$},"⏪ 回退",8,ql),L("button",{class:"ctrl-btn",onClick:I},"🔄 重置"),L("button",{class:"ctrl-btn",disabled:!c.value,onClick:T},"⏭ 跳过",8,jl),L("button",{class:"ctrl-btn primary",disabled:s.value===a.value,onClick:f},"下一步 ▶",8,Dl)])])])])):(P(),C("div",Nl,[...O[5]||(O[5]=[L("p",null,"选择一个实验开始 👆",-1)])]))])}}},Gl=ll(Fl,[["__scopeId","data-v-d294aa85"]]),$l={class:"container"},Hl={class:"tabs-wrap"},Vl={class:"tabs"},Bl=["onClick"],Wl={__name:"App",setup(e){const t=Fs.days,s=Ut(t[t.length-1].id),n=[...t.map(i=>({id:i.id,label:i.label})),{id:"practice",label:"实践"}];return(i,r)=>(P(),C("div",$l,[Ee(xa),L("div",Hl,[L("div",Vl,[(P(),C(W,null,ie(n,o=>L("button",{key:o.id,class:Ge(["tab-btn",{active:s.value===o.id}]),onClick:a=>s.value=o.id},D(o.label),11,Bl)),64))])]),(P(!0),C(W,null,ie(Rt(t),o=>(P(),C(W,{key:o.id},[s.value===o.id?(P(),Zt(al,{key:0,day:o,active:!0},null,8,["day"])):te("",!0)],64))),128)),s.value==="practice"?(P(),Zt(Gl,{key:0})):te("",!0)]))}};ga(Wl).mount("#app");
