...
* @license MIT
**/function Ys(e){const t=Object.create(null);for(const s of e.split(","))t[s]=1;return s=>s in t}const z={},ct=[],Ee=()=>{},ti=()=>!1,cs=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&(e.charCodeAt(2)>122||e.charCodeAt(2)<97),us=e=>e.startsWith("onUpdate:"),le=Object.assign,Xs=(e,t)=>{const s=e.indexOf(t);s>-1&&e.splice(s,1)},dr=Object.prototype.hasOwnProperty,B=(e,t)=>dr.call(e,t),q=Array.isArray,ut=e=>Dt(e)==="[object Map]",ds=e=>Dt(e)==="[object Set]",bn=e=>Dt(e)==="[object Date]",N=e=>typeof e=="function",ee=e=>typeof e=="string",Oe=e=>typeof e=="symbol",K=e=>e!==null&&typeof e=="object",si=e=>(K(e)||N(e))&&N(e.then)&&N(e.catch),ni=Object.prototype.toString,Dt=e=>ni.call(e),pr=e=>Dt(e).slice(8,-1),ii=e=>Dt(e)==="[object Object]",Qs=e=>ee(e)&&e!=="NaN"&&e[0]!=="-"&&""+parseInt(e,10)===e,Tt=Ys(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),ps=e=>{const t=Object.create(null);return(s=>t[s]||(t[s]=e(s)))},fr=/-\w/g,pe=ps(e=>e.replace(fr,t=>t.slice(1).toUpperCase())),mr=/\B([A-Z])/g,it=ps(e=>e.replace(mr,"-$1").toLowerCase()),fs=ps(e=>e.charAt(0).toUpperCase()+e.slice(1)),Ts=ps(e=>e?`on${fs(e)}`:""),Ie=(e,t)=>!Object.is(e,t),Xt=(e,...t)=>{for(let s=0;s<e.length;s++)e[s](...t)},ri=(e,t,s,n=!1)=>{Object.defineProperty(e,t,{configurable:!0,enumerable:!1,writable:n,value:s})},ms=e=>{const t=parseFloat(e);return isNaN(t)?e:t};let xn;const hs=()=>xn||(xn=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function $t(e){if(q(e)){const t={};for(let s=0;s<e.length;s++){const n=e[s],i=ee(n)?vr(n):$t(n);if(i)for(const r in i)t[r]=i[r]}return t}else if(ee(e)||K(e))return e}const hr=/;(?![^(]*\))/g,gr=/:([^]+)/,_r=/\/\*[^]*?\*\//g;function vr(e){const t={};return e.replace(_r,"").split(hr).forEach(s=>{if(s){const n=s.split(gr);n.length>1&&(t[n[0].trim()]=n[1].trim())}}),t}function he(e){let t="";if(ee(e))t=e;else if(q(e))for(let s=0;s<e.length;s++){const n=he(e[s]);n&&(t+=n+" ")}else if(K(e))for(const s in e)e[s]&&(t+=s+" ");return t.trim()}const yr="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",br=Ys(yr);function oi(e){return!!e||e===""}function xr(e,t){if(e.length!==t.length)return!1;let s=!0;for(let n=0;s&&n<e.length;n++)s=Ft(e[n],t[n]);return s}function Ft(e,t){if(e===t)return!0;let s=bn(e),n=bn(t);if(s||n)return s&&n?e.getTime()===t.getTime():!1;if(s=Oe(e),n=Oe(t),s||n)return e===t;if(s=q(e),n=q(t),s||n)return s&&n?xr(e,t):!1;if(s=K(e),n=K(t),s||n){if(!s||!n)return!1;const i=Object.keys(e).length,r=Object.keys(t).length;if(i!==r)return!1;for(const o in e){const a=e.hasOwnProperty(o),l=t.hasOwnProperty(o);if(a&&!l||!a&&l||!Ft(e[o],t[o]))return!1}}return String(e)===String(t)}function kr(e,t){return e.findIndex(s=>Ft(s,t))}const ai=e=>!!(e&&e.__v_isRef===!0),M=e=>ee(e)?e:e==null?"":q(e)||K(e)&&(e.toString===ni||!N(e.toString))?ai(e)?M(e.value):JSON.stringify(e,li,2):String(e),li=(e,t)=>ai(t)?li(e,t.value):ut(t)?{[`Map(${t.size})`]:[...t.entries()].reduce((s,[n,i],r)=>(s[Ps(n,r)+" =>"]=i,s),{})}:ds(t)?{[`Set(${t.size})`]:[...t.values()].map(s=>Ps(s))}:Oe(t)?Ps(t):K(t)&&!q(t)&&!ii(t)?String(t):t,Ps=(e,t="")=>{var s;return Oe(e)?`Symbol(${(s=e.description)!=null?s:t})`:e};/**
* @vue/reactivity v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let ie;class Lr{constructor(t=!1){this.detached=t,this._active=!0,this._on=0,this.effects=[],this.cleanups=[],this._isPaused=!1,this._warnOnRun=!0,this.__v_skip=!0,!t&&ie&&(ie.active?(this.parent=ie,this.index=(ie.scopes||(ie.scopes=[])).push(this)-1):(this._active=!1,this._warnOnRun=!1))}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let t,s;if(this.scopes)for(t=0,s=this.scopes.length;t<s;t++)this.scopes[t].pause();for(t=0,s=this.effects.length;t<s;t++)this.effects[t].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let t,s;if(this.scopes)for(t=0,s=this.scopes.length;t<s;t++)this.scopes[t].resume();for(t=0,s=this.effects.length;t<s;t++)this.effects[t].resume()}}run(t){if(this._active){const s=ie;try{return ie=this,t()}finally{ie=s}}}on(){++this._on===1&&(this.prevScope=ie,ie=this)}off(){if(this._on>0&&--this._on===0){if(ie===this)ie=this.prevScope;else{let t=ie;for(;t;){if(t.prevScope===this){t.prevScope=this.prevScope;break}t=t.prevScope}}this.prevScope=void 0}}stop(t){if(this._active){this._active=!1;let s,n;for(s=0,n=this.effects.length;s<n;s++)this.effects[s].stop();for(this.effects.length=0,s=0,n=this.cleanups.length;s<n;s++)this.cleanups[s]();if(this.cleanups.length=0,this.scopes){for(s=0,n=this.scopes.length;s<n;s++)this.scopes[s].stop(!0);this.scopes.length=0}if(!this.detached&&this.parent&&!t){const i=this.parent.scopes.pop();i&&i!==this&&(this.parent.scopes[this.index]=i,i.index=this.index)}this.parent=void 0}}}function Ar(){return ie}let Y;const Cs=new WeakSet;class ci{constructor(t){this.fn=t,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.next=void 0,this.cleanup=void 0,this.scheduler=void 0,ie&&(ie.active?ie.effects.push(this):this.flags&=-2)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,Cs.has(this)&&(Cs.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||di(this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,kn(this),pi(this);const t=Y,s=ye;Y=this,ye=!0;try{return this.fn()}finally{fi(this),Y=t,ye=s,this.flags&=-3}}stop(){if(this.flags&1){for(let t=this.deps;t;t=t.nextDep)tn(t);this.deps=this.depsTail=void 0,kn(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?Cs.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){$s(this)&&this.run()}get dirty(){return $s(this)}}let ui=0,Pt,Ct;function di(e,t=!1){if(e.flags|=8,t){e.next=Ct,Ct=e;return}e.next=Pt,Pt=e}function Zs(){ui++}function en(){if(--ui>0)return;if(Ct){let t=Ct;for(Ct=void 0;t;){const s=t.next;t.next=void 0,t.flags&=-9,t=s}}let e;for(;Pt;){let t=Pt;for(Pt=void 0;t;){const s=t.next;if(t.next=void 0,t.flags&=-9,t.flags&1)try{t.trigger()}catch(n){e||(e=n)}t=s}}if(e)throw e}function pi(e){for(let t=e.deps;t;t=t.nextDep)t.version=-1,t.prevActiveLink=t.dep.activeLink,t.dep.activeLink=t}function fi(e){let t,s=e.depsTail,n=s;for(;n;){const i=n.prevDep;n.version===-1?(n===s&&(s=i),tn(n),Sr(n)):t=n,n.dep.activeLink=n.prevActiveLink,n.prevActiveLink=void 0,n=i}e.deps=t,e.depsTail=s}function $s(e){for(let t=e.deps;t;t=t.nextDep)if(t.dep.version!==t.version||t.dep.computed&&(mi(t.dep.computed)||t.dep.version!==t.version))return!0;return!!e._dirty}function mi(e){if(e.flags&4&&!(e.flags&16)||(e.flags&=-17,e.globalVersion===Et)||(e.globalVersion=Et,!e.isSSR&&e.flags&128&&(!e.deps&&!e._dirty||!$s(e))))return;e.flags|=2;const t=e.dep,s=Y,n=ye;Y=e,ye=!0;try{pi(e);const i=e.fn(e._value);(t.version===0||Ie(i,e._value))&&(e.flags|=128,e._value=i,t.version++)}catch(i){throw t.version++,i}finally{Y=s,ye=n,fi(e),e.flags&=-3}}function tn(e,t=!1){const{dep:s,prevSub:n,nextSub:i}=e;if(n&&(n.nextSub=i,e.prevSub=void 0),i&&(i.prevSub=n,e.nextSub=void 0),s.subs===e&&(s.subs=n,!n&&s.computed)){s.computed.flags&=-5;for(let r=s.computed.deps;r;r=r.nextDep)tn(r,!0)}!t&&!--s.sc&&s.map&&s.map.delete(s.key)}function Sr(e){const{prevDep:t,nextDep:s}=e;t&&(t.nextDep=s,e.prevDep=void 0),s&&(s.prevDep=t,e.nextDep=void 0)}let ye=!0;const hi=[];function Ge(){hi.push(ye),ye=!1}function He(){const e=hi.pop();ye=e===void 0?!0:e}function kn(e){const{cleanup:t}=e;if(e.cleanup=void 0,t){const s=Y;Y=void 0;try{t()}finally{Y=s}}}let Et=0;class Tr{constructor(t,s){this.sub=t,this.dep=s,this.version=s.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}}class sn{constructor(t){this.computed=t,this.version=0,this.activeLink=void 0,this.subs=void 0,this.map=void 0,this.key=void 0,this.sc=0,this.__v_skip=!0}track(t){if(!Y||!ye||Y===this.computed)return;let s=this.activeLink;if(s===void 0||s.sub!==Y)s=this.activeLink=new Tr(Y,this),Y.deps?(s.prevDep=Y.depsTail,Y.depsTail.nextDep=s,Y.depsTail=s):Y.deps=Y.depsTail=s,gi(s);else if(s.version===-1&&(s.version=this.version,s.nextDep)){const n=s.nextDep;n.prevDep=s.prevDep,s.prevDep&&(s.prevDep.nextDep=n),s.prevDep=Y.depsTail,s.nextDep=void 0,Y.depsTail.nextDep=s,Y.depsTail=s,Y.deps===s&&(Y.deps=n)}return s}trigger(t){this.version++,Et++,this.notify(t)}notify(t){Zs();try{for(let s=this.subs;s;s=s.prevSub)s.sub.notify()&&s.sub.dep.notify()}finally{en()}}}function gi(e){if(e.dep.sc++,e.sub.flags&4){const t=e.dep.computed;if(t&&!e.dep.subs){t.flags|=20;for(let n=t.deps;n;n=n.nextDep)gi(n)}const s=e.dep.subs;s!==e&&(e.prevSub=s,s&&(s.nextSub=e)),e.dep.subs=e}}const Fs=new WeakMap,tt=Symbol(""),Gs=Symbol(""),Ot=Symbol("");function re(e,t,s){if(ye&&Y){let n=Fs.get(e);n||Fs.set(e,n=new Map);let i=n.get(s);i||(n.set(s,i=new sn),i.map=n,i.key=s),i.track()}}function De(e,t,s,n,i,r){const o=Fs.get(e);if(!o){Et++;return}const a=l=>{l&&l.trigger()};if(Zs(),t==="clear")o.forEach(a);else{const l=q(e),p=l&&Qs(s);if(l&&s==="length"){const u=Number(n);o.forEach((f,h)=>{(h==="length"||h===Ot||!Oe(h)&&h>=u)&&a(f)})}else switch((s!==void 0||o.has(void 0))&&a(o.get(s)),p&&a(o.get(Ot)),t){case"add":l?p&&a(o.get("length")):(a(o.get(tt)),ut(e)&&a(o.get(Gs)));break;case"delete":l||(a(o.get(tt)),ut(e)&&a(o.get(Gs)));break;case"set":ut(e)&&a(o.get(tt));break}}en()}function rt(e){const t=V(e);return t===e?t:(re(t,"iterate",Ot),ve(e)?t:t.map(be))}function gs(e){return re(e=V(e),"iterate",Ot),e}function we(e,t){return Ve(e)?ht(st(e)?be(t):t):be(t)}const Pr={__proto__:null,[Symbol.iterator](){return Ms(this,Symbol.iterator,e=>we(this,e))},concat(...e){return rt(this).concat(...e.map(t=>q(t)?rt(t):t))},entries(){return Ms(this,"entries",e=>(e[1]=we(this,e[1]),e))},every(e,t){return qe(this,"every",e,t,void 0,arguments)},filter(e,t){return qe(this,"filter",e,t,s=>s.map(n=>we(this,n)),arguments)},find(e,t){return qe(this,"find",e,t,s=>we(this,s),arguments)},findIndex(e,t){return qe(this,"findIndex",e,t,void 0,arguments)},findLast(e,t){return qe(this,"findLast",e,t,s=>we(this,s),arguments)},findLastIndex(e,t){return qe(this,"findLastIndex",e,t,void 0,arguments)},forEach(e,t){return qe(this,"forEach",e,t,void 0,arguments)},includes(...e){return ws(this,"includes",e)},indexOf(...e){return ws(this,"indexOf",e)},join(e){return rt(this).join(e)},lastIndexOf(...e){return ws(this,"lastIndexOf",e)},map(e,t){return qe(this,"map",e,t,void 0,arguments)},pop(){return xt(this,"pop")},push(...e){return xt(this,"push",e)},reduce(e,...t){return Ln(this,"reduce",e,t)},reduceRight(e,...t){return Ln(this,"reduceRight",e,t)},shift(){return xt(this,"shift")},some(e,t){return qe(this,"some",e,t,void 0,arguments)},splice(...e){return xt(this,"splice",e)},toReversed(){return rt(this).toReversed()},toSorted(e){return rt(this).toSorted(e)},toSpliced(...e){return rt(this).toSpliced(...e)},unshift(...e){return xt(this,"unshift",e)},values(){return Ms(this,"values",e=>we(this,e))}};function Ms(e,t,s){const n=gs(e),i=n[t]();return n!==e&&!ve(e)&&(i._next=i.next,i.next=()=>{const r=i._next();return r.done||(r.value=s(r.value)),r}),i}const Cr=Array.prototype;function qe(e,t,s,n,i,r){const o=gs(e),a=o!==e&&!ve(e),l=o[t];if(l!==Cr[t]){const f=l.apply(e,r);return a?be(f):f}let p=s;o!==e&&(a?p=function(f,h){return s.call(this,we(e,f),h,e)}:s.length>2&&(p=function(f,h){return s.call(this,f,h,e)}));const u=l.call(o,p,n);return a&&i?i(u):u}function Ln(e,t,s,n){const i=gs(e),r=i!==e&&!ve(e);let o=s,a=!1;i!==e&&(r?(a=n.length===0,o=function(p,u,f){return a&&(a=!1,p=we(e,p)),s.call(this,p,we(e,u),f,e)}):s.length>3&&(o=function(p,u,f){return s.call(this,p,u,f,e)}));const l=i[t](o,...n);return a?we(e,l):l}function ws(e,t,s){const n=V(e);re(n,"iterate",Ot);const i=n[t](...s);return(i===-1||i===!1)&&on(s[0])?(s[0]=V(s[0]),n[t](...s)):i}function xt(e,t,s=[]){Ge(),Zs();const n=V(e)[t].apply(e,s);return en(),He(),n}const Mr=Ys("__proto__,__v_isRef,__isVue"),_i=new Set(Object.getOwnPropertyNames(Symbol).filter(e=>e!=="arguments"&&e!=="caller").map(e=>Symbol[e]).filter(Oe));function wr(e){Oe(e)||(e=String(e));const t=V(this);return re(t,"has",e),t.hasOwnProperty(e)}class vi{constructor(t=!1,s=!1){this._isReadonly=t,this._isShallow=s}get(t,s,n){if(s==="__v_skip")return t.__v_skip;const i=this._isReadonly,r=this._isShallow;if(s==="__v_isReactive")return!i;if(s==="__v_isReadonly")return i;if(s==="__v_isShallow")return r;if(s==="__v_raw")return n===(i?r?Fr:ki:r?xi:bi).get(t)||Object.getPrototypeOf(t)===Object.getPrototypeOf(n)?t:void 0;const o=q(t);if(!i){let l;if(o&&(l=Pr[s]))return l;if(s==="hasOwnProperty")return wr}const a=Reflect.get(t,s,ae(t)?t:n);if((Oe(s)?_i.has(s):Mr(s))||(i||re(t,"get",s),r))return a;if(ae(a)){const l=o&&Qs(s)?a:a.value;return i&&K(l)?Vs(l):l}return K(a)?i?Vs(a):_s(a):a}}class yi extends vi{constructor(t=!1){super(!1,t)}set(t,s,n,i){let r=t[s];const o=q(t)&&Qs(s);if(!this._isShallow){const p=Ve(r);if(!ve(n)&&!Ve(n)&&(r=V(r),n=V(n)),!o&&ae(r)&&!ae(n))return p||(r.value=n),!0}const a=o?Number(s)<t.length:B(t,s),l=Reflect.set(t,s,n,ae(t)?t:i);return t===V(i)&&(a?Ie(n,r)&&De(t,"set",s,n):De(t,"add",s,n)),l}deleteProperty(t,s){const n=B(t,s);t[s];const i=Reflect.deleteProperty(t,s);return i&&n&&De(t,"delete",s,void 0),i}has(t,s){const n=Reflect.has(t,s);return(!Oe(s)||!_i.has(s))&&re(t,"has",s),n}ownKeys(t){return re(t,"iterate",q(t)?"length":tt),Reflect.ownKeys(t)}}class Rr extends vi{constructor(t=!1){super(!0,t)}set(t,s){return!0}deleteProperty(t,s){return!0}}const Ir=new yi,Er=new Rr,Or=new yi(!0);const Hs=e=>e,zt=e=>Reflect.getPrototypeOf(e);function qr(e,t,s){return function(...n){const i=this.__v_raw,r=V(i),o=ut(r),a=e==="entries"||e===Symbol.iterator&&o,l=e==="keys"&&o,p=i[e](...n),u=s?Hs:t?ht:be;return!t&&re(r,"iterate",l?Gs:tt),le(Object.create(p),{next(){const{value:f,done:h}=p.next();return h?{value:f,done:h}:{value:a?[u(f[0]),u(f[1])]:u(f),done:h}}})}}function Jt(e){return function(...t){return e==="delete"?!1:e==="clear"?void 0:this}}function jr(e,t){const s={get(i){const r=this.__v_raw,o=V(r),a=V(i);e||(Ie(i,a)&&re(o,"get",i),re(o,"get",a));const{has:l}=zt(o),p=t?Hs:e?ht:be;if(l.call(o,i))return p(r.get(i));if(l.call(o,a))return p(r.get(a));r!==o&&r.get(i)},get size(){const i=this.__v_raw;return!e&&re(V(i),"iterate",tt),i.size},has(i){const r=this.__v_raw,o=V(r),a=V(i);return e||(Ie(i,a)&&re(o,"has",i),re(o,"has",a)),i===a?r.has(i):r.has(i)||r.has(a)},forEach(i,r){const o=this,a=o.__v_raw,l=V(a),p=t?Hs:e?ht:be;return!e&&re(l,"iterate",tt),a.forEach((u,f)=>i.call(r,p(u),p(f),o))}};return le(s,e?{add:Jt("add"),set:Jt("set"),delete:Jt("delete"),clear:Jt("clear")}:{add(i){const r=V(this),o=zt(r),a=V(i),l=!t&&!ve(i)&&!Ve(i)?a:i;return o.has.call(r,l)||Ie(i,l)&&o.has.call(r,i)||Ie(a,l)&&o.has.call(r,a)||(r.add(l),De(r,"add",l,l)),this},set(i,r){!t&&!ve(r)&&!Ve(r)&&(r=V(r));const o=V(this),{has:a,get:l}=zt(o);let p=a.call(o,i);p||(i=V(i),p=a.call(o,i));const u=l.call(o,i);return o.set(i,r),p?Ie(r,u)&&De(o,"set",i,r):De(o,"add",i,r),this},delete(i){const r=V(this),{has:o,get:a}=zt(r);let l=o.call(r,i);l||(i=V(i),l=o.call(r,i)),a&&a.call(r,i);const p=r.delete(i);return l&&De(r,"delete",i,void 0),p},clear(){const i=V(this),r=i.size!==0,o=i.clear();return r&&De(i,"clear",void 0,void 0),o}}),["keys","values","entries",Symbol.iterator].forEach(i=>{s[i]=qr(i,e,t)}),s}function nn(e,t){const s=jr(e,t);return(n,i,r)=>i==="__v_isReactive"?!e:i==="__v_isReadonly"?e:i==="__v_raw"?n:Reflect.get(B(s,i)&&i in n?s:n,i,r)}const Nr={get:nn(!1,!1)},Dr={get:nn(!1,!0)},$r={get:nn(!0,!1)};const bi=new WeakMap,xi=new WeakMap,ki=new WeakMap,Fr=new WeakMap;function Gr(e){switch(e){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function _s(e){return Ve(e)?e:rn(e,!1,Ir,Nr,bi)}function Hr(e){return rn(e,!1,Or,Dr,xi)}function Vs(e){return rn(e,!0,Er,$r,ki)}function rn(e,t,s,n,i){if(!K(e)||e.__v_raw&&!(t&&e.__v_isReactive)||e.__v_skip||!Object.isExtensible(e))return e;const r=i.get(e);if(r)return r;const o=Gr(pr(e));if(o===0)return e;const a=new Proxy(e,o===2?n:s);return i.set(e,a),a}function st(e){return Ve(e)?st(e.__v_raw):!!(e&&e.__v_isReactive)}function Ve(e){return!!(e&&e.__v_isReadonly)}function ve(e){return!!(e&&e.__v_isShallow)}function on(e){return e?!!e.__v_raw:!1}function V(e){const t=e&&e.__v_raw;return t?V(t):e}function Vr(e){return!B(e,"__v_skip")&&Object.isExtensible(e)&&ri(e,"__v_skip",!0),e}const be=e=>K(e)?_s(e):e,ht=e=>K(e)?Vs(e):e;function ae(e){return e?e.__v_isRef===!0:!1}function nt(e){return Br(e,!1)}function Br(e,t){return ae(e)?e:new Wr(e,t)}class Wr{constructor(t,s){this.dep=new sn,this.__v_isRef=!0,this.__v_isShallow=!1,this._rawValue=s?t:V(t),this._value=s?t:be(t),this.__v_isShallow=s}get value(){return this.dep.track(),this._value}set value(t){const s=this._rawValue,n=this.__v_isShallow||ve(t)||Ve(t);t=n?t:V(t),Ie(t,s)&&(this._rawValue=t,this._value=n?t:be(t),this.dep.trigger())}}function vs(e){return ae(e)?e.value:e}const Kr={get:(e,t,s)=>t==="__v_raw"?e:vs(Reflect.get(e,t,s)),set:(e,t,s,n)=>{const i=e[t];return ae(i)&&!ae(s)?(i.value=s,!0):Reflect.set(e,t,s,n)}};function Li(e){return st(e)?e:new Proxy(e,Kr)}class Ur{constructor(t,s,n){this.fn=t,this.setter=s,this._value=void 0,this.dep=new sn(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=Et-1,this.next=void 0,this.effect=this,this.__v_isReadonly=!s,this.isSSR=n}notify(){if(this.flags|=16,!(this.flags&8)&&Y!==this)return di(this,!0),!0}get value(){const t=this.dep.track();return mi(this),t&&(t.version=this.dep.version),this._value}set value(t){this.setter&&this.setter(t)}}function zr(e,t,s=!1){let n,i;return N(e)?n=e:(n=e.get,i=e.set),new Ur(n,i,s)}const Yt={},es=new WeakMap;let Ze;function Jr(e,t=!1,s=Ze){if(s){let n=es.get(s);n||es.set(s,n=[]),n.push(e)}}function Yr(e,t,s=z){const{immediate:n,deep:i,once:r,scheduler:o,augmentJob:a,call:l}=s,p=C=>i?C:ve(C)||i===!1||i===0?$e(C,1):$e(C);let u,f,h,L,E=!1,w=!1;if(ae(e)?(f=()=>e.value,E=ve(e)):st(e)?(f=()=>p(e),E=!0):q(e)?(w=!0,E=e.some(C=>st(C)||ve(C)),f=()=>e.map(C=>{if(ae(C))return C.value;if(st(C))return p(C);if(N(C))return l?l(C,2):C()})):N(e)?t?f=l?()=>l(e,2):e:f=()=>{if(h){Ge();try{h()}finally{He()}}const C=Ze;Ze=u;try{return l?l(e,3,[L]):e(L)}finally{Ze=C}}:f=Ee,t&&i){const C=f,te=i===!0?1/0:i;f=()=>$e(C(),te)}const F=Ar(),j=()=>{u.stop(),F&&F.active&&Xs(F.effects,u)};if(r&&t){const C=t;t=(...te)=>{const ke=C(...te);return j(),ke}}let G=w?new Array(e.length).fill(Yt):Yt;const D=C=>{if(!(!(u.flags&1)||!u.dirty&&!C))if(t){const te=u.run();if(C||i||E||(w?te.some((ke,Le)=>Ie(ke,G[Le])):Ie(te,G))){h&&h();const ke=Ze;Ze=u;try{const Le=[te,G===Yt?void 0:w&&G[0]===Yt?[]:G,L];G=te,l?l(t,3,Le):t(...Le)}finally{Ze=ke}}}else u.run()};return a&&a(D),u=new ci(f),u.scheduler=o?()=>o(D,!1):D,L=C=>Jr(C,!1,u),h=u.onStop=()=>{const C=es.get(u);if(C){if(l)l(C,4);else for(const te of C)te();es.delete(u)}},t?n?D(!0):G=u.run():o?o(D.bind(null,!0),!0):u.run(),j.pause=u.pause.bind(u),j.resume=u.resume.bind(u),j.stop=j,j}function $e(e,t=1/0,s){if(t<=0||!K(e)||e.__v_skip||(s=s||new Map,(s.get(e)||0)>=t))return e;if(s.set(e,t),t--,ae(e))$e(e.value,t,s);else if(q(e))for(let n=0;n<e.length;n++)$e(e[n],t,s);else if(ds(e)||ut(e))e.forEach(n=>{$e(n,t,s)});else if(ii(e)){for(const n in e)$e(e[n],t,s);for(const n of Object.getOwnPropertySymbols(e))Object.prototype.propertyIsEnumerable.call(e,n)&&$e(e[n],t,s)}return e}/**
* @vue/runtime-core v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function Gt(e,t,s,n){try{return n?e(...n):e()}catch(i){ys(i,t,s)}}function xe(e,t,s,n){if(N(e)){const i=Gt(e,t,s,n);return i&&si(i)&&i.catch(r=>{ys(r,t,s)}),i}if(q(e)){const i=[];for(let r=0;r<e.length;r++)i.push(xe(e[r],t,s,n));return i}}function ys(e,t,s,n=!0){const i=t?t.vnode:null,{errorHandler:r,throwUnhandledErrorInProduction:o}=t&&t.appContext.config||z;if(t){let a=t.parent;const l=t.proxy,p=`https://vuejs.org/error-reference/#runtime-${s}`;for(;a;){const u=a.ec;if(u){for(let f=0;f<u.length;f++)if(u[f](e,l,p)===!1)return}a=a.parent}if(r){Ge(),Gt(r,null,10,[e,l,p]),He();return}}Xr(e,s,i,n,o)}function Xr(e,t,s,n=!0,i=!1){if(i)throw e;console.error(e)}const de=[];let Me=-1;const dt=[];let Ke=null,ot=0;const Ai=Promise.resolve();let ts=null;function Si(e){const t=ts||Ai;return e?t.then(this?e.bind(this):e):t}function Qr(e){let t=Me+1,s=de.length;for(;t<s;){const n=t+s>>>1,i=de[n],r=qt(i);r<e||r===e&&i.flags&2?t=n+1:s=n}return t}function an(e){if(!(e.flags&1)){const t=qt(e),s=de[de.length-1];!s||!(e.flags&2)&&t>=qt(s)?de.push(e):de.splice(Qr(t),0,e),e.flags|=1,Ti()}}function Ti(){ts||(ts=Ai.then(Ci))}function Zr(e){q(e)?dt.push(...e):Ke&&e.id===-1?Ke.splice(ot+1,0,e):e.flags&1||(dt.push(e),e.flags|=1),Ti()}function An(e,t,s=Me+1){for(;s<de.length;s++){const n=de[s];if(n&&n.flags&2){if(e&&n.id!==e.uid)continue;de.splice(s,1),s--,n.flags&4&&(n.flags&=-2),n(),n.flags&4||(n.flags&=-2)}}}function Pi(e){if(dt.length){const t=[...new Set(dt)].sort((s,n)=>qt(s)-qt(n));if(dt.length=0,Ke){Ke.push(...t);return}for(Ke=t,ot=0;ot<Ke.length;ot++){const s=Ke[ot];s.flags&4&&(s.flags&=-2),s.flags&8||s(),s.flags&=-2}Ke=null,ot=0}}const qt=e=>e.id==null?e.flags&2?-1:1/0:e.id;function Ci(e){try{for(Me=0;Me<de.length;Me++){const t=de[Me];t&&!(t.flags&8)&&(t.flags&4&&(t.flags&=-2),Gt(t,t.i,t.i?15:14),t.flags&4||(t.flags&=-2))}}finally{for(;Me<de.length;Me++){const t=de[Me];t&&(t.flags&=-2)}Me=-1,de.length=0,Pi(),ts=null,(de.length||dt.length)&&Ci()}}let ge=null,Mi=null;function ss(e){const t=ge;return ge=e,Mi=e&&e.type.__scopeId||null,t}function wi(e,t=ge,s){if(!t||e._n)return e;const n=(...i)=>{n._d&&jn(-1);const r=ss(t);let o;try{o=e(...i)}finally{ss(r),n._d&&jn(1)}return o};return n._n=!0,n._c=!0,n._d=!0,n}function lt(e,t){if(ge===null)return e;const s=Ls(ge),n=e.dirs||(e.dirs=[]);for(let i=0;i<t.length;i++){let[r,o,a,l=z]=t[i];r&&(N(r)&&(r={mounted:r,updated:r}),r.deep&&$e(o),n.push({dir:r,instance:s,value:o,oldValue:void 0,arg:a,modifiers:l}))}return e}function Xe(e,t,s,n){const i=e.dirs,r=t&&t.dirs;for(let o=0;o<i.length;o++){const a=i[o];r&&(a.oldValue=r[o].value);let l=a.dir[n];l&&(Ge(),xe(l,s,8,[e.el,a,e,t]),He())}}function eo(e,t){if(oe){let s=oe.provides;const n=oe.parent&&oe.parent.provides;n===s&&(s=oe.provides=Object.create(n)),s[e]=t}}function Qt(e,t,s=!1){const n=ta();if(n||pt){let i=pt?pt._context.provides:n?n.parent==null||n.ce?n.vnode.appContext&&n.vnode.appContext.provides:n.parent.provides:void 0;if(i&&e in i)return i[e];if(arguments.length>1)return s&&N(t)?t.call(n&&n.proxy):t}}const to=Symbol.for("v-scx"),so=()=>Qt(to);function Rs(e,t,s){return Ri(e,t,s)}function Ri(e,t,s=z){const{immediate:n,deep:i,flush:r,once:o}=s,a=le({},s),l=t&&n||!t&&r!=="post";let p;if(Nt){if(r==="sync"){const L=so();p=L.__watcherHandles||(L.__watcherHandles=[])}else if(!l){const L=()=>{};return L.stop=Ee,L.resume=Ee,L.pause=Ee,L}}const u=oe;a.call=(L,E,w)=>xe(L,u,E,w);let f=!1;r==="post"?a.scheduler=L=>{fe(L,u&&u.suspense)}:r!=="sync"&&(f=!0,a.scheduler=(L,E)=>{E?L():an(L)}),a.augmentJob=L=>{t&&(L.flags|=4),f&&(L.flags|=2,u&&(L.id=u.uid,L.i=u))};const h=Yr(e,t,a);return Nt&&(p?p.push(h):l&&h()),h}function no(e,t,s){const n=this.proxy,i=ee(e)?e.includes(".")?Ii(n,e):()=>n[e]:e.bind(n,n);let r;N(t)?r=t:(r=t.handler,s=t);const o=Ht(this),a=Ri(i,r.bind(n),s);return o(),a}function Ii(e,t){const s=t.split(".");return()=>{let n=e;for(let i=0;i<s.length&&n;i++)n=n[s[i]];return n}}const io=Symbol("_vte"),ro=e=>e.__isTeleport,Is=Symbol("_leaveCb");function ln(e,t){e.shapeFlag&6&&e.component?(e.transition=t,ln(e.component.subTree,t)):e.shapeFlag&128?(e.ssContent.transition=t.clone(e.ssContent),e.ssFallback.transition=t.clone(e.ssFallback)):e.transition=t}function Ei(e){e.ids=[e.ids[0]+e.ids[2]+++"-",0,0]}function Sn(e,t){let s;return!!((s=Object.getOwnPropertyDescriptor(e,t))&&!s.configurable)}const ns=new WeakMap;function Mt(e,t,s,n,i=!1){if(q(e)){e.forEach((w,F)=>Mt(w,t&&(q(t)?t[F]:t),s,n,i));return}if(wt(n)&&!i){n.shapeFlag&512&&n.type.__asyncResolved&&n.component.subTree.component&&Mt(e,t,s,n.component.subTree);return}const r=n.shapeFlag&4?Ls(n.component):n.el,o=i?null:r,{i:a,r:l}=e,p=t&&t.r,u=a.refs===z?a.refs={}:a.refs,f=a.setupState,h=V(f),L=f===z?ti:w=>Sn(u,w)?!1:B(h,w),E=(w,F)=>!(F&&Sn(u,F));if(p!=null&&p!==l){if(Tn(t),ee(p))u[p]=null,L(p)&&(f[p]=null);else if(ae(p)){const w=t;E(p,w.k)&&(p.value=null),w.k&&(u[w.k]=null)}}if(N(l))Gt(l,a,12,[o,u]);else{const w=ee(l),F=ae(l);if(w||F){const j=()=>{if(e.f){const G=w?L(l)?f[l]:u[l]:E()||!e.k?l.value:u[e.k];if(i)q(G)&&Xs(G,r);else if(q(G))G.includes(r)||G.push(r);else if(w)u[l]=[r],L(l)&&(f[l]=u[l]);else{const D=[r];E(l,e.k)&&(l.value=D),e.k&&(u[e.k]=D)}}else w?(u[l]=o,L(l)&&(f[l]=o)):F&&(E(l,e.k)&&(l.value=o),e.k&&(u[e.k]=o))};if(o){const G=()=>{j(),ns.delete(e)};G.id=-1,ns.set(e,G),fe(G,s)}else Tn(e),j()}}}function Tn(e){const t=ns.get(e);t&&(t.flags|=8,ns.delete(e))}hs().requestIdleCallback;hs().cancelIdleCallback;const wt=e=>!!e.type.__asyncLoader,Oi=e=>e.type.__isKeepAlive;function oo(e,t){qi(e,"a",t)}function ao(e,t){qi(e,"da",t)}function qi(e,t,s=oe){const n=e.__wdc||(e.__wdc=()=>{let i=s;for(;i;){if(i.isDeactivated)return;i=i.parent}return e()});if(bs(t,n,s),s){let i=s.parent;for(;i&&i.parent;)Oi(i.parent.vnode)&&lo(n,t,s,i),i=i.parent}}function lo(e,t,s,n){const i=bs(t,e,n,!0);ji(()=>{Xs(n[t],i)},s)}function bs(e,t,s=oe,n=!1){if(s){const i=s[e]||(s[e]=[]),r=t.__weh||(t.__weh=(...o)=>{Ge();const a=Ht(s),l=xe(t,s,e,o);return a(),He(),l});return n?i.unshift(r):i.push(r),r}}const Be=e=>(t,s=oe)=>{(!Nt||e==="sp")&&bs(e,(...n)=>t(...n),s)},co=Be("bm"),uo=Be("m"),po=Be("bu"),fo=Be("u"),mo=Be("bum"),ji=Be("um"),ho=Be("sp"),go=Be("rtg"),_o=Be("rtc");function vo(e,t=oe){bs("ec",e,t)}const yo="components",Ni=Symbol.for("v-ndc");function bo(e){return ee(e)?xo(yo,e,!1)||e:e||Ni}function xo(e,t,s=!0,n=!1){const i=ge||oe;if(i){const r=i.type;{const a=oa(r,!1);if(a&&(a===t||a===pe(t)||a===fs(pe(t))))return r}const o=Pn(i[e]||r[e],t)||Pn(i.appContext[e],t);return!o&&n?r:o}}function Pn(e,t){return e&&(e[t]||e[pe(t)]||e[fs(pe(t))])}function X(e,t,s,n){let i;const r=s,o=q(e);if(o||ee(e)){const a=o&&st(e);let l=!1,p=!1;a&&(l=!ve(e),p=Ve(e),e=gs(e)),i=new Array(e.length);for(let u=0,f=e.length;u<f;u++)i[u]=t(l?p?ht(be(e[u])):be(e[u]):e[u],u,void 0,r)}else if(typeof e=="number"){i=new Array(e);for(let a=0;a<e;a++)i[a]=t(a+1,a,void 0,r)}else if(K(e))if(e[Symbol.iterator])i=Array.from(e,(a,l)=>t(a,l,void 0,r));else{const a=Object.keys(e);i=new Array(a.length);for(let l=0,p=a.length;l<p;l++){const u=a[l];i[l]=t(e[u],u,l,r)}}else i=[];return i}const Bs=e=>e?ir(e)?Ls(e):Bs(e.parent):null,Rt=le(Object.create(null),{$:e=>e,$el:e=>e.vnode.el,$data:e=>e.data,$props:e=>e.props,$attrs:e=>e.attrs,$slots:e=>e.slots,$refs:e=>e.refs,$parent:e=>Bs(e.parent),$root:e=>Bs(e.root),$host:e=>e.ce,$emit:e=>e.emit,$options:e=>$i(e),$forceUpdate:e=>e.f||(e.f=()=>{an(e.update)}),$nextTick:e=>e.n||(e.n=Si.bind(e.proxy)),$watch:e=>no.bind(e)}),Es=(e,t)=>e!==z&&!e.__isScriptSetup&&B(e,t),ko={get({_:e},t){if(t==="__v_skip")return!0;const{ctx:s,setupState:n,data:i,props:r,accessCache:o,type:a,appContext:l}=e;if(t[0]!=="$"){const h=o[t];if(h!==void 0)switch(h){case 1:return n[t];case 2:return i[t];case 4:return s[t];case 3:return r[t]}else{if(Es(n,t))return o[t]=1,n[t];if(i!==z&&B(i,t))return o[t]=2,i[t];if(B(r,t))return o[t]=3,r[t];if(s!==z&&B(s,t))return o[t]=4,s[t];Ws&&(o[t]=0)}}const p=Rt[t];let u,f;if(p)return t==="$attrs"&&re(e.attrs,"get",""),p(e);if((u=a.__cssModules)&&(u=u[t]))return u;if(s!==z&&B(s,t))return o[t]=4,s[t];if(f=l.config.globalProperties,B(f,t))return f[t]},set({_:e},t,s){const{data:n,setupState:i,ctx:r}=e;return Es(i,t)?(i[t]=s,!0):n!==z&&B(n,t)?(n[t]=s,!0):B(e.props,t)||t[0]==="$"&&t.slice(1)in e?!1:(r[t]=s,!0)},has({_:{data:e,setupState:t,accessCache:s,ctx:n,appContext:i,props:r,type:o}},a){let l;return!!(s[a]||e!==z&&a[0]!=="$"&&B(e,a)||Es(t,a)||B(r,a)||B(n,a)||B(Rt,a)||B(i.config.globalProperties,a)||(l=o.__cssModules)&&l[a])},defineProperty(e,t,s){return s.get!=null?e._.accessCache[t]=0:B(s,"value")&&this.set(e,t,s.value,null),Reflect.defineProperty(e,t,s)}};function Cn(e){return q(e)?e.reduce((t,s)=>(t[s]=null,t),{}):e}let Ws=!0;function Lo(e){const t=$i(e),s=e.proxy,n=e.ctx;Ws=!1,t.beforeCreate&&Mn(t.beforeCreate,e,"bc");const{data:i,computed:r,methods:o,watch:a,provide:l,inject:p,created:u,beforeMount:f,mounted:h,beforeUpdate:L,updated:E,activated:w,deactivated:F,beforeDestroy:j,beforeUnmount:G,destroyed:D,unmounted:C,render:te,renderTracked:ke,renderTriggered:Le,errorCaptured:We,serverPrefetch:Vt,expose:ze,inheritAttrs:_t,components:Bt,directives:Wt,filters:As}=t;if(p&&Ao(p,n,null),o)for(const Z in o){const J=o[Z];N(J)&&(n[Z]=J.bind(s))}if(i){const Z=i.call(s,s);K(Z)&&(e.data=_s(Z))}if(Ws=!0,r)for(const Z in r){const J=r[Z],Je=N(J)?J.bind(s,s):N(J.get)?J.get.bind(s,s):Ee,Kt=!N(J)&&N(J.set)?J.set.bind(s):Ee,Ye=at({get:Je,set:Kt});Object.defineProperty(n,Z,{enumerable:!0,configurable:!0,get:()=>Ye.value,set:Ae=>Ye.value=Ae})}if(a)for(const Z in a)Di(a[Z],n,s,Z);if(l){const Z=N(l)?l.call(s):l;Reflect.ownKeys(Z).forEach(J=>{eo(J,Z[J])})}u&&Mn(u,e,"c");function ce(Z,J){q(J)?J.forEach(Je=>Z(Je.bind(s))):J&&Z(J.bind(s))}if(ce(co,f),ce(uo,h),ce(po,L),ce(fo,E),ce(oo,w),ce(ao,F),ce(vo,We),ce(_o,ke),ce(go,Le),ce(mo,G),ce(ji,C),ce(ho,Vt),q(ze))if(ze.length){const Z=e.exposed||(e.exposed={});ze.forEach(J=>{Object.defineProperty(Z,J,{get:()=>s[J],set:Je=>s[J]=Je,enumerable:!0})})}else e.exposed||(e.exposed={});te&&e.render===Ee&&(e.render=te),_t!=null&&(e.inheritAttrs=_t),Bt&&(e.components=Bt),Wt&&(e.directives=Wt),Vt&&Ei(e)}function Ao(e,t,s=Ee){q(e)&&(e=Ks(e));for(const n in e){const i=e[n];let r;K(i)?"default"in i?r=Qt(i.from||n,i.default,!0):r=Qt(i.from||n):r=Qt(i),ae(r)?Object.defineProperty(t,n,{enumerable:!0,configurable:!0,get:()=>r.value,set:o=>r.value=o}):t[n]=r}}function Mn(e,t,s){xe(q(e)?e.map(n=>n.bind(t.proxy)):e.bind(t.proxy),t,s)}function Di(e,t,s,n){let i=n.includes(".")?Ii(s,n):()=>s[n];if(ee(e)){const r=t[e];N(r)&&Rs(i,r)}else if(N(e))Rs(i,e.bind(s));else if(K(e))if(q(e))e.forEach(r=>Di(r,t,s,n));else{const r=N(e.handler)?e.handler.bind(s):t[e.handler];N(r)&&Rs(i,r,e)}}function $i(e){const t=e.type,{mixins:s,extends:n}=t,{mixins:i,optionsCache:r,config:{optionMergeStrategies:o}}=e.appContext,a=r.get(t);let l;return a?l=a:!i.length&&!s&&!n?l=t:(l={},i.length&&i.forEach(p=>is(l,p,o,!0)),is(l,t,o)),K(t)&&r.set(t,l),l}function is(e,t,s,n=!1){const{mixins:i,extends:r}=t;r&&is(e,r,s,!0),i&&i.forEach(o=>is(e,o,s,!0));for(const o in t)if(!(n&&o==="expose")){const a=So[o]||s&&s[o];e[o]=a?a(e[o],t[o]):t[o]}return e}const So={data:wn,props:Rn,emits:Rn,methods:At,computed:At,beforeCreate:ue,created:ue,beforeMount:ue,mounted:ue,beforeUpdate:ue,updated:ue,beforeDestroy:ue,beforeUnmount:ue,destroyed:ue,unmounted:ue,activated:ue,deactivated:ue,errorCaptured:ue,serverPrefetch:ue,components:At,directives:At,watch:Po,provide:wn,inject:To};function wn(e,t){return t?e?function(){return le(N(e)?e.call(this,this):e,N(t)?t.call(this,this):t)}:t:e}function To(e,t){return At(Ks(e),Ks(t))}function Ks(e){if(q(e)){const t={};for(let s=0;s<e.length;s++)t[e[s]]=e[s];return t}return e}function ue(e,t){return e?[...new Set([].concat(e,t))]:t}function At(e,t){return e?le(Object.create(null),e,t):t}function Rn(e,t){return e?q(e)&&q(t)?[...new Set([...e,...t])]:le(Object.create(null),Cn(e),Cn(t??{})):t}function Po(e,t){if(!e)return t;if(!t)return e;const s=le(Object.create(null),e);for(const n in t)s[n]=ue(e[n],t[n]);return s}function Fi(){return{app:null,config:{isNativeTag:ti,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let Co=0;function Mo(e,t){return function(n,i=null){N(n)||(n=le({},n)),i!=null&&!K(i)&&(i=null);const r=Fi(),o=new WeakSet,a=[];let l=!1;const p=r.app={_uid:Co++,_component:n,_props:i,_container:null,_context:r,_instance:null,version:la,get config(){return r.config},set config(u){},use(u,...f){return o.has(u)||(u&&N(u.install)?(o.add(u),u.install(p,...f)):N(u)&&(o.add(u),u(p,...f))),p},mixin(u){return r.mixins.includes(u)||r.mixins.push(u),p},component(u,f){return f?(r.components[u]=f,p):r.components[u]},directive(u,f){return f?(r.directives[u]=f,p):r.directives[u]},mount(u,f,h){if(!l){const L=p._ceVNode||Fe(n,i);return L.appContext=r,h===!0?h="svg":h===!1&&(h=void 0),e(L,u,h),l=!0,p._container=u,u.__vue_app__=p,Ls(L.component)}},onUnmount(u){a.push(u)},unmount(){l&&(xe(a,p._instance,16),e(null,p._container),delete p._container.__vue_app__)},provide(u,f){return r.provides[u]=f,p},runWithContext(u){const f=pt;pt=p;try{return u()}finally{pt=f}}};return p}}let pt=null;const wo=(e,t)=>t==="modelValue"||t==="model-value"?e.modelModifiers:e[`${t}Modifiers`]||e[`${pe(t)}Modifiers`]||e[`${it(t)}Modifiers`];function Ro(e,t,...s){if(e.isUnmounted)return;const n=e.vnode.props||z;let i=s;const r=t.startsWith("update:"),o=r&&wo(n,t.slice(7));o&&(o.trim&&(i=s.map(u=>ee(u)?u.trim():u)),o.number&&(i=s.map(ms)));let a,l=n[a=Ts(t)]||n[a=Ts(pe(t))];!l&&r&&(l=n[a=Ts(it(t))]),l&&xe(l,e,6,i);const p=n[a+"Once"];if(p){if(!e.emitted)e.emitted={};else if(e.emitted[a])return;e.emitted[a]=!0,xe(p,e,6,i)}}const Io=new WeakMap;function Gi(e,t,s=!1){const n=s?Io:t.emitsCache,i=n.get(e);if(i!==void 0)return i;const r=e.emits;let o={},a=!1;if(!N(e)){const l=p=>{const u=Gi(p,t,!0);u&&(a=!0,le(o,u))};!s&&t.mixins.length&&t.mixins.forEach(l),e.extends&&l(e.extends),e.mixins&&e.mixins.forEach(l)}return!r&&!a?(K(e)&&n.set(e,null),null):(q(r)?r.forEach(l=>o[l]=null):le(o,r),K(e)&&n.set(e,o),o)}function xs(e,t){return!e||!cs(t)?!1:(t=t.slice(2).replace(/Once$/,""),B(e,t[0].toLowerCase()+t.slice(1))||B(e,it(t))||B(e,t))}function In(e){const{type:t,vnode:s,proxy:n,withProxy:i,propsOptions:[r],slots:o,attrs:a,emit:l,render:p,renderCache:u,props:f,data:h,setupState:L,ctx:E,inheritAttrs:w}=e,F=ss(e);let j,G;try{if(s.shapeFlag&4){const C=i||n,te=C;j=Re(p.call(te,C,u,f,L,h,E)),G=a}else{const C=t;j=Re(C.length>1?C(f,{attrs:a,slots:o,emit:l}):C(f,null)),G=t.props?a:Eo(a)}}catch(C){It.length=0,ys(C,e,1),j=Fe(Ue)}let D=j;if(G&&w!==!1){const C=Object.keys(G),{shapeFlag:te}=D;C.length&&te&7&&(r&&C.some(us)&&(G=Oo(G,r)),D=gt(D,G,!1,!0))}return s.dirs&&(D=gt(D,null,!1,!0),D.dirs=D.dirs?D.dirs.concat(s.dirs):s.dirs),s.transition&&ln(D,s.transition),j=D,ss(F),j}const Eo=e=>{let t;for(const s in e)(s==="class"||s==="style"||cs(s))&&((t||(t={}))[s]=e[s]);return t},Oo=(e,t)=>{const s={};for(const n in e)(!us(n)||!(n.slice(9)in t))&&(s[n]=e[n]);return s};function qo(e,t,s){const{props:n,children:i,component:r}=e,{props:o,children:a,patchFlag:l}=t,p=r.emitsOptions;if(t.dirs||t.transition)return!0;if(s&&l>=0){if(l&1024)return!0;if(l&16)return n?En(n,o,p):!!o;if(l&8){const u=t.dynamicProps;for(let f=0;f<u.length;f++){const h=u[f];if(Hi(o,n,h)&&!xs(p,h))return!0}}}else return(i||a)&&(!a||!a.$stable)?!0:n===o?!1:n?o?En(n,o,p):!0:!!o;return!1}function En(e,t,s){const n=Object.keys(t);if(n.length!==Object.keys(e).length)return!0;for(let i=0;i<n.length;i++){const r=n[i];if(Hi(t,e,r)&&!xs(s,r))return!0}return!1}function Hi(e,t,s){const n=e[s],i=t[s];return s==="style"&&K(n)&&K(i)?!Ft(n,i):n!==i}function jo({vnode:e,parent:t,suspense:s},n){for(;t;){const i=t.subTree;if(i.suspense&&i.suspense.activeBranch===e&&(i.suspense.vnode.el=i.el=n,e=i),i===e)(e=t.vnode).el=n,t=t.parent;else break}s&&s.activeBranch===e&&(s.vnode.el=n)}const Vi={},Bi=()=>Object.create(Vi),Wi=e=>Object.getPrototypeOf(e)===Vi;function No(e,t,s,n=!1){const i={},r=Bi();e.propsDefaults=Object.create(null),Ki(e,t,i,r);for(const o in e.propsOptions[0])o in i||(i[o]=void 0);s?e.props=n?i:Hr(i):e.type.props?e.props=i:e.props=r,e.attrs=r}function Do(e,t,s,n){const{props:i,attrs:r,vnode:{patchFlag:o}}=e,a=V(i),[l]=e.propsOptions;let p=!1;if((n||o>0)&&!(o&16)){if(o&8){const u=e.vnode.dynamicProps;for(let f=0;f<u.length;f++){let h=u[f];if(xs(e.emitsOptions,h))continue;const L=t[h];if(l)if(B(r,h))L!==r[h]&&(r[h]=L,p=!0);else{const E=pe(h);i[E]=Us(l,a,E,L,e,!1)}else L!==r[h]&&(r[h]=L,p=!0)}}}else{Ki(e,t,i,r)&&(p=!0);let u;for(const f in a)(!t||!B(t,f)&&((u=it(f))===f||!B(t,u)))&&(l?s&&(s[f]!==void 0||s[u]!==void 0)&&(i[f]=Us(l,a,f,void 0,e,!0)):delete i[f]);if(r!==a)for(const f in r)(!t||!B(t,f))&&(delete r[f],p=!0)}p&&De(e.attrs,"set","")}function Ki(e,t,s,n){const[i,r]=e.propsOptions;let o=!1,a;if(t)for(let l in t){if(Tt(l))continue;const p=t[l];let u;i&&B(i,u=pe(l))?!r||!r.includes(u)?s[u]=p:(a||(a={}))[u]=p:xs(e.emitsOptions,l)||(!(l in n)||p!==n[l])&&(n[l]=p,o=!0)}if(r){const l=V(s),p=a||z;for(let u=0;u<r.length;u++){const f=r[u];s[f]=Us(i,l,f,p[f],e,!B(p,f))}}return o}function Us(e,t,s,n,i,r){const o=e[s];if(o!=null){const a=B(o,"default");if(a&&n===void 0){const l=o.default;if(o.type!==Function&&!o.skipFactory&&N(l)){const{propsDefaults:p}=i;if(s in p)n=p[s];else{const u=Ht(i);n=p[s]=l.call(null,t),u()}}else n=l;i.ce&&i.ce._setProp(s,n)}o[0]&&(r&&!a?n=!1:o[1]&&(n===""||n===it(s))&&(n=!0))}return n}const $o=new WeakMap;function Ui(e,t,s=!1){const n=s?$o:t.propsCache,i=n.get(e);if(i)return i;const r=e.props,o={},a=[];let l=!1;if(!N(e)){const u=f=>{l=!0;const[h,L]=Ui(f,t,!0);le(o,h),L&&a.push(...L)};!s&&t.mixins.length&&t.mixins.forEach(u),e.extends&&u(e.extends),e.mixins&&e.mixins.forEach(u)}if(!r&&!l)return K(e)&&n.set(e,ct),ct;if(q(r))for(let u=0;u<r.length;u++){const f=pe(r[u]);On(f)&&(o[f]=z)}else if(r)for(const u in r){const f=pe(u);if(On(f)){const h=r[u],L=o[f]=q(h)||N(h)?{type:h}:le({},h),E=L.type;let w=!1,F=!0;if(q(E))for(let j=0;j<E.length;++j){const G=E[j],D=N(G)&&G.name;if(D==="Boolean"){w=!0;break}else D==="String"&&(F=!1)}else w=N(E)&&E.name==="Boolean";L[0]=w,L[1]=F,(w||B(L,"default"))&&a.push(f)}}const p=[o,a];return K(e)&&n.set(e,p),p}function On(e){return e[0]!=="$"&&!Tt(e)}const cn=e=>e==="_"||e==="_ctx"||e==="$stable",un=e=>q(e)?e.map(Re):[Re(e)],Fo=(e,t,s)=>{if(t._n)return t;const n=wi((...i)=>un(t(...i)),s);return n._c=!1,n},zi=(e,t,s)=>{const n=e._ctx;for(const i in e){if(cn(i))continue;const r=e[i];if(N(r))t[i]=Fo(i,r,n);else if(r!=null){const o=un(r);t[i]=()=>o}}},Ji=(e,t)=>{const s=un(t);e.slots.default=()=>s},Yi=(e,t,s)=>{for(const n in t)(s||!cn(n))&&(e[n]=t[n])},Go=(e,t,s)=>{const n=e.slots=Bi();if(e.vnode.shapeFlag&32){const i=t._;i?(Yi(n,t,s),s&&ri(n,"_",i,!0)):zi(t,n)}else t&&Ji(e,t)},Ho=(e,t,s)=>{const{vnode:n,slots:i}=e;let r=!0,o=z;if(n.shapeFlag&32){const a=t._;a?s&&a===1?r=!1:Yi(i,t,s):(r=!t.$stable,zi(t,i)),o=t}else t&&(Ji(e,t),o={default:1});if(r)for(const a in i)!cn(a)&&o[a]==null&&delete i[a]},fe=Uo;function Vo(e){return Bo(e)}function Bo(e,t){const s=hs();s.__VUE__=!0;const{insert:n,remove:i,patchProp:r,createElement:o,createText:a,createComment:l,setText:p,setElementText:u,parentNode:f,nextSibling:h,setScopeId:L=Ee,insertStaticContent:E}=e,w=(c,d,m,b=null,_=null,g=null,T=void 0,S=null,A=!!d.dynamicChildren)=>{if(c===d)return;c&&!kt(c,d)&&(b=Ut(c),Ae(c,_,g,!0),c=null),d.patchFlag===-2&&(A=!1,d.dynamicChildren=null);const{type:v,ref:I,shapeFlag:P}=d;switch(v){case ks:F(c,d,m,b);break;case Ue:j(c,d,m,b);break;case qs:c==null&&G(d,m,b,T);break;case $:Bt(c,d,m,b,_,g,T,S,A);break;default:P&1?te(c,d,m,b,_,g,T,S,A):P&6?Wt(c,d,m,b,_,g,T,S,A):(P&64||P&128)&&v.process(c,d,m,b,_,g,T,S,A,yt)}I!=null&&_?Mt(I,c&&c.ref,g,d||c,!d):I==null&&c&&c.ref!=null&&Mt(c.ref,null,g,c,!0)},F=(c,d,m,b)=>{if(c==null)n(d.el=a(d.children),m,b);else{const _=d.el=c.el;d.children!==c.children&&p(_,d.children)}},j=(c,d,m,b)=>{c==null?n(d.el=l(d.children||""),m,b):d.el=c.el},G=(c,d,m,b)=>{[c.el,c.anchor]=E(c.children,d,m,b,c.el,c.anchor)},D=({el:c,anchor:d},m,b)=>{let _;for(;c&&c!==d;)_=h(c),n(c,m,b),c=_;n(d,m,b)},C=({el:c,anchor:d})=>{let m;for(;c&&c!==d;)m=h(c),i(c),c=m;i(d)},te=(c,d,m,b,_,g,T,S,A)=>{if(d.type==="svg"?T="svg":d.type==="math"&&(T="mathml"),c==null)ke(d,m,b,_,g,T,S,A);else{const v=c.el&&c.el._isVueCE?c.el:null;try{v&&v._beginPatch(),Vt(c,d,_,g,T,S,A)}finally{v&&v._endPatch()}}},ke=(c,d,m,b,_,g,T,S)=>{let A,v;const{props:I,shapeFlag:P,transition:R,dirs:O}=c;if(A=c.el=o(c.type,g,I&&I.is,I),P&8?u(A,c.children):P&16&&We(c.children,A,null,b,_,Os(c,g),T,S),O&&Xe(c,null,b,"created"),Le(A,c,c.scopeId,T,b),I){for(const U in I)U!=="value"&&!Tt(U)&&r(A,U,null,I[U],g,b);"value"in I&&r(A,"value",null,I.value,g),(v=I.onVnodeBeforeMount)&&Ce(v,b,c)}O&&Xe(c,null,b,"beforeMount");const H=Wo(_,R);H&&R.beforeEnter(A),n(A,d,m),((v=I&&I.onVnodeMounted)||H||O)&&fe(()=>{try{v&&Ce(v,b,c),H&&R.enter(A),O&&Xe(c,null,b,"mounted")}finally{}},_)},Le=(c,d,m,b,_)=>{if(m&&L(c,m),b)for(let g=0;g<b.length;g++)L(c,b[g]);if(_){let g=_.subTree;if(d===g||er(g.type)&&(g.ssContent===d||g.ssFallback===d)){const T=_.vnode;Le(c,T,T.scopeId,T.slotScopeIds,_.parent)}}},We=(c,d,m,b,_,g,T,S,A=0)=>{for(let v=A;v<c.length;v++){const I=c[v]=S?Ne(c[v]):Re(c[v]);w(null,I,d,m,b,_,g,T,S)}},Vt=(c,d,m,b,_,g,T)=>{const S=d.el=c.el;let{patchFlag:A,dynamicChildren:v,dirs:I}=d;A|=c.patchFlag&16;const P=c.props||z,R=d.props||z;let O;if(m&&Qe(m,!1),(O=R.onVnodeBeforeUpdate)&&Ce(O,m,d,c),I&&Xe(d,c,m,"beforeUpdate"),m&&Qe(m,!0),(P.innerHTML&&R.innerHTML==null||P.textContent&&R.textContent==null)&&u(S,""),v?ze(c.dynamicChildren,v,S,m,b,Os(d,_),g):T||J(c,d,S,null,m,b,Os(d,_),g,!1),A>0){if(A&16)_t(S,P,R,m,_);else if(A&2&&P.class!==R.class&&r(S,"class",null,R.class,_),A&4&&r(S,"style",P.style,R.style,_),A&8){const H=d.dynamicProps;for(let U=0;U<H.length;U++){const W=H[U],se=P[W],ne=R[W];(ne!==se||W==="value")&&r(S,W,se,ne,_,m)}}A&1&&c.children!==d.children&&u(S,d.children)}else!T&&v==null&&_t(S,P,R,m,_);((O=R.onVnodeUpdated)||I)&&fe(()=>{O&&Ce(O,m,d,c),I&&Xe(d,c,m,"updated")},b)},ze=(c,d,m,b,_,g,T)=>{for(let S=0;S<d.length;S++){const A=c[S],v=d[S],I=A.el&&(A.type===$||!kt(A,v)||A.shapeFlag&198)?f(A.el):m;w(A,v,I,null,b,_,g,T,!0)}},_t=(c,d,m,b,_)=>{if(d!==m){if(d!==z)for(const g in d)!Tt(g)&&!(g in m)&&r(c,g,d[g],null,_,b);for(const g in m){if(Tt(g))continue;const T=m[g],S=d[g];T!==S&&g!=="value"&&r(c,g,S,T,_,b)}"value"in m&&r(c,"value",d.value,m.value,_)}},Bt=(c,d,m,b,_,g,T,S,A)=>{const v=d.el=c?c.el:a(""),I=d.anchor=c?c.anchor:a("");let{patchFlag:P,dynamicChildren:R,slotScopeIds:O}=d;O&&(S=S?S.concat(O):O),c==null?(n(v,m,b),n(I,m,b),We(d.children||[],m,I,_,g,T,S,A)):P>0&&P&64&&R&&c.dynamicChildren&&c.dynamicChildren.length===R.length?(ze(c.dynamicChildren,R,m,_,g,T,S),(d.key!=null||_&&d===_.subTree)&&Xi(c,d,!0)):J(c,d,m,I,_,g,T,S,A)},Wt=(c,d,m,b,_,g,T,S,A)=>{d.slotScopeIds=S,c==null?d.shapeFlag&512?_.ctx.activate(d,m,b,T,A):As(d,m,b,_,g,T,A):mn(c,d,A)},As=(c,d,m,b,_,g,T)=>{const S=c.component=ea(c,b,_);if(Oi(c)&&(S.ctx.renderer=yt),sa(S,!1,T),S.asyncDep){if(_&&_.registerDep(S,ce,T),!c.el){const A=S.subTree=Fe(Ue);j(null,A,d,m),c.placeholder=A.el}}else ce(S,c,d,m,_,g,T)},mn=(c,d,m)=>{const b=d.component=c.component;if(qo(c,d,m))if(b.asyncDep&&!b.asyncResolved){Z(b,d,m);return}else b.next=d,b.update();else d.el=c.el,b.vnode=d},ce=(c,d,m,b,_,g,T)=>{const S=()=>{if(c.isMounted){let{next:P,bu:R,u:O,parent:H,vnode:U}=c;{const Te=Qi(c);if(Te){P&&(P.el=U.el,Z(c,P,T)),Te.asyncDep.then(()=>{fe(()=>{c.isUnmounted||v()},_)});return}}let W=P,se;Qe(c,!1),P?(P.el=U.el,Z(c,P,T)):P=U,R&&Xt(R),(se=P.props&&P.props.onVnodeBeforeUpdate)&&Ce(se,H,P,U),Qe(c,!0);const ne=In(c),Se=c.subTree;c.subTree=ne,w(Se,ne,f(Se.el),Ut(Se),c,_,g),P.el=ne.el,W===null&&jo(c,ne.el),O&&fe(O,_),(se=P.props&&P.props.onVnodeUpdated)&&fe(()=>Ce(se,H,P,U),_)}else{let P;const{el:R,props:O}=d,{bm:H,m:U,parent:W,root:se,type:ne}=c,Se=wt(d);Qe(c,!1),H&&Xt(H),!Se&&(P=O&&O.onVnodeBeforeMount)&&Ce(P,W,d),Qe(c,!0);{se.ce&&se.ce._hasShadowRoot()&&se.ce._injectChildStyle(ne,c.parent?c.parent.type:void 0);const Te=c.subTree=In(c);w(null,Te,m,b,c,_,g),d.el=Te.el}if(U&&fe(U,_),!Se&&(P=O&&O.onVnodeMounted)){const Te=d;fe(()=>Ce(P,W,Te),_)}(d.shapeFlag&256||W&&wt(W.vnode)&&W.vnode.shapeFlag&256)&&c.a&&fe(c.a,_),c.isMounted=!0,d=m=b=null}};c.scope.on();const A=c.effect=new ci(S);c.scope.off();const v=c.update=A.run.bind(A),I=c.job=A.runIfDirty.bind(A);I.i=c,I.id=c.uid,A.scheduler=()=>an(I),Qe(c,!0),v()},Z=(c,d,m)=>{d.component=c;const b=c.vnode.props;c.vnode=d,c.next=null,Do(c,d.props,b,m),Ho(c,d.children,m),Ge(),An(c),He()},J=(c,d,m,b,_,g,T,S,A=!1)=>{const v=c&&c.children,I=c?c.shapeFlag:0,P=d.children,{patchFlag:R,shapeFlag:O}=d;if(R>0){if(R&128){Kt(v,P,m,b,_,g,T,S,A);return}else if(R&256){Je(v,P,m,b,_,g,T,S,A);return}}O&8?(I&16&&vt(v,_,g),P!==v&&u(m,P)):I&16?O&16?Kt(v,P,m,b,_,g,T,S,A):vt(v,_,g,!0):(I&8&&u(m,""),O&16&&We(P,m,b,_,g,T,S,A))},Je=(c,d,m,b,_,g,T,S,A)=>{c=c||ct,d=d||ct;const v=c.length,I=d.length,P=Math.min(v,I);let R;for(R=0;R<P;R++){const O=d[R]=A?Ne(d[R]):Re(d[R]);w(c[R],O,m,null,_,g,T,S,A)}v>I?vt(c,_,g,!0,!1,P):We(d,m,b,_,g,T,S,A,P)},Kt=(c,d,m,b,_,g,T,S,A)=>{let v=0;const I=d.length;let P=c.length-1,R=I-1;for(;v<=P&&v<=R;){const O=c[v],H=d[v]=A?Ne(d[v]):Re(d[v]);if(kt(O,H))w(O,H,m,null,_,g,T,S,A);else break;v++}for(;v<=P&&v<=R;){const O=c[P],H=d[R]=A?Ne(d[R]):Re(d[R]);if(kt(O,H))w(O,H,m,null,_,g,T,S,A);else break;P--,R--}if(v>P){if(v<=R){const O=R+1,H=O<I?d[O].el:b;for(;v<=R;)w(null,d[v]=A?Ne(d[v]):Re(d[v]),m,H,_,g,T,S,A),v++}}else if(v>R)for(;v<=P;)Ae(c[v],_,g,!0),v++;else{const O=v,H=v,U=new Map;for(v=H;v<=R;v++){const me=d[v]=A?Ne(d[v]):Re(d[v]);me.key!=null&&U.set(me.key,v)}let W,se=0;const ne=R-H+1;let Se=!1,Te=0;const bt=new Array(ne);for(v=0;v<ne;v++)bt[v]=0;for(v=O;v<=P;v++){const me=c[v];if(se>=ne){Ae(me,_,g,!0);continue}let Pe;if(me.key!=null)Pe=U.get(me.key);else for(W=H;W<=R;W++)if(bt[W-H]===0&&kt(me,d[W])){Pe=W;break}Pe===void 0?Ae(me,_,g,!0):(bt[Pe-H]=v+1,Pe>=Te?Te=Pe:Se=!0,w(me,d[Pe],m,null,_,g,T,S,A),se++)}const _n=Se?Ko(bt):ct;for(W=_n.length-1,v=ne-1;v>=0;v--){const me=H+v,Pe=d[me],vn=d[me+1],yn=me+1<I?vn.el||Zi(vn):b;bt[v]===0?w(null,Pe,m,yn,_,g,T,S,A):Se&&(W<0||v!==_n[W]?Ye(Pe,m,yn,2):W--)}}},Ye=(c,d,m,b,_=null)=>{const{el:g,type:T,transition:S,children:A,shapeFlag:v}=c;if(v&6){Ye(c.component.subTree,d,m,b);return}if(v&128){c.suspense.move(d,m,b);return}if(v&64){T.move(c,d,m,yt);return}if(T===$){n(g,d,m);for(let P=0;P<A.length;P++)Ye(A[P],d,m,b);n(c.anchor,d,m);return}if(T===qs){D(c,d,m);return}if(b!==2&&v&1&&S)if(b===0)S.persisted&&!g[Is]?n(g,d,m):(S.beforeEnter(g),n(g,d,m),fe(()=>S.enter(g),_));else{const{leave:P,delayLeave:R,afterLeave:O}=S,H=()=>{c.ctx.isUnmounted?i(g):n(g,d,m)},U=()=>{const W=g._isLeaving||!!g[Is];g._isLeaving&&g[Is](!0),S.persisted&&!W?H():P(g,()=>{H(),O&&O()})};R?R(g,H,U):U()}else n(g,d,m)},Ae=(c,d,m,b=!1,_=!1)=>{const{type:g,props:T,ref:S,children:A,dynamicChildren:v,shapeFlag:I,patchFlag:P,dirs:R,cacheIndex:O,memo:H}=c;if(P===-2&&(_=!1),S!=null&&(Ge(),Mt(S,null,m,c,!0),He()),O!=null&&(d.renderCache[O]=void 0),I&256){d.ctx.deactivate(c);return}const U=I&1&&R,W=!wt(c);let se;if(W&&(se=T&&T.onVnodeBeforeUnmount)&&Ce(se,d,c),I&6)ur(c.component,m,b);else{if(I&128){c.suspense.unmount(m,b);return}U&&Xe(c,null,d,"beforeUnmount"),I&64?c.type.remove(c,d,m,yt,b):v&&!v.hasOnce&&(g!==$||P>0&&P&64)?vt(v,d,m,!1,!0):(g===$&&P&384||!_&&I&16)&&vt(A,d,m),b&&hn(c)}const ne=H!=null&&O==null;(W&&(se=T&&T.onVnodeUnmounted)||U||ne)&&fe(()=>{se&&Ce(se,d,c),U&&Xe(c,null,d,"unmounted"),ne&&(c.el=null)},m)},hn=c=>{const{type:d,el:m,anchor:b,transition:_}=c;if(d===$){cr(m,b);return}if(d===qs){C(c);return}const g=()=>{i(m),_&&!_.persisted&&_.afterLeave&&_.afterLeave()};if(c.shapeFlag&1&&_&&!_.persisted){const{leave:T,delayLeave:S}=_,A=()=>T(m,g);S?S(c.el,g,A):A()}else g()},cr=(c,d)=>{let m;for(;c!==d;)m=h(c),i(c),c=m;i(d)},ur=(c,d,m)=>{const{bum:b,scope:_,job:g,subTree:T,um:S,m:A,a:v}=c;qn(A),qn(v),b&&Xt(b),_.stop(),g&&(g.flags|=8,Ae(T,c,d,m)),S&&fe(S,d),fe(()=>{c.isUnmounted=!0},d)},vt=(c,d,m,b=!1,_=!1,g=0)=>{for(let T=g;T<c.length;T++)Ae(c[T],d,m,b,_)},Ut=c=>{if(c.shapeFlag&6)return Ut(c.component.subTree);if(c.shapeFlag&128)return c.suspense.next();const d=h(c.anchor||c.el),m=d&&d[io];return m?h(m):d};let Ss=!1;const gn=(c,d,m)=>{let b;c==null?d._vnode&&(Ae(d._vnode,null,null,!0),b=d._vnode.component):w(d._vnode||null,c,d,null,null,null,m),d._vnode=c,Ss||(Ss=!0,An(b),Pi(),Ss=!1)},yt={p:w,um:Ae,m:Ye,r:hn,mt:As,mc:We,pc:J,pbc:ze,n:Ut,o:e};return{render:gn,hydrate:void 0,createApp:Mo(gn)}}function Os({type:e,props:t},s){return s==="svg"&&e==="foreignObject"||s==="mathml"&&e==="annotation-xml"&&t&&t.encoding&&t.encoding.includes("html")?void 0:s}function Qe({effect:e,job:t},s){s?(e.flags|=32,t.flags|=4):(e.flags&=-33,t.flags&=-5)}function Wo(e,t){return(!e||e&&!e.pendingBranch)&&t&&!t.persisted}function Xi(e,t,s=!1){const n=e.children,i=t.children;if(q(n)&&q(i))for(let r=0;r<n.length;r++){const o=n[r];let a=i[r];a.shapeFlag&1&&!a.dynamicChildren&&((a.patchFlag<=0||a.patchFlag===32)&&(a=i[r]=Ne(i[r]),a.el=o.el),!s&&a.patchFlag!==-2&&Xi(o,a)),a.type===ks&&(a.patchFlag===-1&&(a=i[r]=Ne(a)),a.el=o.el),a.type===Ue&&!a.el&&(a.el=o.el)}}function Ko(e){const t=e.slice(),s=[0];let n,i,r,o,a;const l=e.length;for(n=0;n<l;n++){const p=e[n];if(p!==0){if(i=s[s.length-1],e[i]<p){t[n]=i,s.push(n);continue}for(r=0,o=s.length-1;r<o;)a=r+o>>1,e[s[a]]<p?r=a+1:o=a;p<e[s[r]]&&(r>0&&(t[n]=s[r-1]),s[r]=n)}}for(r=s.length,o=s[r-1];r-- >0;)s[r]=o,o=t[o];return s}function Qi(e){const t=e.subTree.component;if(t)return t.asyncDep&&!t.asyncResolved?t:Qi(t)}function qn(e){if(e)for(let t=0;t<e.length;t++)e[t].flags|=8}function Zi(e){if(e.placeholder)return e.placeholder;const t=e.component;return t?Zi(t.subTree):null}const er=e=>e.__isSuspense;function Uo(e,t){t&&t.pendingBranch?q(e)?t.effects.push(...e):t.effects.push(e):Zr(e)}const $=Symbol.for("v-fgt"),ks=Symbol.for("v-txt"),Ue=Symbol.for("v-cmt"),qs=Symbol.for("v-stc"),It=[];let _e=null;function y(e=!1){It.push(_e=e?null:[])}function zo(){It.pop(),_e=It[It.length-1]||null}let jt=1;function jn(e,t=!1){jt+=e,e<0&&_e&&t&&(_e.hasOnce=!0)}function tr(e){return e.dynamicChildren=jt>0?_e||ct:null,zo(),jt>0&&_e&&_e.push(e),e}function k(e,t,s,n,i,r){return tr(x(e,t,s,n,i,r,!0))}function ft(e,t,s,n,i){return tr(Fe(e,t,s,n,i,!0))}function sr(e){return e?e.__v_isVNode===!0:!1}function kt(e,t){return e.type===t.type&&e.key===t.key}const nr=({key:e})=>e??null,Zt=({ref:e,ref_key:t,ref_for:s})=>(typeof e=="number"&&(e=""+e),e!=null?ee(e)||ae(e)||N(e)?{i:ge,r:e,k:t,f:!!s}:e:null);function x(e,t=null,s=null,n=0,i=null,r=e===$?0:1,o=!1,a=!1){const l={__v_isVNode:!0,__v_skip:!0,type:e,props:t,key:t&&nr(t),ref:t&&Zt(t),scopeId:Mi,slotScopeIds:null,children:s,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:r,patchFlag:n,dynamicProps:i,dynamicChildren:null,appContext:null,ctx:ge};return a?(pn(l,s),r&128&&e.normalize(l)):s&&(l.shapeFlag|=ee(s)?8:16),jt>0&&!o&&_e&&(l.patchFlag>0||r&6)&&l.patchFlag!==32&&_e.push(l),l}const Fe=Jo;function Jo(e,t=null,s=null,n=0,i=null,r=!1){if((!e||e===Ni)&&(e=Ue),sr(e)){const a=gt(e,t,!0);return s&&pn(a,s),jt>0&&!r&&_e&&(a.shapeFlag&6?_e[_e.indexOf(e)]=a:_e.push(a)),a.patchFlag=-2,a}if(aa(e)&&(e=e.__vccOpts),t){t=Yo(t);let{class:a,style:l}=t;a&&!ee(a)&&(t.class=he(a)),K(l)&&(on(l)&&!q(l)&&(l=le({},l)),t.style=$t(l))}const o=ee(e)?1:er(e)?128:ro(e)?64:K(e)?4:N(e)?2:0;return x(e,t,s,n,i,o,r,!0)}function Yo(e){return e?on(e)||Wi(e)?le({},e):e:null}function gt(e,t,s=!1,n=!1){const{props:i,ref:r,patchFlag:o,children:a,transition:l}=e,p=t?Xo(i||{},t):i,u={__v_isVNode:!0,__v_skip:!0,type:e.type,props:p,key:p&&nr(p),ref:t&&t.ref?s&&r?q(r)?r.concat(Zt(t)):[r,Zt(t)]:Zt(t):r,scopeId:e.scopeId,slotScopeIds:e.slotScopeIds,children:a,target:e.target,targetStart:e.targetStart,targetAnchor:e.targetAnchor,staticCount:e.staticCount,shapeFlag:e.shapeFlag,patchFlag:t&&e.type!==$?o===-1?16:o|16:o,dynamicProps:e.dynamicProps,dynamicChildren:e.dynamicChildren,appContext:e.appContext,dirs:e.dirs,transition:l,component:e.component,suspense:e.suspense,ssContent:e.ssContent&&gt(e.ssContent),ssFallback:e.ssFallback&&gt(e.ssFallback),placeholder:e.placeholder,el:e.el,anchor:e.anchor,ctx:e.ctx,ce:e.ce};return l&&n&&ln(u,l.clone(u)),u}function dn(e=" ",t=0){return Fe(ks,null,e,t)}function Q(e="",t=!1){return t?(y(),ft(Ue,null,e)):Fe(Ue,null,e)}function Re(e){return e==null||typeof e=="boolean"?Fe(Ue):q(e)?Fe($,null,e.slice()):sr(e)?Ne(e):Fe(ks,null,String(e))}function Ne(e){return e.el===null&&e.patchFlag!==-1||e.memo?e:gt(e)}function pn(e,t){let s=0;const{shapeFlag:n}=e;if(t==null)t=null;else if(q(t))s=16;else if(typeof t=="object")if(n&65){const i=t.default;i&&(i._c&&(i._d=!1),pn(e,i()),i._c&&(i._d=!0));return}else{s=32;const i=t._;!i&&!Wi(t)?t._ctx=ge:i===3&&ge&&(ge.slots._===1?t._=1:(t._=2,e.patchFlag|=1024))}else N(t)?(t={default:t,_ctx:ge},s=32):(t=String(t),n&64?(s=16,t=[dn(t)]):s=8);e.children=t,e.shapeFlag|=s}function Xo(...e){const t={};for(let s=0;s<e.length;s++){const n=e[s];for(const i in n)if(i==="class")t.class!==n.class&&(t.class=he([t.class,n.class]));else if(i==="style")t.style=$t([t.style,n.style]);else if(cs(i)){const r=t[i],o=n[i];o&&r!==o&&!(q(r)&&r.includes(o))?t[i]=r?[].concat(r,o):o:o==null&&r==null&&!us(i)&&(t[i]=o)}else i!==""&&(t[i]=n[i])}return t}function Ce(e,t,s,n=null){xe(e,t,7,[s,n])}const Qo=Fi();let Zo=0;function ea(e,t,s){const n=e.type,i=(t?t.appContext:e.appContext)||Qo,r={uid:Zo++,vnode:e,type:n,parent:t,appContext:i,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new Lr(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:t?t.provides:Object.create(i.provides),ids:t?t.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:Ui(n,i),emitsOptions:Gi(n,i),emit:null,emitted:null,propsDefaults:z,inheritAttrs:n.inheritAttrs,ctx:z,data:z,props:z,attrs:z,slots:z,refs:z,setupState:z,setupContext:null,suspense:s,suspenseId:s?s.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return r.ctx={_:r},r.root=t?t.root:r,r.emit=Ro.bind(null,r),e.ce&&e.ce(r),r}let oe=null;const ta=()=>oe||ge;let rs,zs;{const e=hs(),t=(s,n)=>{let i;return(i=e[s])||(i=e[s]=[]),i.push(n),r=>{i.length>1?i.forEach(o=>o(r)):i[0](r)}};rs=t("__VUE_INSTANCE_SETTERS__",s=>oe=s),zs=t("__VUE_SSR_SETTERS__",s=>Nt=s)}const Ht=e=>{const t=oe;return rs(e),e.scope.on(),()=>{e.scope.off(),rs(t)}},Nn=()=>{oe&&oe.scope.off(),rs(null)};function ir(e){return e.vnode.shapeFlag&4}let Nt=!1;function sa(e,t=!1,s=!1){t&&zs(t);const{props:n,children:i}=e.vnode,r=ir(e);No(e,n,r,t),Go(e,i,s||t);const o=r?na(e,t):void 0;return t&&zs(!1),o}function na(e,t){const s=e.type;e.accessCache=Object.create(null),e.proxy=new Proxy(e.ctx,ko);const{setup:n}=s;if(n){Ge();const i=e.setupContext=n.length>1?ra(e):null,r=Ht(e),o=Gt(n,e,0,[e.props,i]),a=si(o);if(He(),r(),(a||e.sp)&&!wt(e)&&Ei(e),a){if(o.then(Nn,Nn),t)return o.then(l=>{Dn(e,l)}).catch(l=>{ys(l,e,0)});e.asyncDep=o}else Dn(e,o)}else rr(e)}function Dn(e,t,s){N(t)?e.type.__ssrInlineRender?e.ssrRender=t:e.render=t:K(t)&&(e.setupState=Li(t)),rr(e)}function rr(e,t,s){const n=e.type;e.render||(e.render=n.render||Ee);{const i=Ht(e);Ge();try{Lo(e)}finally{He(),i()}}}const ia={get(e,t){return re(e,"get",""),e[t]}};function ra(e){const t=s=>{e.exposed=s||{}};return{attrs:new Proxy(e.attrs,ia),slots:e.slots,emit:e.emit,expose:t}}function Ls(e){return e.exposed?e.exposeProxy||(e.exposeProxy=new Proxy(Li(Vr(e.exposed)),{get(t,s){if(s in t)return t[s];if(s in Rt)return Rt[s](e)},has(t,s){return s in t||s in Rt}})):e.proxy}function oa(e,t=!0){return N(e)?e.displayName||e.name:e.name||t&&e.__name}function aa(e){return N(e)&&"__vccOpts"in e}const at=(e,t)=>zr(e,t,Nt),la="3.5.38";/**
* @vue/runtime-dom v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let Js;const $n=typeof window<"u"&&window.trustedTypes;if($n)try{Js=$n.createPolicy("vue",{createHTML:e=>e})}catch{}const or=Js?e=>Js.createHTML(e):e=>e,ca="http://www.w3.org/2000/svg",ua="http://www.w3.org/1998/Math/MathML",je=typeof document<"u"?document:null,Fn=je&&je.createElement("template"),da={insert:(e,t,s)=>{t.insertBefore(e,s||null)},remove:e=>{const t=e.parentNode;t&&t.removeChild(e)},createElement:(e,t,s,n)=>{const i=t==="svg"?je.createElementNS(ca,e):t==="mathml"?je.createElementNS(ua,e):s?je.createElement(e,{is:s}):je.createElement(e);return e==="select"&&n&&n.multiple!=null&&i.setAttribute("multiple",n.multiple),i},createText:e=>je.createTextNode(e),createComment:e=>je.createComment(e),setText:(e,t)=>{e.nodeValue=t},setElementText:(e,t)=>{e.textContent=t},parentNode:e=>e.parentNode,nextSibling:e=>e.nextSibling,querySelector:e=>je.querySelector(e),setScopeId(e,t){e.setAttribute(t,"")},insertStaticContent(e,t,s,n,i,r){const o=s?s.previousSibling:t.lastChild;if(i&&(i===r||i.nextSibling))for(;t.insertBefore(i.cloneNode(!0),s),!(i===r||!(i=i.nextSibling)););else{Fn.innerHTML=or(n==="svg"?`<svg>${e}</svg>`:n==="mathml"?`<math>${e}</math>`:e);const a=Fn.content;if(n==="svg"||n==="mathml"){const l=a.firstChild;for(;l.firstChild;)a.appendChild(l.firstChild);a.removeChild(l)}t.insertBefore(a,s)}return[o?o.nextSibling:t.firstChild,s?s.previousSibling:t.lastChild]}},pa=Symbol("_vtc");function fa(e,t,s){const n=e[pa];n&&(t=(t?[t,...n]:[...n]).join(" ")),t==null?e.removeAttribute("class"):s?e.setAttribute("class",t):e.className=t}const os=Symbol("_vod"),ar=Symbol("_vsh"),lr={name:"show",beforeMount(e,{value:t},{transition:s}){e[os]=e.style.display==="none"?"":e.style.display,s&&t?s.beforeEnter(e):Lt(e,t)},mounted(e,{value:t},{transition:s}){s&&t&&s.enter(e)},updated(e,{value:t,oldValue:s},{transition:n}){!t!=!s&&(n?t?(n.beforeEnter(e),Lt(e,!0),n.enter(e)):n.leave(e,()=>{Lt(e,!1)}):Lt(e,t))},beforeUnmount(e,{value:t}){Lt(e,t)}};function Lt(e,t){e.style.display=t?e[os]:"none",e[ar]=!t}const ma=Symbol(""),ha=/(?:^|;)\s*display\s*:/;function ga(e,t,s){const n=e.style,i=ee(s);let r=!1;if(s&&!i){if(t)if(ee(t))for(const o of t.split(";")){const a=o.slice(0,o.indexOf(":")).trim();s[a]==null&&St(n,a,"")}else for(const o in t)s[o]==null&&St(n,o,"");for(const o in s){o==="display"&&(r=!0);const a=s[o];a!=null?va(e,o,!ee(t)&&t?t[o]:void 0,a)||St(n,o,a):St(n,o,"")}}else if(i){if(t!==s){const o=n[ma];o&&(s+=";"+o),n.cssText=s,r=ha.test(s)}}else t&&e.removeAttribute("style");os in e&&(e[os]=r?n.display:"",e[ar]&&(n.display="none"))}const Gn=/\s*!important$/;function St(e,t,s){if(q(s))s.forEach(n=>St(e,t,n));else if(s==null&&(s=""),t.startsWith("--"))e.setProperty(t,s);else{const n=_a(e,t);Gn.test(s)?e.setProperty(it(n),s.replace(Gn,""),"important"):e[n]=s}}const Hn=["Webkit","Moz","ms"],js={};function _a(e,t){const s=js[t];if(s)return s;let n=pe(t);if(n!=="filter"&&n in e)return js[t]=n;n=fs(n);for(let i=0;i<Hn.length;i++){const r=Hn[i]+n;if(r in e)return js[t]=r}return t}function va(e,t,s,n){return e.tagName==="TEXTAREA"&&(t==="width"||t==="height")&&ee(n)&&s===n}const Vn="http://www.w3.org/1999/xlink";function Bn(e,t,s,n,i,r=br(t)){n&&t.startsWith("xlink:")?s==null?e.removeAttributeNS(Vn,t.slice(6,t.length)):e.setAttributeNS(Vn,t,s):s==null||r&&!oi(s)?e.removeAttribute(t):e.setAttribute(t,r?"":Oe(s)?String(s):s)}function Wn(e,t,s,n,i){if(t==="innerHTML"||t==="textContent"){s!=null&&(e[t]=t==="innerHTML"?or(s):s);return}const r=e.tagName;if(t==="value"&&r!=="PROGRESS"&&!r.includes("-")){const a=r==="OPTION"?e.getAttribute("value")||"":e.value,l=s==null?e.type==="checkbox"?"on":"":String(s);(a!==l||!("_value"in e))&&(e.value=l),s==null&&e.removeAttribute(t),e._value=s;return}let o=!1;if(s===""||s==null){const a=typeof e[t];a==="boolean"?s=oi(s):s==null&&a==="string"?(s="",o=!0):a==="number"&&(s=0,o=!0)}try{e[t]=s}catch{}o&&e.removeAttribute(i||t)}function et(e,t,s,n){e.addEventListener(t,s,n)}function ya(e,t,s,n){e.removeEventListener(t,s,n)}const Kn=Symbol("_vei");function ba(e,t,s,n,i=null){const r=e[Kn]||(e[Kn]={}),o=r[t];if(n&&o)o.value=n;else{const[a,l]=xa(t);if(n){const p=r[t]=Aa(n,i);et(e,a,p,l)}else o&&(ya(e,a,o,l),r[t]=void 0)}}const Un=/(?:Once|Passive|Capture)$/;function xa(e){let t;if(Un.test(e)){t={};let n;for(;n=e.match(Un);)e=e.slice(0,e.length-n[0].length),t[n[0].toLowerCase()]=!0}return[e[2]===":"?e.slice(3):it(e.slice(2)),t]}let Ns=0;const ka=Promise.resolve(),La=()=>Ns||(ka.then(()=>Ns=0),Ns=Date.now());function Aa(e,t){const s=n=>{if(!n._vts)n._vts=Date.now();else if(n._vts<=s.attached)return;const i=s.value;if(q(i)){const r=n.stopImmediatePropagation;n.stopImmediatePropagation=()=>{r.call(n),n._stopped=!0};const o=i.slice(),a=[n];for(let l=0;l<o.length&&!n._stopped;l++){const p=o[l];p&&xe(p,t,5,a)}}else xe(i,t,5,[n])};return s.value=e,s.attached=La(),s}const zn=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&e.charCodeAt(2)>96&&e.charCodeAt(2)<123,Sa=(e,t,s,n,i,r)=>{const o=i==="svg";t==="class"?fa(e,n,o):t==="style"?ga(e,s,n):cs(t)?us(t)||ba(e,t,s,n,r):(t[0]==="."?(t=t.slice(1),!0):t[0]==="^"?(t=t.slice(1),!1):Ta(e,t,n,o))?(Wn(e,t,n),!e.tagName.includes("-")&&(t==="value"||t==="checked"||t==="selected")&&Bn(e,t,n,o,r,t!=="value")):e._isVueCE&&(Pa(e,t)||e._def.__asyncLoader&&(/[A-Z]/.test(t)||!ee(n)))?Wn(e,pe(t),n,r,t):(t==="true-value"?e._trueValue=n:t==="false-value"&&(e._falseValue=n),Bn(e,t,n,o))};function Ta(e,t,s,n){if(n)return!!(t==="innerHTML"||t==="textContent"||t in e&&zn(t)&&N(s));if(t==="spellcheck"||t==="draggable"||t==="translate"||t==="autocorrect"||t==="sandbox"&&e.tagName==="IFRAME"||t==="form"||t==="list"&&e.tagName==="INPUT"||t==="type"&&e.tagName==="TEXTAREA")return!1;if(t==="width"||t==="height"){const i=e.tagName;if(i==="IMG"||i==="VIDEO"||i==="CANVAS"||i==="SOURCE")return!1}return zn(t)&&ee(s)?!1:t in e}function Pa(e,t){const s=e._def.props;if(!s)return!1;const n=pe(t);return Array.isArray(s)?s.some(i=>pe(i)===n):Object.keys(s).some(i=>pe(i)===n)}const as=e=>{const t=e.props["onUpdate:modelValue"]||!1;return q(t)?s=>Xt(t,s):t};function Ca(e){e.target.composing=!0}function Jn(e){const t=e.target;t.composing&&(t.composing=!1,t.dispatchEvent(new Event("input")))}const mt=Symbol("_assign");function Yn(e,t,s){return t&&(e=e.trim()),s&&(e=ms(e)),e}const Ds={created(e,{modifiers:{lazy:t,trim:s,number:n}},i){e[mt]=as(i);const r=n||i.props&&i.props.type==="number";et(e,t?"change":"input",o=>{o.target.composing||e[mt](Yn(e.value,s,r))}),(s||r)&&et(e,"change",()=>{e.value=Yn(e.value,s,r)}),t||(et(e,"compositionstart",Ca),et(e,"compositionend",Jn),et(e,"change",Jn))},mounted(e,{value:t}){e.value=t??""},beforeUpdate(e,{value:t,oldValue:s,modifiers:{lazy:n,trim:i,number:r}},o){if(e[mt]=as(o),e.composing)return;const a=(r||e.type==="number")&&!/^0\d/.test(e.value)?ms(e.value):e.value,l=t??"";if(a===l)return;const p=e.getRootNode();(p instanceof Document||p instanceof ShadowRoot)&&p.activeElement===e&&e.type!=="range"&&(n&&t===s||i&&e.value.trim()===l)||(e.value=l)}},Ma={deep:!0,created(e,{value:t,modifiers:{number:s}},n){const i=ds(t);et(e,"change",()=>{const r=Array.prototype.filter.call(e.options,o=>o.selected).map(o=>s?ms(ls(o)):ls(o));e[mt](e.multiple?i?new Set(r):r:r[0]),e._assigning=!0,Si(()=>{e._assigning=!1})}),e[mt]=as(n)},mounted(e,{value:t}){Xn(e,t)},beforeUpdate(e,t,s){e[mt]=as(s)},updated(e,{value:t}){e._assigning||Xn(e,t)}};function Xn(e,t){const s=e.multiple,n=q(t);if(!(s&&!n&&!ds(t))){for(let i=0,r=e.options.length;i<r;i++){const o=e.options[i],a=ls(o);if(s)if(n){const l=typeof a;l==="string"||l==="number"?o.selected=t.some(p=>String(p)===String(a)):o.selected=kr(t,a)>-1}else o.selected=t.has(a);else if(Ft(ls(o),t)){e.selectedIndex!==i&&(e.selectedIndex=i);return}}!s&&e.selectedIndex!==-1&&(e.selectedIndex=-1)}}function ls(e){return"_value"in e?e._value:e.value}const wa=le({patchProp:Sa},da);let Qn;function Ra(){return Qn||(Qn=Vo(wa))}const Ia=((...e)=>{const t=Ra().createApp(...e),{mount:s}=t;return t.mount=n=>{const i=Oa(n);if(!i)return;const r=t._component;!N(r)&&!r.render&&!r.template&&(r.template=i.innerHTML),i.nodeType===1&&(i.textContent="");const o=s(i,!1,Ea(i));return i instanceof Element&&(i.removeAttribute("v-cloak"),i.setAttribute("data-v-app","")),o},t});function Ea(e){if(e instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&e instanceof MathMLElement)return"mathml"}function Oa(e){return ee(e)?document.querySelector(e):e}const qa={days:[{id:1,label:"Day 1",date:"2026年6月17日 · 基础入门",locked:!0,footer:"Day 1 · 2026-06-17 · 🔒 已锁定",progress:{label:"当前进度",detail:"Phase 11 · 已学 6/22 课",percent:28,text:"~30h / 209h",desc:"环境搭建 → LLM 工程 → 工具协议 → Agent → 多智能体 → 生产部署"},sections:[{emoji:"🛠",title:"1. 环境搭建",tag:"完成",blocks:[{type:"list",items:['配置了公司的 Anthropic 兼容 API：<span class="highlight">base_url=http://llmapi.bilibili.co</span>',"安装了 Python 包：anthropic, openai, sentence-transformers, numpy","跑通了第一次 API 调用"]},{type:"code",code:'client = anthropic.Anthropic(api_key="...", base_url="http://llmapi.bilibili.co")'}]},{emoji:"📝",title:"2. Prompt 工程",tag:"Phase 11-01",blocks:[{type:"list",items:["<strong>System Message</strong> — 设置身份和全局规则","<strong>User Message</strong> — 具体任务","<strong>Assistant Prefill</strong> — 预先写回复开头，控制输出格式","角色越具体，输出质量越高"]}]},{emoji:"💡",title:"3. Few-Shot & 思维链",tag:"Phase 11-02",blocks:[{type:"table",headers:["技术","做法","适用场景"],rows:[["Few-Shot","先给 3-5 个例子再问","格式敏感任务"],["Chain-of-Thought",'加"请一步一步思考"',"数学、逻辑推理"],["Self-Consistency","跑多次取多数答案","高准确率要求"],["Tree-of-Thought","多条路径探索评估选最优","复杂规划问题"]]}]},{emoji:"📋",title:"4. 结构化输出",tag:"Phase 11-03",blocks:[{type:"list",items:["应用需要 JSON，模型给的是自然语言 → 需要告诉模型格式",'3 种方式：Prompt 说"返回JSON" → 给 JSON 模板 → JSON 模板 + try/except','<span class="highlight">try/except</span> 捕获 JSON 解析失败，兜底处理']}]},{emoji:"🔢",title:"5. Embeddings",tag:"Phase 11-04",blocks:[{type:"list",items:["<strong>Embedding</strong> = 把文字转成一串数字（向量）","意思相近的文字 → 向量距离近 → 余弦相似度高",'中文用 <span class="highlight">shibing624/text2vec-base-chinese</span>']},{type:"code",code:"相似度 = (向量A · 向量B) / (|向量A| × |向量B|)"}]},{emoji:"📐",title:"6. 上下文工程",tag:"Phase 11-05",blocks:[{type:"list",items:["上下文窗口是稀缺资源，不是越大越好","<strong>Lost-in-the-Middle</strong> — 模型最关注开头和结尾","<strong>三明治原则：</strong>重要信息放开头和结尾"]},{type:"code",code:"System → 工具定义 → 检索文档 → 对话历史 → 当前问题 → 最后指令"}]},{emoji:"📚",title:"7. RAG 检索增强生成",tag:"Phase 11-06",blocks:[{type:"list",items:["<strong>RAG 四步：</strong>文档向量化 → 问题转向量 → 搜索最相似文档 → 文档+问题一起给模型","比微调便宜百倍，数据随时更新，可追溯来源"]},{type:"code",code:"相似度 = (doc_vectors @ q_vec.T).flatten() / (norm_doc * norm_q)"}]},{emoji:"⚡",title:"8. 高级 RAG",tag:"Phase 11-07",blocks:[{type:"table",headers:["改进","做法"],rows:[["关键词提权","向量相似度 + 命中关键词加分"],["兜底搜索","向量搜不到就换关键词搜"],["误判过滤","相似度低于阈值的文档不用"]]}]},{emoji:"⚙️",title:"9. Function Calling",tag:"Phase 11-09",blocks:[{type:"list",items:['模型输出结构化 JSON 说"我要调什么函数、参数是什么"',"<strong>你的代码执行工具，模型只做决策</strong>","完整 6 步循环：定义工具 → 传给模型 → 模型决定用哪个 → 代码执行 → 结果还回 → 模型最终回答"]}]},{emoji:"💰",title:"10. 缓存与成本优化",tag:"Phase 11-11",blocks:[{type:"list",items:["40-60% 的提问是同一意思换说法 → <strong>语义缓存</strong>","问题转向量，相似度超过阈值就返回缓存结果，不调 API"]}]},{emoji:"🐍",title:"Python 基础语法（Day 1 遇到的）",blocks:[{type:"table",headers:["语法","作用","例子"],rows:[["def","定义函数","def 加法(a,b): return a+b"],["for x in 列表","遍历",'for 水果 in ["苹果"]:'],["if/else","条件判断","if 分数 > 0.8:"],["try/except","捕获错误","try: json.loads(x)"],['f"你好{名字}"',"字符串嵌入变量",'f"温度是{度}度"']]}]}]},{id:2,label:"Day 2",date:"2026年6月18日 · RAG 文档管理 + PDF 处理 + LoRA 微调",locked:!1,footer:"Day 2 · 2026-06-18 · PDF 处理 + LoRA 微调实战",keyPoint:{title:"今日核心问题",highlights:["文档中的表格和图片怎么存到 RAG 里？","怎么用 LoRA 微调模型改变它的回答风格？"],desc:"上午跑通了 RAG 文档更新方案的完整链路，下午从原理到手写代码到 Colab 实战，完整跑通了 LoRA 微调。"},sections:[{emoji:"🔄",title:"1. 文档更新了怎么办？",blocks:[{type:"table",headers:["方案","做法","适合场景"],rows:[["删旧重新编","更新文档 → 删旧向量 → 重新 encode","单篇更新，最常用"],["定时全量重建","每天凌晨全部重新向量化","文档稳定，实时性不高"],["事件驱动","文档系统主动通知（webhook）","有飞书/语雀平台"]]}]},{emoji:"🔍",title:"2. 怎么知道文档变没变？",blocks:[{type:"table",headers:["方法","粒度","速度","原理"],rows:[['<span class="highlight">mtime</span>',"整个文件","几毫秒","读文件修改时间戳"],['<span class="highlight">MD5</span>',"每个内容块","需要读内容","算文本哈希值"]]}]},{emoji:"🧩",title:'3. 文档怎么"切块"存？',blocks:[{type:"code",code:`原始文档（3000字）
...
if __name__ == "__main__":
    run_demo()
`,error:"",lineCount:511,truncated:!1}},Na={class:"emoji"},Da={key:0,class:"tag"},$a=["innerHTML"],Fa={key:1,class:"section-subtitle"},Ga={key:2},Ha=["innerHTML"],Va=["innerHTML"],Ba={key:4,class:"code-ref"},Wa=["onClick"],Ka={class:"code-ref-arrow"},Ua={class:"code-ref-file"},za={key:0,class:"code-ref-meta"},Ja={key:1,class:"code-ref-label"},Ya={class:"code-ref-body"},Xa={key:0,class:"code-ref-error"},Qa={class:"code-ref-pre"},Za={key:0,class:"code-ref-trunc"},el={key:5,class:"table-wrap"},tl=["innerHTML"],sl=["innerHTML"],nl={key:6,class:"flow"},il={class:"label"},rl={class:"desc"},ol={key:7},al={class:"qa-q"},ll={class:"qa-a"},cl={__name:"SectionCard",props:{section:{type:Object,required:!0}},setup(e){const t=nt({});function s(i){t.value[i]=!t.value[i]}function n(i){const r=i.lines?`${i.file}#${i.lines}`:i.file;return ja[r]||{code:"",error:`未找到源码：${i.file}（重新 build 试试）`,lineCount:0}}return(i,r)=>(y(),k("div",{class:he(["section",{"accent-border":e.section.accentBorder}])},[x("h2",null,[x("span",Na,M(e.section.emoji),1),dn(" "+M(e.section.title)+" ",1),e.section.tag?(y(),k("span",Da,M(e.section.tag),1)):Q("",!0)]),(y(!0),k($,null,X(e.section.blocks,(o,a)=>(y(),k($,{key:a},[o.type==="text"?(y(),k("p",{key:0,class:he(o.style||""),innerHTML:o.text},null,10,$a)):Q("",!0),o.type==="subtitle"?(y(),k("p",Fa,M(o.text),1)):Q("",!0),o.type==="list"?(y(),k("ul",Ga,[(y(!0),k($,null,X(o.items,(l,p)=>(y(),k("li",{key:p,innerHTML:l},null,8,Ha))),128))])):Q("",!0),o.type==="code"?(y(),k("div",{key:3,class:"code",innerHTML:o.code},null,8,Va)):Q("",!0),o.type==="codeRef"?(y(),k("div",Ba,[x("button",{class:"code-ref-head",onClick:l=>s(a)},[x("span",Ka,M(t.value[a]?"▼":"▶"),1),x("span",Ua,M(o.file),1),n(o).lineCount?(y(),k("span",za,M(n(o).lineCount)+" 行",1)):Q("",!0),o.label?(y(),k("span",Ja,"— "+M(o.label),1)):Q("",!0)],8,Wa),lt(x("div",Ya,[n(o).error?(y(),k("p",Xa,M(n(o).error),1)):(y(),k($,{key:1},[x("pre",Qa,[x("code",null,M(n(o).code),1)]),n(o).truncated?(y(),k("p",Za,"… 仅显示前若干行，完整源码见仓库 "+M(o.file),1)):Q("",!0)],64))],512),[[lr,t.value[a]]])])):Q("",!0),o.type==="table"?(y(),k("div",el,[x("table",null,[x("tr",null,[(y(!0),k($,null,X(o.headers,(l,p)=>(y(),k("th",{key:p,innerHTML:l},null,8,tl))),128))]),(y(!0),k($,null,X(o.rows,(l,p)=>(y(),k("tr",{key:p},[(y(!0),k($,null,X(l,(u,f)=>(y(),k("td",{key:f,innerHTML:u},null,8,sl))),128))]))),128))])])):Q("",!0),o.type==="flow"?(y(),k("div",nl,[(y(!0),k($,null,X(o.steps,(l,p)=>(y(),k("div",{key:p,class:"flow-step"},[x("span",il,M(l.label),1),r[0]||(r[0]=x("br",null,null,-1)),x("span",rl,M(l.desc),1)]))),128))])):Q("",!0),o.type==="qa"?(y(),k("div",ol,[(y(!0),k($,null,X(o.items,(l,p)=>(y(),k("div",{key:p,class:"qa-item"},[x("p",al,[x("strong",null,"Q: "+M(l.q),1)]),x("p",ll,M(l.a),1)]))),128))])):Q("",!0)],64))),128))],2))}},ul={class:"day-content"},dl={class:"day-header"},pl={class:"date"},fl={key:0,class:"lock-badge"},ml={key:0,class:"progress-container"},hl={class:"progress-header"},gl={class:"progress-bar"},_l={class:"progress-desc"},vl={key:1,class:"key-point"},yl={class:"highlight"},bl={class:"footer"},xl={__name:"DayContent",props:{day:{type:Object,required:!0},active:{type:Boolean,default:!1}},setup(e){return(t,s)=>lt((y(),k("div",ul,[x("div",dl,[x("span",pl,M(e.day.date),1),e.day.locked?(y(),k("span",fl,"🔒 已锁定")):Q("",!0)]),e.day.progress?(y(),k("div",ml,[x("div",hl,[x("span",null,M(e.day.progress.label),1),x("span",null,M(e.day.progress.detail),1)]),x("div",gl,[x("div",{class:"progress-fill",style:$t({width:e.day.progress.percent+"%"})},M(e.day.progress.text),5)]),x("div",_l,M(e.day.progress.desc),1)])):Q("",!0),e.day.keyPoint?(y(),k("div",vl,[x("p",null,[x("strong",null,M(e.day.keyPoint.title),1)]),(y(!0),k($,null,X(e.day.keyPoint.highlights,(n,i)=>(y(),k("p",{key:i,style:{"font-size":"1.05rem","text-align":"center",padding:"12px 0"}},[x("span",yl,M(n),1)]))),128)),x("p",null,M(e.day.keyPoint.desc),1)])):Q("",!0),(y(!0),k($,null,X(e.day.sections,(n,i)=>(y(),ft(cl,{key:i,section:n},null,8,["section"]))),128)),x("div",bl,M(e.day.footer),1)],512)),[[lr,e.active]])}},Zn=[{id:"rag-basic",title:"RAG 基本流程",description:"从文档库到 LLM 回答的完整 RAG 流程",steps:[{name:"初始化文档库",description:"准备要检索的文档列表，每个文档是一段知识",code:`文档库 = [
...
阈值 0.95 → 1条自动(10%) 9条人工   # 只放行最确定的`,highlightLines:[1,2,3],variables:[{name:"一级客服",value:"分错代价低→阈值可低(0.6~0.7)"},{name:"退款/账户",value:"分错代价高→阈值调高(0.9)"}],output:"阈值↑ 转人工↑(准但贵)；阈值↓ 自动↑(省但险)"},{name:"4. 生产级分类是分层的",description:'LLM 会"自信地错"(高置信但答错)，所以路由主力不是 LLM，而是便宜可靠的小模型 + 分层兜底。',code:`消息进来：
  ...
  仍低于阈值      → 升级人工`,highlightLines:[2,3,4,5],variables:[{name:"为啥不都用LLM",value:"路由高频调用，大LLM太贵太慢"},{name:"置信度谁更可信",value:"embedding+小模型 > LLM自报"}],output:"✅ 规则→小模型→LLM→人工，分层组合；置信度阈值是最后一道分流闸"}]}],fn=(e,t)=>{const s=e.__vccOpts||e;for(const[n,i]of t)s[n]=i;return s},kl={class:"practice-view"},Ll={class:"experiment-tabs"},Al=["onClick"],Sl={key:0,class:"debugger"},Tl={class:"step-indicator"},Pl=["onClick"],Cl={class:"step-label"},Ml={class:"debugger-main"},wl={class:"code-panel"},Rl={class:"code-block"},Il={class:"cursor-line",ref:"cursorRef"},El={class:"right-sidebar"},Ol={class:"state-panel"},ql={class:"state-body"},jl={class:"state-name"},Nl={class:"state-value"},Dl={key:0,class:"params-panel"},$l={class:"params-body"},Fl={class:"param-name"},Gl={class:"param-val"},Hl={class:"param-desc"},Vl={key:1,class:"sidebar-output"},Bl={class:"output-text"},Wl={class:"step-desc"},Kl={class:"debug-controls"},Ul=["disabled"],zl=["disabled"],Jl=["disabled"],Yl=["disabled"],Xl={key:1,class:"empty-state"},Ql={__name:"PracticeView",setup(e){const t=nt(null),s=nt(0);function n(F){t.value=Zn.find(j=>j.id===F),s.value=0}const i=at(()=>t.value?t.value.steps[s.value]:{variables:[],output:null,name:"",description:""}),r=at(()=>t.value?i.value.code.split(`
`):[]);function o(F){const j=i.value.highlightLines;return j&&j.includes(F)}const a=at(()=>t.value?t.value.steps.length-1:0),l=at(()=>s.value+1<=a.value),p=at(()=>s.value>0);function u(){s.value<a.value&&s.value++}function f(){s.value>0&&s.value--}function h(F){F>=0&&F<=a.value&&(s.value=F)}function L(){const F=Math.min(s.value+3,a.value);s.value=F}function E(){const F=Math.max(s.value-3,0);s.value=F}function w(){s.value=0}return(F,j)=>{var G;return y(),k("div",kl,[x("div",Ll,[(y(!0),k($,null,X(vs(Zn),D=>{var C;return y(),k("button",{key:D.id,class:he(["exp-btn",{active:((C=t.value)==null?void 0:C.id)===D.id}]),onClick:te=>n(D.id)},M(D.title),11,Al)}),128))]),t.value?(y(),k("div",Sl,[x("div",Tl,[(y(!0),k($,null,X(t.value.steps,(D,C)=>(y(),k("div",{key:C,class:he(["step-dot",{active:s.value===C,done:s.value>C}]),onClick:te=>h(C)},null,10,Pl))),128)),x("span",Cl,M(s.value+1)+" / "+M(t.value.steps.length),1)]),x("div",Ml,[x("div",wl,[j[0]||(j[0]=x("div",{class:"panel-header"},"📄 代码",-1)),x("pre",Rl,[(y(!0),k($,null,X(r.value,(D,C)=>(y(),k("code",{key:C,class:he({highlight:o(C+1)})},M(D),3))),128)),x("span",Il,null,512)])]),x("div",El,[x("div",Ol,[j[2]||(j[2]=x("div",{class:"panel-header"},"📊 变量状态",-1)),x("div",ql,[(y(!0),k($,null,X(i.value.variables,(D,C)=>(y(),k("div",{key:C,class:"state-row"},[x("span",jl,M(D.name),1),j[1]||(j[1]=x("span",{class:"state-eq"},"=",-1)),x("span",Nl,M(D.value),1)]))),128))])]),(G=i.value.params)!=null&&G.length?(y(),k("div",Dl,[j[3]||(j[3]=x("div",{class:"panel-header"},"💡 参数说明",-1)),x("div",$l,[(y(!0),k($,null,X(i.value.params,(D,C)=>(y(),k("div",{key:C,class:"param-row"},[x("span",Fl,M(D.name),1),x("span",Gl,M(D.value),1),x("span",Hl,M(D.desc),1)]))),128))])])):Q("",!0),i.value.output?(y(),k("div",Vl,[j[4]||(j[4]=x("div",{class:"panel-header"},"📋 输出",-1)),x("pre",Bl,M(i.value.output),1)])):Q("",!0),x("div",Wl,[x("strong",null,M(i.value.name),1),x("p",null,M(i.value.description),1)]),x("div",Kl,[x("button",{class:"ctrl-btn",disabled:s.value===0,onClick:f},"◀ 上一步",8,Ul),x("button",{class:"ctrl-btn",disabled:!p.value,onClick:E},"⏪ 回退",8,zl),x("button",{class:"ctrl-btn",onClick:w},"🔄 重置"),x("button",{class:"ctrl-btn",disabled:!l.value,onClick:L},"⏭ 跳过",8,Jl),x("button",{class:"ctrl-btn primary",disabled:s.value===a.value,onClick:u},"下一步 ▶",8,Yl)])])])])):(y(),k("div",Xl,[...j[5]||(j[5]=[x("p",null,"选择一个实验开始 👆",-1)])]))])}}},Zl=fn(Ql,[["__scopeId","data-v-d294aa85"]]),ei=[["我要退款！！！订单还没发就不想要了","退款",.96],["这个 App 一打开就闪退，安卓 14","bug报告",.93],["你们企业版怎么收费，能开发票吗","销售",.91],["怎么修改收货地址","一级支持",.88],["密码忘了登不进去","一级支持",.84],["那个……之前那个事儿到底咋整啊","一级支持",.41],["钱","退款",.38],["？？？","一级支持",.22],["我想把上次买的会员退了顺便问下新套餐","退款",.55],["系统是不是又崩了我朋友也进不去","bug报告",.79]];function ec(e){let t=parseFloat(e.threshold);isNaN(t)&&(t=.7),t=Math.max(0,Math.min(t,1));const s=[];let n=0,i=0;const r={};for(const[u,f,h]of ei){let L,E;h>=t?(L=`自动 → ${f}队列`,E="✓ 自动",n++,r[f]=(r[f]||0)+1):(L="转人工（没把握）",E="⚠ 人工",i++);const w=u.length<=20?u:u.slice(0,20)+"…";s.push([w,f,h.toFixed(2),E,L])}const o=ei.length,a=n/o,l=Object.entries(r).sort((u,f)=>f[1]-u[1]).map(([u,f])=>[u,String(f)]),p=[{type:"keyvalue",label:"路由结果（当前阈值）",items:{当前阈值:t.toFixed(2),消息总数:o,自动处理:`${n} 条（${Math.round(a*100)}%）`,转人工:`${i} 条（${Math.round(i/o*100)}%）`,省人工程度:a>=.7?"高（机器多担待）":a>=.4?"中":"低（大量转人工）"}},{type:"table",label:"逐条路由（置信度 ≥ 阈值才自动，否则转人工）",headers:["消息","分类器判类别","置信度","决策","去向"],rows:s},l.length?{type:"table",label:"自动处理的按类别分发",headers:["自动分发队列","条数"],rows:l}:{type:"text",label:"自动分发",content:"（当前阈值下无消息自动处理，全转人工）"},{type:"list",label:"要点",items:["置信度 = 分类器'我有多确定'的分数(0~1)；阈值 = 你划的线，低于线就别自动、交人工","阈值越高→转人工越多(准但贵慢)；越低→自动越多(省但错的多)。按“分错的代价”定","一级客服分错代价低→阈值可低(0.6~0.7)；退款/账户安全分错代价高→调高(0.9)","坑：LLM 会'自信地错'(高置信但答错)，置信度更信 embedding+小分类模型，而非 LLM 自报","生产分类分层：规则匹配→小分类模型(主力)→LLM(兜底)→低于阈值升人工"]},{type:"text",label:"怎么玩",content:"试试把阈值从 0.3 拖到 0.95：低阈值几乎全自动(但含糊消息也被硬分)，高阈值只放行最确定的、其余全转人工。这就是练习题1的权衡——没有万能数字，看业务错误代价。"}];return{summary:`阈值 ${t.toFixed(2)}：${n} 条自动（${Math.round(a*100)}%）、${i} 条转人工（${Math.round(i/o*100)}%）`,blocks:p}}const tc=[{phase:"14-agent-engineering",icon:"🤖",label:"Phase 14 · Agent 工程",modules:[{name:"confidence-router",displayName:"置信度阈值路由（客服分流）",lesson:"12 工作流模式",description:"路由模式落地：分类器给每条消息判类别+置信度，低于阈值转人工。调阈值看自动率/人工率权衡（练习题1）。",inputs:[{name:"threshold",label:"置信度阈值 (0~1)",type:"number",default:.7,help:"低于此值＝分类器没把握→转人工。一级客服可低(0.6~0.7)，高风险业务调高(0.9)"}],run:ec}]}],sc={class:"pg-panel"},nc={class:"pg-nav"},ic={class:"nav-group-title"},rc=["onClick"],oc={class:"nav-item-name"},ac={class:"nav-item-lesson"},lc={class:"pg-main"},cc={key:0,class:"empty-state"},uc={class:"module-head"},dc={class:"module-title"},pc={class:"module-desc"},fc={class:"form-body"},mc={key:0,class:"field-help"},hc=["onUpdate:modelValue","placeholder"],gc=["onUpdate:modelValue"],_c=["value"],vc=["onUpdate:modelValue","placeholder"],yc=["onUpdate:modelValue","placeholder"],bc={key:0,class:"result-area"},xc={class:"result-summary"},kc={key:0,class:"block-label"},Lc={key:1,class:"block-text"},Ac={key:2,class:"block-score"},Sc={class:"score-row"},Tc={class:"score-num"},Pc={key:0,class:"score-hint"},Cc={class:"score-bar"},Mc={key:3,class:"block-table"},wc={key:4,class:"block-kv"},Rc={class:"kv-key"},Ic={class:"kv-val"},Ec={key:6,class:"block-text"},Oc={__name:"PlaygroundView",setup(e){const t=tc,s=nt(null),n=_s({}),i=nt(null);function r(u){s.value=u,Object.keys(n).forEach(f=>delete n[f]);for(const f of u.inputs)n[f.name]=f.default;i.value=u.run({...n})}function o(){s.value&&(i.value=s.value.run({...n}))}function a(u,f){u.key!=="Enter"||u.isComposing||f&&!(u.metaKey||u.ctrlKey)||(u.preventDefault(),o())}const l=u=>Math.min(100,Math.max(0,u.value/(u.max||1)*100));function p(u){return u?Array.isArray(u)?u.map((f,h)=>[String(h),f]):Object.entries(u):[]}return(u,f)=>(y(),k("div",sc,[x("aside",nc,[(y(!0),k($,null,X(vs(t),h=>(y(),k("div",{key:h.phase,class:"nav-group"},[x("div",ic,M(h.icon)+" "+M(h.label),1),(y(!0),k($,null,X(h.modules,L=>{var E;return y(),k("div",{key:L.name,class:he(["nav-item",{active:((E=s.value)==null?void 0:E.name)===L.name}]),onClick:w=>r(L)},[x("div",oc,M(L.displayName),1),x("div",ac,M(L.lesson),1)],10,rc)}),128))]))),128))]),x("section",lc,[s.value?(y(),k($,{key:1},[x("div",uc,[x("div",null,[x("div",dc,M(s.value.displayName),1),x("div",pc,M(s.value.description),1)]),x("button",{class:"btn-run",onClick:o,title:"单行输入框按 Enter 运行"},"▶ 运行")]),x("div",fc,[(y(!0),k($,null,X(s.value.inputs,h=>(y(),k("div",{key:h.name,class:"form-field"},[x("label",null,[dn(M(h.label)+" ",1),h.help?(y(),k("span",mc,M(h.help),1)):Q("",!0)]),h.type==="textarea"?lt((y(),k("textarea",{key:0,"onUpdate:modelValue":L=>n[h.name]=L,placeholder:h.placeholder,rows:"3",onKeydown:f[0]||(f[0]=L=>a(L,!0))},null,40,hc)),[[Ds,n[h.name]]]):h.type==="select"?lt((y(),k("select",{key:1,"onUpdate:modelValue":L=>n[h.name]=L},[(y(!0),k($,null,X(h.options,L=>(y(),k("option",{key:L,value:L},M(L),9,_c))),128))],8,gc)),[[Ma,n[h.name]]]):h.type==="number"?lt((y(),k("input",{key:2,"onUpdate:modelValue":L=>n[h.name]=L,type:"number",step:"0.05",placeholder:h.placeholder,onKeydown:f[1]||(f[1]=L=>a(L,!1))},null,40,vc)),[[Ds,n[h.name]]]):lt((y(),k("input",{key:3,"onUpdate:modelValue":L=>n[h.name]=L,type:"text",placeholder:h.placeholder,onKeydown:f[2]||(f[2]=L=>a(L,!1))},null,40,yc)),[[Ds,n[h.name]]])]))),128))]),i.value?(y(),k("div",bc,[x("div",xc,M(i.value.summary),1),(y(!0),k($,null,X(i.value.blocks,(h,L)=>(y(),k("div",{key:L,class:"block"},[h.label?(y(),k("div",kc,M(h.label),1)):Q("",!0),h.type==="text"?(y(),k("pre",Lc,M(h.content),1)):h.type==="score"?(y(),k("div",Ac,[x("div",Sc,[x("span",Tc,M(h.value),1),h.hint?(y(),k("span",Pc,M(h.hint),1)):Q("",!0)]),x("div",Cc,[x("div",{class:"score-fill",style:$t({width:l(h)+"%"})},null,4)])])):h.type==="table"?(y(),k("table",Mc,[x("thead",null,[x("tr",null,[(y(!0),k($,null,X(h.headers,(E,w)=>(y(),k("th",{key:w},M(E),1))),128))])]),x("tbody",null,[(y(!0),k($,null,X(h.rows,(E,w)=>(y(),k("tr",{key:w},[(y(!0),k($,null,X(E,(F,j)=>(y(),k("td",{key:j},M(F),1))),128))]))),128))])])):h.type==="keyvalue"?(y(),k("div",wc,[(y(!0),k($,null,X(p(h.items),([E,w])=>(y(),k("div",{key:E,class:"kv-row"},[x("span",Rc,M(E),1),x("span",Ic,M(w),1)]))),128))])):h.type==="list"?(y(),ft(bo(h.ordered?"ol":"ul"),{key:5,class:"block-list"},{default:wi(()=>[(y(!0),k($,null,X(h.items,(E,w)=>(y(),k("li",{key:w},M(E),1))),128))]),_:2},1024)):h.type==="json"?(y(),k("pre",Ec,M(JSON.stringify(h.data,null,2)),1)):Q("",!0)]))),128))])):Q("",!0)],64)):(y(),k("div",cc,[...f[3]||(f[3]=[x("div",{class:"empty-icon"},"🧪",-1),x("p",null,"从左侧选一个课程模块开始测试",-1)])]))])]))}},qc=fn(Oc,[["__scopeId","data-v-ffc24678"]]),jc={class:"top-tabs"},Nc={class:"tabs-wrap"},Dc={class:"tabs"},$c=["onClick"],Fc={__name:"App",setup(e){const t=qa.days,s=nt("notes"),n=nt(t[t.length-1].id),i=[...t.map(r=>({id:r.id,label:r.label})),{id:"practice",label:"实践"}];return(r,o)=>(y(),k("div",{class:he(["container",{"full-width":s.value==="playground"}])},[x("div",jc,[x("button",{class:he(["top-tab-btn",{active:s.value==="notes"}]),onClick:o[0]||(o[0]=a=>s.value="notes")},"📖 AI 学习笔记",2),x("button",{class:he(["top-tab-btn",{active:s.value==="playground"}]),onClick:o[1]||(o[1]=a=>s.value="playground")},"🧪 AI 工程学习实验台",2)]),s.value==="notes"?(y(),k($,{key:0},[x("div",Nc,[x("div",Dc,[(y(),k($,null,X(i,a=>x("button",{key:a.id,class:he(["tab-btn",{active:n.value===a.id}]),onClick:l=>n.value=a.id},M(a.label),11,$c)),64))])]),(y(!0),k($,null,X(vs(t),a=>(y(),k($,{key:a.id},[n.value===a.id?(y(),ft(xl,{key:0,day:a,active:!0},null,8,["day"])):Q("",!0)],64))),128)),n.value==="practice"?(y(),ft(Zl,{key:0})):Q("",!0)],64)):s.value==="playground"?(y(),ft(qc,{key:1})):Q("",!0)],2))}},Gc=fn(Fc,[["__scopeId","data-v-03a918b3"]]);Ia(Gc).mount("#app");
