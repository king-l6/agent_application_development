...
* @license MIT
**/function Gs(e){const t=Object.create(null);for(const s of e.split(","))t[s]=1;return s=>s in t}const z={},ot=[],Ie=()=>{},Gn=()=>!1,ss=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&(e.charCodeAt(2)>122||e.charCodeAt(2)<97),ns=e=>e.startsWith("onUpdate:"),ae=Object.assign,$s=(e,t)=>{const s=e.indexOf(t);s>-1&&e.splice(s,1)},Xi=Object.prototype.hasOwnProperty,V=(e,t)=>Xi.call(e,t),E=Array.isArray,at=e=>Ot(e)==="[object Map]",$n=e=>Ot(e)==="[object Set]",un=e=>Ot(e)==="[object Date]",q=e=>typeof e=="function",Q=e=>typeof e=="string",Oe=e=>typeof e=="symbol",K=e=>e!==null&&typeof e=="object",Hn=e=>(K(e)||q(e))&&q(e.then)&&q(e.catch),Vn=Object.prototype.toString,Ot=e=>Vn.call(e),Qi=e=>Ot(e).slice(8,-1),Bn=e=>Ot(e)==="[object Object]",Hs=e=>Q(e)&&e!=="NaN"&&e[0]!=="-"&&""+parseInt(e,10)===e,xt=Gs(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),is=e=>{const t=Object.create(null);return(s=>t[s]||(t[s]=e(s)))},Zi=/-\w/g,_e=is(e=>e.replace(Zi,t=>t.slice(1).toUpperCase())),er=/\B([A-Z])/g,st=is(e=>e.replace(er,"-$1").toLowerCase()),Wn=is(e=>e.charAt(0).toUpperCase()+e.slice(1)),hs=is(e=>e?`on${Wn(e)}`:""),we=(e,t)=>!Object.is(e,t),gs=(e,...t)=>{for(let s=0;s<e.length;s++)e[s](...t)},Kn=(e,t,s,n=!1)=>{Object.defineProperty(e,t,{configurable:!0,enumerable:!1,writable:n,value:s})},tr=e=>{const t=parseFloat(e);return isNaN(t)?e:t};let pn;const rs=()=>pn||(pn=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function os(e){if(E(e)){const t={};for(let s=0;s<e.length;s++){const n=e[s],i=Q(n)?rr(n):os(n);if(i)for(const r in i)t[r]=i[r]}return t}else if(Q(e)||K(e))return e}const sr=/;(?![^(]*\))/g,nr=/:([^]+)/,ir=/\/\*[^]*?\*\//g;function rr(e){const t={};return e.replace(ir,"").split(sr).forEach(s=>{if(s){const n=s.split(nr);n.length>1&&(t[n[0].trim()]=n[1].trim())}}),t}function Ge(e){let t="";if(Q(e))t=e;else if(E(e))for(let s=0;s<e.length;s++){const n=Ge(e[s]);n&&(t+=n+" ")}else if(K(e))for(const s in e)e[s]&&(t+=s+" ");return t.trim()}const or="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",ar=Gs(or);function Un(e){return!!e||e===""}function lr(e,t){if(e.length!==t.length)return!1;let s=!0;for(let n=0;s&&n<e.length;n++)s=Vs(e[n],t[n]);return s}function Vs(e,t){if(e===t)return!0;let s=un(e),n=un(t);if(s||n)return s&&n?e.getTime()===t.getTime():!1;if(s=Oe(e),n=Oe(t),s||n)return e===t;if(s=E(e),n=E(t),s||n)return s&&n?lr(e,t):!1;if(s=K(e),n=K(t),s||n){if(!s||!n)return!1;const i=Object.keys(e).length,r=Object.keys(t).length;if(i!==r)return!1;for(const o in e){const a=e.hasOwnProperty(o),c=t.hasOwnProperty(o);if(a&&!c||!a&&c||!Vs(e[o],t[o]))return!1}}return String(e)===String(t)}const zn=e=>!!(e&&e.__v_isRef===!0),N=e=>Q(e)?e:e==null?"":E(e)||K(e)&&(e.toString===Vn||!q(e.toString))?zn(e)?N(e.value):JSON.stringify(e,Jn,2):String(e),Jn=(e,t)=>zn(t)?Jn(e,t.value):at(t)?{[`Map(${t.size})`]:[...t.entries()].reduce((s,[n,i],r)=>(s[_s(n,r)+" =>"]=i,s),{})}:$n(t)?{[`Set(${t.size})`]:[...t.values()].map(s=>_s(s))}:Oe(t)?_s(t):K(t)&&!E(t)&&!Bn(t)?String(t):t,_s=(e,t="")=>{var s;return Oe(e)?`Symbol(${(s=e.description)!=null?s:t})`:e};/**
* @vue/reactivity v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let ne;class cr{constructor(t=!1){this.detached=t,this._active=!0,this._on=0,this.effects=[],this.cleanups=[],this._isPaused=!1,this._warnOnRun=!0,this.__v_skip=!0,!t&&ne&&(ne.active?(this.parent=ne,this.index=(ne.scopes||(ne.scopes=[])).push(this)-1):(this._active=!1,this._warnOnRun=!1))}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let t,s;if(this.scopes)for(t=0,s=this.scopes.length;t<s;t++)this.scopes[t].pause();for(t=0,s=this.effects.length;t<s;t++)this.effects[t].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let t,s;if(this.scopes)for(t=0,s=this.scopes.length;t<s;t++)this.scopes[t].resume();for(t=0,s=this.effects.length;t<s;t++)this.effects[t].resume()}}run(t){if(this._active){const s=ne;try{return ne=this,t()}finally{ne=s}}}on(){++this._on===1&&(this.prevScope=ne,ne=this)}off(){if(this._on>0&&--this._on===0){if(ne===this)ne=this.prevScope;else{let t=ne;for(;t;){if(t.prevScope===this){t.prevScope=this.prevScope;break}t=t.prevScope}}this.prevScope=void 0}}stop(t){if(this._active){this._active=!1;let s,n;for(s=0,n=this.effects.length;s<n;s++)this.effects[s].stop();for(this.effects.length=0,s=0,n=this.cleanups.length;s<n;s++)this.cleanups[s]();if(this.cleanups.length=0,this.scopes){for(s=0,n=this.scopes.length;s<n;s++)this.scopes[s].stop(!0);this.scopes.length=0}if(!this.detached&&this.parent&&!t){const i=this.parent.scopes.pop();i&&i!==this&&(this.parent.scopes[this.index]=i,i.index=this.index)}this.parent=void 0}}}function ur(){return ne}let Y;const vs=new WeakSet;class Yn{constructor(t){this.fn=t,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.next=void 0,this.cleanup=void 0,this.scheduler=void 0,ne&&(ne.active?ne.effects.push(this):this.flags&=-2)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,vs.has(this)&&(vs.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||Qn(this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,fn(this),Zn(this);const t=Y,s=ve;Y=this,ve=!0;try{return this.fn()}finally{ei(this),Y=t,ve=s,this.flags&=-3}}stop(){if(this.flags&1){for(let t=this.deps;t;t=t.nextDep)Ks(t);this.deps=this.depsTail=void 0,fn(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?vs.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){Cs(this)&&this.run()}get dirty(){return Cs(this)}}let Xn=0,kt,Lt;function Qn(e,t=!1){if(e.flags|=8,t){e.next=Lt,Lt=e;return}e.next=kt,kt=e}function Bs(){Xn++}function Ws(){if(--Xn>0)return;if(Lt){let t=Lt;for(Lt=void 0;t;){const s=t.next;t.next=void 0,t.flags&=-9,t=s}}let e;for(;kt;){let t=kt;for(kt=void 0;t;){const s=t.next;if(t.next=void 0,t.flags&=-9,t.flags&1)try{t.trigger()}catch(n){e||(e=n)}t=s}}if(e)throw e}function Zn(e){for(let t=e.deps;t;t=t.nextDep)t.version=-1,t.prevActiveLink=t.dep.activeLink,t.dep.activeLink=t}function ei(e){let t,s=e.depsTail,n=s;for(;n;){const i=n.prevDep;n.version===-1?(n===s&&(s=i),Ks(n),pr(n)):t=n,n.dep.activeLink=n.prevActiveLink,n.prevActiveLink=void 0,n=i}e.deps=t,e.depsTail=s}function Cs(e){for(let t=e.deps;t;t=t.nextDep)if(t.dep.version!==t.version||t.dep.computed&&(ti(t.dep.computed)||t.dep.version!==t.version))return!0;return!!e._dirty}function ti(e){if(e.flags&4&&!(e.flags&16)||(e.flags&=-17,e.globalVersion===Ct)||(e.globalVersion=Ct,!e.isSSR&&e.flags&128&&(!e.deps&&!e._dirty||!Cs(e))))return;e.flags|=2;const t=e.dep,s=Y,n=ve;Y=e,ve=!0;try{Zn(e);const i=e.fn(e._value);(t.version===0||we(i,e._value))&&(e.flags|=128,e._value=i,t.version++)}catch(i){throw t.version++,i}finally{Y=s,ve=n,ei(e),e.flags&=-3}}function Ks(e,t=!1){const{dep:s,prevSub:n,nextSub:i}=e;if(n&&(n.nextSub=i,e.prevSub=void 0),i&&(i.prevSub=n,e.nextSub=void 0),s.subs===e&&(s.subs=n,!n&&s.computed)){s.computed.flags&=-5;for(let r=s.computed.deps;r;r=r.nextDep)Ks(r,!0)}!t&&!--s.sc&&s.map&&s.map.delete(s.key)}function pr(e){const{prevDep:t,nextDep:s}=e;t&&(t.nextDep=s,e.prevDep=void 0),s&&(s.prevDep=t,e.nextDep=void 0)}let ve=!0;const si=[];function $e(){si.push(ve),ve=!1}function He(){const e=si.pop();ve=e===void 0?!0:e}function fn(e){const{cleanup:t}=e;if(e.cleanup=void 0,t){const s=Y;Y=void 0;try{t()}finally{Y=s}}}let Ct=0;class fr{constructor(t,s){this.sub=t,this.dep=s,this.version=s.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}}class Us{constructor(t){this.computed=t,this.version=0,this.activeLink=void 0,this.subs=void 0,this.map=void 0,this.key=void 0,this.sc=0,this.__v_skip=!0}track(t){if(!Y||!ve||Y===this.computed)return;let s=this.activeLink;if(s===void 0||s.sub!==Y)s=this.activeLink=new fr(Y,this),Y.deps?(s.prevDep=Y.depsTail,Y.depsTail.nextDep=s,Y.depsTail=s):Y.deps=Y.depsTail=s,ni(s);else if(s.version===-1&&(s.version=this.version,s.nextDep)){const n=s.nextDep;n.prevDep=s.prevDep,s.prevDep&&(s.prevDep.nextDep=n),s.prevDep=Y.depsTail,s.nextDep=void 0,Y.depsTail.nextDep=s,Y.depsTail=s,Y.deps===s&&(Y.deps=n)}return s}trigger(t){this.version++,Ct++,this.notify(t)}notify(t){Bs();try{for(let s=this.subs;s;s=s.prevSub)s.sub.notify()&&s.sub.dep.notify()}finally{Ws()}}}function ni(e){if(e.dep.sc++,e.sub.flags&4){const t=e.dep.computed;if(t&&!e.dep.subs){t.flags|=20;for(let n=t.deps;n;n=n.nextDep)ni(n)}const s=e.dep.subs;s!==e&&(e.prevSub=s,s&&(s.nextSub=e)),e.dep.subs=e}}const Ms=new WeakMap,et=Symbol(""),Rs=Symbol(""),Mt=Symbol("");function re(e,t,s){if(ve&&Y){let n=Ms.get(e);n||Ms.set(e,n=new Map);let i=n.get(s);i||(n.set(s,i=new Us),i.map=n,i.key=s),i.track()}}function De(e,t,s,n,i,r){const o=Ms.get(e);if(!o){Ct++;return}const a=c=>{c&&c.trigger()};if(Bs(),t==="clear")o.forEach(a);else{const c=E(e),f=c&&Hs(s);if(c&&s==="length"){const p=Number(n);o.forEach((m,A)=>{(A==="length"||A===Mt||!Oe(A)&&A>=p)&&a(m)})}else switch((s!==void 0||o.has(void 0))&&a(o.get(s)),f&&a(o.get(Mt)),t){case"add":c?f&&a(o.get("length")):(a(o.get(et)),at(e)&&a(o.get(Rs)));break;case"delete":c||(a(o.get(et)),at(e)&&a(o.get(Rs)));break;case"set":at(e)&&a(o.get(et));break}}Ws()}function nt(e){const t=H(e);return t===e?t:(re(t,"iterate",Mt),ge(e)?t:t.map(ye))}function as(e){return re(e=H(e),"iterate",Mt),e}function Me(e,t){return Ve(e)?ut(tt(e)?ye(t):t):ye(t)}const dr={__proto__:null,[Symbol.iterator](){return ys(this,Symbol.iterator,e=>Me(this,e))},concat(...e){return nt(this).concat(...e.map(t=>E(t)?nt(t):t))},entries(){return ys(this,"entries",e=>(e[1]=Me(this,e[1]),e))},every(e,t){return qe(this,"every",e,t,void 0,arguments)},filter(e,t){return qe(this,"filter",e,t,s=>s.map(n=>Me(this,n)),arguments)},find(e,t){return qe(this,"find",e,t,s=>Me(this,s),arguments)},findIndex(e,t){return qe(this,"findIndex",e,t,void 0,arguments)},findLast(e,t){return qe(this,"findLast",e,t,s=>Me(this,s),arguments)},findLastIndex(e,t){return qe(this,"findLastIndex",e,t,void 0,arguments)},forEach(e,t){return qe(this,"forEach",e,t,void 0,arguments)},includes(...e){return bs(this,"includes",e)},indexOf(...e){return bs(this,"indexOf",e)},join(e){return nt(this).join(e)},lastIndexOf(...e){return bs(this,"lastIndexOf",e)},map(e,t){return qe(this,"map",e,t,void 0,arguments)},pop(){return gt(this,"pop")},push(...e){return gt(this,"push",e)},reduce(e,...t){return dn(this,"reduce",e,t)},reduceRight(e,...t){return dn(this,"reduceRight",e,t)},shift(){return gt(this,"shift")},some(e,t){return qe(this,"some",e,t,void 0,arguments)},splice(...e){return gt(this,"splice",e)},toReversed(){return nt(this).toReversed()},toSorted(e){return nt(this).toSorted(e)},toSpliced(...e){return nt(this).toSpliced(...e)},unshift(...e){return gt(this,"unshift",e)},values(){return ys(this,"values",e=>Me(this,e))}};function ys(e,t,s){const n=as(e),i=n[t]();return n!==e&&!ge(e)&&(i._next=i.next,i.next=()=>{const r=i._next();return r.done||(r.value=s(r.value)),r}),i}const mr=Array.prototype;function qe(e,t,s,n,i,r){const o=as(e),a=o!==e&&!ge(e),c=o[t];if(c!==mr[t]){const m=c.apply(e,r);return a?ye(m):m}let f=s;o!==e&&(a?f=function(m,A){return s.call(this,Me(e,m),A,e)}:s.length>2&&(f=function(m,A){return s.call(this,m,A,e)}));const p=c.call(o,f,n);return a&&i?i(p):p}function dn(e,t,s,n){const i=as(e),r=i!==e&&!ge(e);let o=s,a=!1;i!==e&&(r?(a=n.length===0,o=function(f,p,m){return a&&(a=!1,f=Me(e,f)),s.call(this,f,Me(e,p),m,e)}):s.length>3&&(o=function(f,p,m){return s.call(this,f,p,m,e)}));const c=i[t](o,...n);return a?Me(e,c):c}function bs(e,t,s){const n=H(e);re(n,"iterate",Mt);const i=n[t](...s);return(i===-1||i===!1)&&Xs(s[0])?(s[0]=H(s[0]),n[t](...s)):i}function gt(e,t,s=[]){$e(),Bs();const n=H(e)[t].apply(e,s);return Ws(),He(),n}const hr=Gs("__proto__,__v_isRef,__isVue"),ii=new Set(Object.getOwnPropertyNames(Symbol).filter(e=>e!=="arguments"&&e!=="caller").map(e=>Symbol[e]).filter(Oe));function gr(e){Oe(e)||(e=String(e));const t=H(this);return re(t,"has",e),t.hasOwnProperty(e)}class ri{constructor(t=!1,s=!1){this._isReadonly=t,this._isShallow=s}get(t,s,n){if(s==="__v_skip")return t.__v_skip;const i=this._isReadonly,r=this._isShallow;if(s==="__v_isReactive")return!i;if(s==="__v_isReadonly")return i;if(s==="__v_isShallow")return r;if(s==="__v_raw")return n===(i?r?Tr:ci:r?li:ai).get(t)||Object.getPrototypeOf(t)===Object.getPrototypeOf(n)?t:void 0;const o=E(t);if(!i){let c;if(o&&(c=dr[s]))return c;if(s==="hasOwnProperty")return gr}const a=Reflect.get(t,s,oe(t)?t:n);if((Oe(s)?ii.has(s):hr(s))||(i||re(t,"get",s),r))return a;if(oe(a)){const c=o&&Hs(s)?a:a.value;return i&&K(c)?Is(c):c}return K(a)?i?Is(a):Js(a):a}}class oi extends ri{constructor(t=!1){super(!1,t)}set(t,s,n,i){let r=t[s];const o=E(t)&&Hs(s);if(!this._isShallow){const f=Ve(r);if(!ge(n)&&!Ve(n)&&(r=H(r),n=H(n)),!o&&oe(r)&&!oe(n))return f||(r.value=n),!0}const a=o?Number(s)<t.length:V(t,s),c=Reflect.set(t,s,n,oe(t)?t:i);return t===H(i)&&(a?we(n,r)&&De(t,"set",s,n):De(t,"add",s,n)),c}deleteProperty(t,s){const n=V(t,s);t[s];const i=Reflect.deleteProperty(t,s);return i&&n&&De(t,"delete",s,void 0),i}has(t,s){const n=Reflect.has(t,s);return(!Oe(s)||!ii.has(s))&&re(t,"has",s),n}ownKeys(t){return re(t,"iterate",E(t)?"length":et),Reflect.ownKeys(t)}}class _r extends ri{constructor(t=!1){super(!0,t)}set(t,s){return!0}deleteProperty(t,s){return!0}}const vr=new oi,yr=new _r,br=new oi(!0);const ws=e=>e,Ht=e=>Reflect.getPrototypeOf(e);function xr(e,t,s){return function(...n){const i=this.__v_raw,r=H(i),o=at(r),a=e==="entries"||e===Symbol.iterator&&o,c=e==="keys"&&o,f=i[e](...n),p=s?ws:t?ut:ye;return!t&&re(r,"iterate",c?Rs:et),ae(Object.create(f),{next(){const{value:m,done:A}=f.next();return A?{value:m,done:A}:{value:a?[p(m[0]),p(m[1])]:p(m),done:A}}})}}function Vt(e){return function(...t){return e==="delete"?!1:e==="clear"?void 0:this}}function kr(e,t){const s={get(i){const r=this.__v_raw,o=H(r),a=H(i);e||(we(i,a)&&re(o,"get",i),re(o,"get",a));const{has:c}=Ht(o),f=t?ws:e?ut:ye;if(c.call(o,i))return f(r.get(i));if(c.call(o,a))return f(r.get(a));r!==o&&r.get(i)},get size(){const i=this.__v_raw;return!e&&re(H(i),"iterate",et),i.size},has(i){const r=this.__v_raw,o=H(r),a=H(i);return e||(we(i,a)&&re(o,"has",i),re(o,"has",a)),i===a?r.has(i):r.has(i)||r.has(a)},forEach(i,r){const o=this,a=o.__v_raw,c=H(a),f=t?ws:e?ut:ye;return!e&&re(c,"iterate",et),a.forEach((p,m)=>i.call(r,f(p),f(m),o))}};return ae(s,e?{add:Vt("add"),set:Vt("set"),delete:Vt("delete"),clear:Vt("clear")}:{add(i){const r=H(this),o=Ht(r),a=H(i),c=!t&&!ge(i)&&!Ve(i)?a:i;return o.has.call(r,c)||we(i,c)&&o.has.call(r,i)||we(a,c)&&o.has.call(r,a)||(r.add(c),De(r,"add",c,c)),this},set(i,r){!t&&!ge(r)&&!Ve(r)&&(r=H(r));const o=H(this),{has:a,get:c}=Ht(o);let f=a.call(o,i);f||(i=H(i),f=a.call(o,i));const p=c.call(o,i);return o.set(i,r),f?we(r,p)&&De(o,"set",i,r):De(o,"add",i,r),this},delete(i){const r=H(this),{has:o,get:a}=Ht(r);let c=o.call(r,i);c||(i=H(i),c=o.call(r,i)),a&&a.call(r,i);const f=r.delete(i);return c&&De(r,"delete",i,void 0),f},clear(){const i=H(this),r=i.size!==0,o=i.clear();return r&&De(i,"clear",void 0,void 0),o}}),["keys","values","entries",Symbol.iterator].forEach(i=>{s[i]=xr(i,e,t)}),s}function zs(e,t){const s=kr(e,t);return(n,i,r)=>i==="__v_isReactive"?!e:i==="__v_isReadonly"?e:i==="__v_raw"?n:Reflect.get(V(s,i)&&i in n?s:n,i,r)}const Lr={get:zs(!1,!1)},Ar={get:zs(!1,!0)},Sr={get:zs(!0,!1)};const ai=new WeakMap,li=new WeakMap,ci=new WeakMap,Tr=new WeakMap;function Pr(e){switch(e){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function Js(e){return Ve(e)?e:Ys(e,!1,vr,Lr,ai)}function Cr(e){return Ys(e,!1,br,Ar,li)}function Is(e){return Ys(e,!0,yr,Sr,ci)}function Ys(e,t,s,n,i){if(!K(e)||e.__v_raw&&!(t&&e.__v_isReactive)||e.__v_skip||!Object.isExtensible(e))return e;const r=i.get(e);if(r)return r;const o=Pr(Qi(e));if(o===0)return e;const a=new Proxy(e,o===2?n:s);return i.set(e,a),a}function tt(e){return Ve(e)?tt(e.__v_raw):!!(e&&e.__v_isReactive)}function Ve(e){return!!(e&&e.__v_isReadonly)}function ge(e){return!!(e&&e.__v_isShallow)}function Xs(e){return e?!!e.__v_raw:!1}function H(e){const t=e&&e.__v_raw;return t?H(t):e}function Mr(e){return!V(e,"__v_skip")&&Object.isExtensible(e)&&Kn(e,"__v_skip",!0),e}const ye=e=>K(e)?Js(e):e,ut=e=>K(e)?Is(e):e;function oe(e){return e?e.__v_isRef===!0:!1}function Ut(e){return Rr(e,!1)}function Rr(e,t){return oe(e)?e:new wr(e,t)}class wr{constructor(t,s){this.dep=new Us,this.__v_isRef=!0,this.__v_isShallow=!1,this._rawValue=s?t:H(t),this._value=s?t:ye(t),this.__v_isShallow=s}get value(){return this.dep.track(),this._value}set value(t){const s=this._rawValue,n=this.__v_isShallow||ge(t)||Ve(t);t=n?t:H(t),we(t,s)&&(this._rawValue=t,this._value=n?t:ye(t),this.dep.trigger())}}function Rt(e){return oe(e)?e.value:e}const Ir={get:(e,t,s)=>t==="__v_raw"?e:Rt(Reflect.get(e,t,s)),set:(e,t,s,n)=>{const i=e[t];return oe(i)&&!oe(s)?(i.value=s,!0):Reflect.set(e,t,s,n)}};function ui(e){return tt(e)?e:new Proxy(e,Ir)}class Er{constructor(t,s,n){this.fn=t,this.setter=s,this._value=void 0,this.dep=new Us(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=Ct-1,this.next=void 0,this.effect=this,this.__v_isReadonly=!s,this.isSSR=n}notify(){if(this.flags|=16,!(this.flags&8)&&Y!==this)return Qn(this,!0),!0}get value(){const t=this.dep.track();return ti(this),t&&(t.version=this.dep.version),this._value}set value(t){this.setter&&this.setter(t)}}function Or(e,t,s=!1){let n,i;return q(e)?n=e:(n=e.get,i=e.set),new Er(n,i,s)}const Bt={},zt=new WeakMap;let Ze;function qr(e,t=!1,s=Ze){if(s){let n=zt.get(s);n||zt.set(s,n=[]),n.push(e)}}function jr(e,t,s=z){const{immediate:n,deep:i,once:r,scheduler:o,augmentJob:a,call:c}=s,f=S=>i?S:ge(S)||i===!1||i===0?Fe(S,1):Fe(S);let p,m,A,P,$=!1,I=!1;if(oe(e)?(m=()=>e.value,$=ge(e)):tt(e)?(m=()=>f(e),$=!0):E(e)?(I=!0,$=e.some(S=>tt(S)||ge(S)),m=()=>e.map(S=>{if(oe(S))return S.value;if(tt(S))return f(S);if(q(S))return c?c(S,2):S()})):q(e)?t?m=c?()=>c(e,2):e:m=()=>{if(A){$e();try{A()}finally{He()}}const S=Ze;Ze=p;try{return c?c(e,3,[P]):e(P)}finally{Ze=S}}:m=Ie,t&&i){const S=m,Z=i===!0?1/0:i;m=()=>Fe(S(),Z)}const F=ur(),O=()=>{p.stop(),F&&F.active&&$s(F.effects,p)};if(r&&t){const S=t;t=(...Z)=>{const xe=S(...Z);return O(),xe}}let D=I?new Array(e.length).fill(Bt):Bt;const j=S=>{if(!(!(p.flags&1)||!p.dirty&&!S))if(t){const Z=p.run();if(S||i||$||(I?Z.some((xe,ke)=>we(xe,D[ke])):we(Z,D))){A&&A();const xe=Ze;Ze=p;try{const ke=[Z,D===Bt?void 0:I&&D[0]===Bt?[]:D,P];D=Z,c?c(t,3,ke):t(...ke)}finally{Ze=xe}}}else p.run()};return a&&a(j),p=new Yn(m),p.scheduler=o?()=>o(j,!1):j,P=S=>qr(S,!1,p),A=p.onStop=()=>{const S=zt.get(p);if(S){if(c)c(S,4);else for(const Z of S)Z();zt.delete(p)}},t?n?j(!0):D=p.run():o?o(j.bind(null,!0),!0):p.run(),O.pause=p.pause.bind(p),O.resume=p.resume.bind(p),O.stop=O,O}function Fe(e,t=1/0,s){if(t<=0||!K(e)||e.__v_skip||(s=s||new Map,(s.get(e)||0)>=t))return e;if(s.set(e,t),t--,oe(e))Fe(e.value,t,s);else if(E(e))for(let n=0;n<e.length;n++)Fe(e[n],t,s);else if($n(e)||at(e))e.forEach(n=>{Fe(n,t,s)});else if(Bn(e)){for(const n in e)Fe(e[n],t,s);for(const n of Object.getOwnPropertySymbols(e))Object.prototype.propertyIsEnumerable.call(e,n)&&Fe(e[n],t,s)}return e}/**
* @vue/runtime-core v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function qt(e,t,s,n){try{return n?e(...n):e()}catch(i){ls(i,t,s)}}function be(e,t,s,n){if(q(e)){const i=qt(e,t,s,n);return i&&Hn(i)&&i.catch(r=>{ls(r,t,s)}),i}if(E(e)){const i=[];for(let r=0;r<e.length;r++)i.push(be(e[r],t,s,n));return i}}function ls(e,t,s,n=!0){const i=t?t.vnode:null,{errorHandler:r,throwUnhandledErrorInProduction:o}=t&&t.appContext.config||z;if(t){let a=t.parent;const c=t.proxy,f=`https://vuejs.org/error-reference/#runtime-${s}`;for(;a;){const p=a.ec;if(p){for(let m=0;m<p.length;m++)if(p[m](e,c,f)===!1)return}a=a.parent}if(r){$e(),qt(r,null,10,[e,c,f]),He();return}}Nr(e,s,i,n,o)}function Nr(e,t,s,n=!0,i=!1){if(i)throw e;console.error(e)}const ue=[];let Ce=-1;const lt=[];let Ke=null,it=0;const pi=Promise.resolve();let Jt=null;function Dr(e){const t=Jt||pi;return e?t.then(this?e.bind(this):e):t}function Fr(e){let t=Ce+1,s=ue.length;for(;t<s;){const n=t+s>>>1,i=ue[n],r=wt(i);r<e||r===e&&i.flags&2?t=n+1:s=n}return t}function Qs(e){if(!(e.flags&1)){const t=wt(e),s=ue[ue.length-1];!s||!(e.flags&2)&&t>=wt(s)?ue.push(e):ue.splice(Fr(t),0,e),e.flags|=1,fi()}}function fi(){Jt||(Jt=pi.then(mi))}function Gr(e){E(e)?lt.push(...e):Ke&&e.id===-1?Ke.splice(it+1,0,e):e.flags&1||(lt.push(e),e.flags|=1),fi()}function mn(e,t,s=Ce+1){for(;s<ue.length;s++){const n=ue[s];if(n&&n.flags&2){if(e&&n.id!==e.uid)continue;ue.splice(s,1),s--,n.flags&4&&(n.flags&=-2),n(),n.flags&4||(n.flags&=-2)}}}function di(e){if(lt.length){const t=[...new Set(lt)].sort((s,n)=>wt(s)-wt(n));if(lt.length=0,Ke){Ke.push(...t);return}for(Ke=t,it=0;it<Ke.length;it++){const s=Ke[it];s.flags&4&&(s.flags&=-2),s.flags&8||s(),s.flags&=-2}Ke=null,it=0}}const wt=e=>e.id==null?e.flags&2?-1:1/0:e.id;function mi(e){try{for(Ce=0;Ce<ue.length;Ce++){const t=ue[Ce];t&&!(t.flags&8)&&(t.flags&4&&(t.flags&=-2),qt(t,t.i,t.i?15:14),t.flags&4||(t.flags&=-2))}}finally{for(;Ce<ue.length;Ce++){const t=ue[Ce];t&&(t.flags&=-2)}Ce=-1,ue.length=0,di(),Jt=null,(ue.length||lt.length)&&mi()}}let he=null,hi=null;function Yt(e){const t=he;return he=e,hi=e&&e.type.__scopeId||null,t}function $r(e,t=he,s){if(!t||e._n)return e;const n=(...i)=>{n._d&&Sn(-1);const r=Yt(t);let o;try{o=e(...i)}finally{Yt(r),n._d&&Sn(1)}return o};return n._n=!0,n._c=!0,n._d=!0,n}function gi(e,t){if(he===null)return e;const s=fs(he),n=e.dirs||(e.dirs=[]);for(let i=0;i<t.length;i++){let[r,o,a,c=z]=t[i];r&&(q(r)&&(r={mounted:r,updated:r}),r.deep&&Fe(o),n.push({dir:r,instance:s,value:o,oldValue:void 0,arg:a,modifiers:c}))}return e}function Xe(e,t,s,n){const i=e.dirs,r=t&&t.dirs;for(let o=0;o<i.length;o++){const a=i[o];r&&(a.oldValue=r[o].value);let c=a.dir[n];c&&($e(),be(c,s,8,[e.el,a,e,t]),He())}}function Hr(e,t){if(pe){let s=pe.provides;const n=pe.parent&&pe.parent.provides;n===s&&(s=pe.provides=Object.create(n)),s[e]=t}}function Wt(e,t,s=!1){const n=$o();if(n||ct){let i=ct?ct._context.provides:n?n.parent==null||n.ce?n.vnode.appContext&&n.vnode.appContext.provides:n.parent.provides:void 0;if(i&&e in i)return i[e];if(arguments.length>1)return s&&q(t)?t.call(n&&n.proxy):t}}const Vr=Symbol.for("v-scx"),Br=()=>Wt(Vr);function xs(e,t,s){return _i(e,t,s)}function _i(e,t,s=z){const{immediate:n,deep:i,flush:r,once:o}=s,a=ae({},s),c=t&&n||!t&&r!=="post";let f;if(Et){if(r==="sync"){const P=Br();f=P.__watcherHandles||(P.__watcherHandles=[])}else if(!c){const P=()=>{};return P.stop=Ie,P.resume=Ie,P.pause=Ie,P}}const p=pe;a.call=(P,$,I)=>be(P,p,$,I);let m=!1;r==="post"?a.scheduler=P=>{fe(P,p&&p.suspense)}:r!=="sync"&&(m=!0,a.scheduler=(P,$)=>{$?P():Qs(P)}),a.augmentJob=P=>{t&&(P.flags|=4),m&&(P.flags|=2,p&&(P.id=p.uid,P.i=p))};const A=jr(e,t,a);return Et&&(f?f.push(A):c&&A()),A}function Wr(e,t,s){const n=this.proxy,i=Q(e)?e.includes(".")?vi(n,e):()=>n[e]:e.bind(n,n);let r;q(t)?r=t:(r=t.handler,s=t);const o=jt(this),a=_i(i,r.bind(n),s);return o(),a}function vi(e,t){const s=t.split(".");return()=>{let n=e;for(let i=0;i<s.length&&n;i++)n=n[s[i]];return n}}const Kr=Symbol("_vte"),Ur=e=>e.__isTeleport,ks=Symbol("_leaveCb");function Zs(e,t){e.shapeFlag&6&&e.component?(e.transition=t,Zs(e.component.subTree,t)):e.shapeFlag&128?(e.ssContent.transition=t.clone(e.ssContent),e.ssFallback.transition=t.clone(e.ssFallback)):e.transition=t}function yi(e){e.ids=[e.ids[0]+e.ids[2]+++"-",0,0]}function hn(e,t){let s;return!!((s=Object.getOwnPropertyDescriptor(e,t))&&!s.configurable)}const Xt=new WeakMap;function At(e,t,s,n,i=!1){if(E(e)){e.forEach((I,F)=>At(I,t&&(E(t)?t[F]:t),s,n,i));return}if(St(n)&&!i){n.shapeFlag&512&&n.type.__asyncResolved&&n.component.subTree.component&&At(e,t,s,n.component.subTree);return}const r=n.shapeFlag&4?fs(n.component):n.el,o=i?null:r,{i:a,r:c}=e,f=t&&t.r,p=a.refs===z?a.refs={}:a.refs,m=a.setupState,A=H(m),P=m===z?Gn:I=>hn(p,I)?!1:V(A,I),$=(I,F)=>!(F&&hn(p,F));if(f!=null&&f!==c){if(gn(t),Q(f))p[f]=null,P(f)&&(m[f]=null);else if(oe(f)){const I=t;$(f,I.k)&&(f.value=null),I.k&&(p[I.k]=null)}}if(q(c))qt(c,a,12,[o,p]);else{const I=Q(c),F=oe(c);if(I||F){const O=()=>{if(e.f){const D=I?P(c)?m[c]:p[c]:$()||!e.k?c.value:p[e.k];if(i)E(D)&&$s(D,r);else if(E(D))D.includes(r)||D.push(r);else if(I)p[c]=[r],P(c)&&(m[c]=p[c]);else{const j=[r];$(c,e.k)&&(c.value=j),e.k&&(p[e.k]=j)}}else I?(p[c]=o,P(c)&&(m[c]=o)):F&&($(c,e.k)&&(c.value=o),e.k&&(p[e.k]=o))};if(o){const D=()=>{O(),Xt.delete(e)};D.id=-1,Xt.set(e,D),fe(D,s)}else gn(e),O()}}}function gn(e){const t=Xt.get(e);t&&(t.flags|=8,Xt.delete(e))}rs().requestIdleCallback;rs().cancelIdleCallback;const St=e=>!!e.type.__asyncLoader,bi=e=>e.type.__isKeepAlive;function zr(e,t){xi(e,"a",t)}function Jr(e,t){xi(e,"da",t)}function xi(e,t,s=pe){const n=e.__wdc||(e.__wdc=()=>{let i=s;for(;i;){if(i.isDeactivated)return;i=i.parent}return e()});if(cs(t,n,s),s){let i=s.parent;for(;i&&i.parent;)bi(i.parent.vnode)&&Yr(n,t,s,i),i=i.parent}}function Yr(e,t,s,n){const i=cs(t,e,n,!0);ki(()=>{$s(n[t],i)},s)}function cs(e,t,s=pe,n=!1){if(s){const i=s[e]||(s[e]=[]),r=t.__weh||(t.__weh=(...o)=>{$e();const a=jt(s),c=be(t,s,e,o);return a(),He(),c});return n?i.unshift(r):i.push(r),r}}const Be=e=>(t,s=pe)=>{(!Et||e==="sp")&&cs(e,(...n)=>t(...n),s)},Xr=Be("bm"),Qr=Be("m"),Zr=Be("bu"),eo=Be("u"),to=Be("bum"),ki=Be("um"),so=Be("sp"),no=Be("rtg"),io=Be("rtc");function ro(e,t=pe){cs("ec",e,t)}const oo=Symbol.for("v-ndc");function ie(e,t,s,n){let i;const r=s,o=E(e);if(o||Q(e)){const a=o&&tt(e);let c=!1,f=!1;a&&(c=!ge(e),f=Ve(e),e=as(e)),i=new Array(e.length);for(let p=0,m=e.length;p<m;p++)i[p]=t(c?f?ut(ye(e[p])):ye(e[p]):e[p],p,void 0,r)}else if(typeof e=="number"){i=new Array(e);for(let a=0;a<e;a++)i[a]=t(a+1,a,void 0,r)}else if(K(e))if(e[Symbol.iterator])i=Array.from(e,(a,c)=>t(a,c,void 0,r));else{const a=Object.keys(e);i=new Array(a.length);for(let c=0,f=a.length;c<f;c++){const p=a[c];i[c]=t(e[p],p,c,r)}}else i=[];return i}const Es=e=>e?Bi(e)?fs(e):Es(e.parent):null,Tt=ae(Object.create(null),{$:e=>e,$el:e=>e.vnode.el,$data:e=>e.data,$props:e=>e.props,$attrs:e=>e.attrs,$slots:e=>e.slots,$refs:e=>e.refs,$parent:e=>Es(e.parent),$root:e=>Es(e.root),$host:e=>e.ce,$emit:e=>e.emit,$options:e=>Ai(e),$forceUpdate:e=>e.f||(e.f=()=>{Qs(e.update)}),$nextTick:e=>e.n||(e.n=Dr.bind(e.proxy)),$watch:e=>Wr.bind(e)}),Ls=(e,t)=>e!==z&&!e.__isScriptSetup&&V(e,t),ao={get({_:e},t){if(t==="__v_skip")return!0;const{ctx:s,setupState:n,data:i,props:r,accessCache:o,type:a,appContext:c}=e;if(t[0]!=="$"){const A=o[t];if(A!==void 0)switch(A){case 1:return n[t];case 2:return i[t];case 4:return s[t];case 3:return r[t]}else{if(Ls(n,t))return o[t]=1,n[t];if(i!==z&&V(i,t))return o[t]=2,i[t];if(V(r,t))return o[t]=3,r[t];if(s!==z&&V(s,t))return o[t]=4,s[t];Os&&(o[t]=0)}}const f=Tt[t];let p,m;if(f)return t==="$attrs"&&re(e.attrs,"get",""),f(e);if((p=a.__cssModules)&&(p=p[t]))return p;if(s!==z&&V(s,t))return o[t]=4,s[t];if(m=c.config.globalProperties,V(m,t))return m[t]},set({_:e},t,s){const{data:n,setupState:i,ctx:r}=e;return Ls(i,t)?(i[t]=s,!0):n!==z&&V(n,t)?(n[t]=s,!0):V(e.props,t)||t[0]==="$"&&t.slice(1)in e?!1:(r[t]=s,!0)},has({_:{data:e,setupState:t,accessCache:s,ctx:n,appContext:i,props:r,type:o}},a){let c;return!!(s[a]||e!==z&&a[0]!=="$"&&V(e,a)||Ls(t,a)||V(r,a)||V(n,a)||V(Tt,a)||V(i.config.globalProperties,a)||(c=o.__cssModules)&&c[a])},defineProperty(e,t,s){return s.get!=null?e._.accessCache[t]=0:V(s,"value")&&this.set(e,t,s.value,null),Reflect.defineProperty(e,t,s)}};function _n(e){return E(e)?e.reduce((t,s)=>(t[s]=null,t),{}):e}let Os=!0;function lo(e){const t=Ai(e),s=e.proxy,n=e.ctx;Os=!1,t.beforeCreate&&vn(t.beforeCreate,e,"bc");const{data:i,computed:r,methods:o,watch:a,provide:c,inject:f,created:p,beforeMount:m,mounted:A,beforeUpdate:P,updated:$,activated:I,deactivated:F,beforeDestroy:O,beforeUnmount:D,destroyed:j,unmounted:S,render:Z,renderTracked:xe,renderTriggered:ke,errorCaptured:We,serverPrefetch:Nt,expose:ze,inheritAttrs:ft,components:Dt,directives:Ft,filters:ds}=t;if(f&&co(f,n,null),o)for(const X in o){const J=o[X];q(J)&&(n[X]=J.bind(s))}if(i){const X=i.call(s,s);K(X)&&(e.data=Js(X))}if(Os=!0,r)for(const X in r){const J=r[X],Je=q(J)?J.bind(s,s):q(J.get)?J.get.bind(s,s):Ie,Gt=!q(J)&&q(J.set)?J.set.bind(s):Ie,Ye=rt({get:Je,set:Gt});Object.defineProperty(n,X,{enumerable:!0,configurable:!0,get:()=>Ye.value,set:Le=>Ye.value=Le})}if(a)for(const X in a)Li(a[X],n,s,X);if(c){const X=q(c)?c.call(s):c;Reflect.ownKeys(X).forEach(J=>{Hr(J,X[J])})}p&&vn(p,e,"c");function le(X,J){E(J)?J.forEach(Je=>X(Je.bind(s))):J&&X(J.bind(s))}if(le(Xr,m),le(Qr,A),le(Zr,P),le(eo,$),le(zr,I),le(Jr,F),le(ro,We),le(io,xe),le(no,ke),le(to,D),le(ki,S),le(so,Nt),E(ze))if(ze.length){const X=e.exposed||(e.exposed={});ze.forEach(J=>{Object.defineProperty(X,J,{get:()=>s[J],set:Je=>s[J]=Je,enumerable:!0})})}else e.exposed||(e.exposed={});Z&&e.render===Ie&&(e.render=Z),ft!=null&&(e.inheritAttrs=ft),Dt&&(e.components=Dt),Ft&&(e.directives=Ft),Nt&&yi(e)}function co(e,t,s=Ie){E(e)&&(e=qs(e));for(const n in e){const i=e[n];let r;K(i)?"default"in i?r=Wt(i.from||n,i.default,!0):r=Wt(i.from||n):r=Wt(i),oe(r)?Object.defineProperty(t,n,{enumerable:!0,configurable:!0,get:()=>r.value,set:o=>r.value=o}):t[n]=r}}function vn(e,t,s){be(E(e)?e.map(n=>n.bind(t.proxy)):e.bind(t.proxy),t,s)}function Li(e,t,s,n){let i=n.includes(".")?vi(s,n):()=>s[n];if(Q(e)){const r=t[e];q(r)&&xs(i,r)}else if(q(e))xs(i,e.bind(s));else if(K(e))if(E(e))e.forEach(r=>Li(r,t,s,n));else{const r=q(e.handler)?e.handler.bind(s):t[e.handler];q(r)&&xs(i,r,e)}}function Ai(e){const t=e.type,{mixins:s,extends:n}=t,{mixins:i,optionsCache:r,config:{optionMergeStrategies:o}}=e.appContext,a=r.get(t);let c;return a?c=a:!i.length&&!s&&!n?c=t:(c={},i.length&&i.forEach(f=>Qt(c,f,o,!0)),Qt(c,t,o)),K(t)&&r.set(t,c),c}function Qt(e,t,s,n=!1){const{mixins:i,extends:r}=t;r&&Qt(e,r,s,!0),i&&i.forEach(o=>Qt(e,o,s,!0));for(const o in t)if(!(n&&o==="expose")){const a=uo[o]||s&&s[o];e[o]=a?a(e[o],t[o]):t[o]}return e}const uo={data:yn,props:bn,emits:bn,methods:yt,computed:yt,beforeCreate:ce,created:ce,beforeMount:ce,mounted:ce,beforeUpdate:ce,updated:ce,beforeDestroy:ce,beforeUnmount:ce,destroyed:ce,unmounted:ce,activated:ce,deactivated:ce,errorCaptured:ce,serverPrefetch:ce,components:yt,directives:yt,watch:fo,provide:yn,inject:po};function yn(e,t){return t?e?function(){return ae(q(e)?e.call(this,this):e,q(t)?t.call(this,this):t)}:t:e}function po(e,t){return yt(qs(e),qs(t))}function qs(e){if(E(e)){const t={};for(let s=0;s<e.length;s++)t[e[s]]=e[s];return t}return e}function ce(e,t){return e?[...new Set([].concat(e,t))]:t}function yt(e,t){return e?ae(Object.create(null),e,t):t}function bn(e,t){return e?E(e)&&E(t)?[...new Set([...e,...t])]:ae(Object.create(null),_n(e),_n(t??{})):t}function fo(e,t){if(!e)return t;if(!t)return e;const s=ae(Object.create(null),e);for(const n in t)s[n]=ce(e[n],t[n]);return s}function Si(){return{app:null,config:{isNativeTag:Gn,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let mo=0;function ho(e,t){return function(n,i=null){q(n)||(n=ae({},n)),i!=null&&!K(i)&&(i=null);const r=Si(),o=new WeakSet,a=[];let c=!1;const f=r.app={_uid:mo++,_component:n,_props:i,_container:null,_context:r,_instance:null,version:Uo,get config(){return r.config},set config(p){},use(p,...m){return o.has(p)||(p&&q(p.install)?(o.add(p),p.install(f,...m)):q(p)&&(o.add(p),p(f,...m))),f},mixin(p){return r.mixins.includes(p)||r.mixins.push(p),f},component(p,m){return m?(r.components[p]=m,f):r.components[p]},directive(p,m){return m?(r.directives[p]=m,f):r.directives[p]},mount(p,m,A){if(!c){const P=f._ceVNode||Ee(n,i);return P.appContext=r,A===!0?A="svg":A===!1&&(A=void 0),e(P,p,A),c=!0,f._container=p,p.__vue_app__=f,fs(P.component)}},onUnmount(p){a.push(p)},unmount(){c&&(be(a,f._instance,16),e(null,f._container),delete f._container.__vue_app__)},provide(p,m){return r.provides[p]=m,f},runWithContext(p){const m=ct;ct=f;try{return p()}finally{ct=m}}};return f}}let ct=null;const go=(e,t)=>t==="modelValue"||t==="model-value"?e.modelModifiers:e[`${t}Modifiers`]||e[`${_e(t)}Modifiers`]||e[`${st(t)}Modifiers`];function _o(e,t,...s){if(e.isUnmounted)return;const n=e.vnode.props||z;let i=s;const r=t.startsWith("update:"),o=r&&go(n,t.slice(7));o&&(o.trim&&(i=s.map(p=>Q(p)?p.trim():p)),o.number&&(i=s.map(tr)));let a,c=n[a=hs(t)]||n[a=hs(_e(t))];!c&&r&&(c=n[a=hs(st(t))]),c&&be(c,e,6,i);const f=n[a+"Once"];if(f){if(!e.emitted)e.emitted={};else if(e.emitted[a])return;e.emitted[a]=!0,be(f,e,6,i)}}const vo=new WeakMap;function Ti(e,t,s=!1){const n=s?vo:t.emitsCache,i=n.get(e);if(i!==void 0)return i;const r=e.emits;let o={},a=!1;if(!q(e)){const c=f=>{const p=Ti(f,t,!0);p&&(a=!0,ae(o,p))};!s&&t.mixins.length&&t.mixins.forEach(c),e.extends&&c(e.extends),e.mixins&&e.mixins.forEach(c)}return!r&&!a?(K(e)&&n.set(e,null),null):(E(r)?r.forEach(c=>o[c]=null):ae(o,r),K(e)&&n.set(e,o),o)}function us(e,t){return!e||!ss(t)?!1:(t=t.slice(2).replace(/Once$/,""),V(e,t[0].toLowerCase()+t.slice(1))||V(e,st(t))||V(e,t))}function xn(e){const{type:t,vnode:s,proxy:n,withProxy:i,propsOptions:[r],slots:o,attrs:a,emit:c,render:f,renderCache:p,props:m,data:A,setupState:P,ctx:$,inheritAttrs:I}=e,F=Yt(e);let O,D;try{if(s.shapeFlag&4){const S=i||n,Z=S;O=Re(f.call(Z,S,p,m,P,A,$)),D=a}else{const S=t;O=Re(S.length>1?S(m,{attrs:a,slots:o,emit:c}):S(m,null)),D=t.props?a:yo(a)}}catch(S){Pt.length=0,ls(S,e,1),O=Ee(Ue)}let j=O;if(D&&I!==!1){const S=Object.keys(D),{shapeFlag:Z}=j;S.length&&Z&7&&(r&&S.some(ns)&&(D=bo(D,r)),j=pt(j,D,!1,!0))}return s.dirs&&(j=pt(j,null,!1,!0),j.dirs=j.dirs?j.dirs.concat(s.dirs):s.dirs),s.transition&&Zs(j,s.transition),O=j,Yt(F),O}const yo=e=>{let t;for(const s in e)(s==="class"||s==="style"||ss(s))&&((t||(t={}))[s]=e[s]);return t},bo=(e,t)=>{const s={};for(const n in e)(!ns(n)||!(n.slice(9)in t))&&(s[n]=e[n]);return s};function xo(e,t,s){const{props:n,children:i,component:r}=e,{props:o,children:a,patchFlag:c}=t,f=r.emitsOptions;if(t.dirs||t.transition)return!0;if(s&&c>=0){if(c&1024)return!0;if(c&16)return n?kn(n,o,f):!!o;if(c&8){const p=t.dynamicProps;for(let m=0;m<p.length;m++){const A=p[m];if(Pi(o,n,A)&&!us(f,A))return!0}}}else return(i||a)&&(!a||!a.$stable)?!0:n===o?!1:n?o?kn(n,o,f):!0:!!o;return!1}function kn(e,t,s){const n=Object.keys(t);if(n.length!==Object.keys(e).length)return!0;for(let i=0;i<n.length;i++){const r=n[i];if(Pi(t,e,r)&&!us(s,r))return!0}return!1}function Pi(e,t,s){const n=e[s],i=t[s];return s==="style"&&K(n)&&K(i)?!Vs(n,i):n!==i}function ko({vnode:e,parent:t,suspense:s},n){for(;t;){const i=t.subTree;if(i.suspense&&i.suspense.activeBranch===e&&(i.suspense.vnode.el=i.el=n,e=i),i===e)(e=t.vnode).el=n,t=t.parent;else break}s&&s.activeBranch===e&&(s.vnode.el=n)}const Ci={},Mi=()=>Object.create(Ci),Ri=e=>Object.getPrototypeOf(e)===Ci;function Lo(e,t,s,n=!1){const i={},r=Mi();e.propsDefaults=Object.create(null),wi(e,t,i,r);for(const o in e.propsOptions[0])o in i||(i[o]=void 0);s?e.props=n?i:Cr(i):e.type.props?e.props=i:e.props=r,e.attrs=r}function Ao(e,t,s,n){const{props:i,attrs:r,vnode:{patchFlag:o}}=e,a=H(i),[c]=e.propsOptions;let f=!1;if((n||o>0)&&!(o&16)){if(o&8){const p=e.vnode.dynamicProps;for(let m=0;m<p.length;m++){let A=p[m];if(us(e.emitsOptions,A))continue;const P=t[A];if(c)if(V(r,A))P!==r[A]&&(r[A]=P,f=!0);else{const $=_e(A);i[$]=js(c,a,$,P,e,!1)}else P!==r[A]&&(r[A]=P,f=!0)}}}else{wi(e,t,i,r)&&(f=!0);let p;for(const m in a)(!t||!V(t,m)&&((p=st(m))===m||!V(t,p)))&&(c?s&&(s[m]!==void 0||s[p]!==void 0)&&(i[m]=js(c,a,m,void 0,e,!0)):delete i[m]);if(r!==a)for(const m in r)(!t||!V(t,m))&&(delete r[m],f=!0)}f&&De(e.attrs,"set","")}function wi(e,t,s,n){const[i,r]=e.propsOptions;let o=!1,a;if(t)for(let c in t){if(xt(c))continue;const f=t[c];let p;i&&V(i,p=_e(c))?!r||!r.includes(p)?s[p]=f:(a||(a={}))[p]=f:us(e.emitsOptions,c)||(!(c in n)||f!==n[c])&&(n[c]=f,o=!0)}if(r){const c=H(s),f=a||z;for(let p=0;p<r.length;p++){const m=r[p];s[m]=js(i,c,m,f[m],e,!V(f,m))}}return o}function js(e,t,s,n,i,r){const o=e[s];if(o!=null){const a=V(o,"default");if(a&&n===void 0){const c=o.default;if(o.type!==Function&&!o.skipFactory&&q(c)){const{propsDefaults:f}=i;if(s in f)n=f[s];else{const p=jt(i);n=f[s]=c.call(null,t),p()}}else n=c;i.ce&&i.ce._setProp(s,n)}o[0]&&(r&&!a?n=!1:o[1]&&(n===""||n===st(s))&&(n=!0))}return n}const So=new WeakMap;function Ii(e,t,s=!1){const n=s?So:t.propsCache,i=n.get(e);if(i)return i;const r=e.props,o={},a=[];let c=!1;if(!q(e)){const p=m=>{c=!0;const[A,P]=Ii(m,t,!0);ae(o,A),P&&a.push(...P)};!s&&t.mixins.length&&t.mixins.forEach(p),e.extends&&p(e.extends),e.mixins&&e.mixins.forEach(p)}if(!r&&!c)return K(e)&&n.set(e,ot),ot;if(E(r))for(let p=0;p<r.length;p++){const m=_e(r[p]);Ln(m)&&(o[m]=z)}else if(r)for(const p in r){const m=_e(p);if(Ln(m)){const A=r[p],P=o[m]=E(A)||q(A)?{type:A}:ae({},A),$=P.type;let I=!1,F=!0;if(E($))for(let O=0;O<$.length;++O){const D=$[O],j=q(D)&&D.name;if(j==="Boolean"){I=!0;break}else j==="String"&&(F=!1)}else I=q($)&&$.name==="Boolean";P[0]=I,P[1]=F,(I||V(P,"default"))&&a.push(m)}}const f=[o,a];return K(e)&&n.set(e,f),f}function Ln(e){return e[0]!=="$"&&!xt(e)}const en=e=>e==="_"||e==="_ctx"||e==="$stable",tn=e=>E(e)?e.map(Re):[Re(e)],To=(e,t,s)=>{if(t._n)return t;const n=$r((...i)=>tn(t(...i)),s);return n._c=!1,n},Ei=(e,t,s)=>{const n=e._ctx;for(const i in e){if(en(i))continue;const r=e[i];if(q(r))t[i]=To(i,r,n);else if(r!=null){const o=tn(r);t[i]=()=>o}}},Oi=(e,t)=>{const s=tn(t);e.slots.default=()=>s},qi=(e,t,s)=>{for(const n in t)(s||!en(n))&&(e[n]=t[n])},Po=(e,t,s)=>{const n=e.slots=Mi();if(e.vnode.shapeFlag&32){const i=t._;i?(qi(n,t,s),s&&Kn(n,"_",i,!0)):Ei(t,n)}else t&&Oi(e,t)},Co=(e,t,s)=>{const{vnode:n,slots:i}=e;let r=!0,o=z;if(n.shapeFlag&32){const a=t._;a?s&&a===1?r=!1:qi(i,t,s):(r=!t.$stable,Ei(t,i)),o=t}else t&&(Oi(e,t),o={default:1});if(r)for(const a in i)!en(a)&&o[a]==null&&delete i[a]},fe=Eo;function Mo(e){return Ro(e)}function Ro(e,t){const s=rs();s.__VUE__=!0;const{insert:n,remove:i,patchProp:r,createElement:o,createText:a,createComment:c,setText:f,setElementText:p,parentNode:m,nextSibling:A,setScopeId:P=Ie,insertStaticContent:$}=e,I=(l,u,d,v=null,g=null,h=null,x=void 0,b=null,y=!!u.dynamicChildren)=>{if(l===u)return;l&&!_t(l,u)&&(v=$t(l),Le(l,g,h,!0),l=null),u.patchFlag===-2&&(y=!1,u.dynamicChildren=null);const{type:_,ref:R,shapeFlag:k}=u;switch(_){case ps:F(l,u,d,v);break;case Ue:O(l,u,d,v);break;case Ss:l==null&&D(u,d,v,x);break;case W:Dt(l,u,d,v,g,h,x,b,y);break;default:k&1?Z(l,u,d,v,g,h,x,b,y):k&6?Ft(l,u,d,v,g,h,x,b,y):(k&64||k&128)&&_.process(l,u,d,v,g,h,x,b,y,mt)}R!=null&&g?At(R,l&&l.ref,h,u||l,!u):R==null&&l&&l.ref!=null&&At(l.ref,null,h,l,!0)},F=(l,u,d,v)=>{if(l==null)n(u.el=a(u.children),d,v);else{const g=u.el=l.el;u.children!==l.children&&f(g,u.children)}},O=(l,u,d,v)=>{l==null?n(u.el=c(u.children||""),d,v):u.el=l.el},D=(l,u,d,v)=>{[l.el,l.anchor]=$(l.children,u,d,v,l.el,l.anchor)},j=({el:l,anchor:u},d,v)=>{let g;for(;l&&l!==u;)g=A(l),n(l,d,v),l=g;n(u,d,v)},S=({el:l,anchor:u})=>{let d;for(;l&&l!==u;)d=A(l),i(l),l=d;i(u)},Z=(l,u,d,v,g,h,x,b,y)=>{if(u.type==="svg"?x="svg":u.type==="math"&&(x="mathml"),l==null)xe(u,d,v,g,h,x,b,y);else{const _=l.el&&l.el._isVueCE?l.el:null;try{_&&_._beginPatch(),Nt(l,u,g,h,x,b,y)}finally{_&&_._endPatch()}}},xe=(l,u,d,v,g,h,x,b)=>{let y,_;const{props:R,shapeFlag:k,transition:M,dirs:w}=l;if(y=l.el=o(l.type,h,R&&R.is,R),k&8?p(y,l.children):k&16&&We(l.children,y,null,v,g,As(l,h),x,b),w&&Xe(l,null,v,"created"),ke(y,l,l.scopeId,x,v),R){for(const U in R)U!=="value"&&!xt(U)&&r(y,U,null,R[U],h,v);"value"in R&&r(y,"value",null,R.value,h),(_=R.onVnodeBeforeMount)&&Pe(_,v,l)}w&&Xe(l,null,v,"beforeMount");const G=wo(g,M);G&&M.beforeEnter(y),n(y,u,d),((_=R&&R.onVnodeMounted)||G||w)&&fe(()=>{try{_&&Pe(_,v,l),G&&M.enter(y),w&&Xe(l,null,v,"mounted")}finally{}},g)},ke=(l,u,d,v,g)=>{if(d&&P(l,d),v)for(let h=0;h<v.length;h++)P(l,v[h]);if(g){let h=g.subTree;if(u===h||Fi(h.type)&&(h.ssContent===u||h.ssFallback===u)){const x=g.vnode;ke(l,x,x.scopeId,x.slotScopeIds,g.parent)}}},We=(l,u,d,v,g,h,x,b,y=0)=>{for(let _=y;_<l.length;_++){const R=l[_]=b?Ne(l[_]):Re(l[_]);I(null,R,u,d,v,g,h,x,b)}},Nt=(l,u,d,v,g,h,x)=>{const b=u.el=l.el;let{patchFlag:y,dynamicChildren:_,dirs:R}=u;y|=l.patchFlag&16;const k=l.props||z,M=u.props||z;let w;if(d&&Qe(d,!1),(w=M.onVnodeBeforeUpdate)&&Pe(w,d,u,l),R&&Xe(u,l,d,"beforeUpdate"),d&&Qe(d,!0),(k.innerHTML&&M.innerHTML==null||k.textContent&&M.textContent==null)&&p(b,""),_?ze(l.dynamicChildren,_,b,d,v,As(u,g),h):x||J(l,u,b,null,d,v,As(u,g),h,!1),y>0){if(y&16)ft(b,k,M,d,g);else if(y&2&&k.class!==M.class&&r(b,"class",null,M.class,g),y&4&&r(b,"style",k.style,M.style,g),y&8){const G=u.dynamicProps;for(let U=0;U<G.length;U++){const B=G[U],ee=k[B],se=M[B];(se!==ee||B==="value")&&r(b,B,ee,se,g,d)}}y&1&&l.children!==u.children&&p(b,u.children)}else!x&&_==null&&ft(b,k,M,d,g);((w=M.onVnodeUpdated)||R)&&fe(()=>{w&&Pe(w,d,u,l),R&&Xe(u,l,d,"updated")},v)},ze=(l,u,d,v,g,h,x)=>{for(let b=0;b<u.length;b++){const y=l[b],_=u[b],R=y.el&&(y.type===W||!_t(y,_)||y.shapeFlag&198)?m(y.el):d;I(y,_,R,null,v,g,h,x,!0)}},ft=(l,u,d,v,g)=>{if(u!==d){if(u!==z)for(const h in u)!xt(h)&&!(h in d)&&r(l,h,u[h],null,g,v);for(const h in d){if(xt(h))continue;const x=d[h],b=u[h];x!==b&&h!=="value"&&r(l,h,b,x,g,v)}"value"in d&&r(l,"value",u.value,d.value,g)}},Dt=(l,u,d,v,g,h,x,b,y)=>{const _=u.el=l?l.el:a(""),R=u.anchor=l?l.anchor:a("");let{patchFlag:k,dynamicChildren:M,slotScopeIds:w}=u;w&&(b=b?b.concat(w):w),l==null?(n(_,d,v),n(R,d,v),We(u.children||[],d,R,g,h,x,b,y)):k>0&&k&64&&M&&l.dynamicChildren&&l.dynamicChildren.length===M.length?(ze(l.dynamicChildren,M,d,g,h,x,b),(u.key!=null||g&&u===g.subTree)&&ji(l,u,!0)):J(l,u,d,R,g,h,x,b,y)},Ft=(l,u,d,v,g,h,x,b,y)=>{u.slotScopeIds=b,l==null?u.shapeFlag&512?g.ctx.activate(u,d,v,x,y):ds(u,d,v,g,h,x,y):nn(l,u,y)},ds=(l,u,d,v,g,h,x)=>{const b=l.component=Go(l,v,g);if(bi(l)&&(b.ctx.renderer=mt),Ho(b,!1,x),b.asyncDep){if(g&&g.registerDep(b,le,x),!l.el){const y=b.subTree=Ee(Ue);O(null,y,u,d),l.placeholder=y.el}}else le(b,l,u,d,g,h,x)},nn=(l,u,d)=>{const v=u.component=l.component;if(xo(l,u,d))if(v.asyncDep&&!v.asyncResolved){X(v,u,d);return}else v.next=u,v.update();else u.el=l.el,v.vnode=u},le=(l,u,d,v,g,h,x)=>{const b=()=>{if(l.isMounted){let{next:k,bu:M,u:w,parent:G,vnode:U}=l;{const Se=Ni(l);if(Se){k&&(k.el=U.el,X(l,k,x)),Se.asyncDep.then(()=>{fe(()=>{l.isUnmounted||_()},g)});return}}let B=k,ee;Qe(l,!1),k?(k.el=U.el,X(l,k,x)):k=U,M&&gs(M),(ee=k.props&&k.props.onVnodeBeforeUpdate)&&Pe(ee,G,k,U),Qe(l,!0);const se=xn(l),Ae=l.subTree;l.subTree=se,I(Ae,se,m(Ae.el),$t(Ae),l,g,h),k.el=se.el,B===null&&ko(l,se.el),w&&fe(w,g),(ee=k.props&&k.props.onVnodeUpdated)&&fe(()=>Pe(ee,G,k,U),g)}else{let k;const{el:M,props:w}=u,{bm:G,m:U,parent:B,root:ee,type:se}=l,Ae=St(u);Qe(l,!1),G&&gs(G),!Ae&&(k=w&&w.onVnodeBeforeMount)&&Pe(k,B,u),Qe(l,!0);{ee.ce&&ee.ce._hasShadowRoot()&&ee.ce._injectChildStyle(se,l.parent?l.parent.type:void 0);const Se=l.subTree=xn(l);I(null,Se,d,v,l,g,h),u.el=Se.el}if(U&&fe(U,g),!Ae&&(k=w&&w.onVnodeMounted)){const Se=u;fe(()=>Pe(k,B,Se),g)}(u.shapeFlag&256||B&&St(B.vnode)&&B.vnode.shapeFlag&256)&&l.a&&fe(l.a,g),l.isMounted=!0,u=d=v=null}};l.scope.on();const y=l.effect=new Yn(b);l.scope.off();const _=l.update=y.run.bind(y),R=l.job=y.runIfDirty.bind(y);R.i=l,R.id=l.uid,y.scheduler=()=>Qs(R),Qe(l,!0),_()},X=(l,u,d)=>{u.component=l;const v=l.vnode.props;l.vnode=u,l.next=null,Ao(l,u.props,v,d),Co(l,u.children,d),$e(),mn(l),He()},J=(l,u,d,v,g,h,x,b,y=!1)=>{const _=l&&l.children,R=l?l.shapeFlag:0,k=u.children,{patchFlag:M,shapeFlag:w}=u;if(M>0){if(M&128){Gt(_,k,d,v,g,h,x,b,y);return}else if(M&256){Je(_,k,d,v,g,h,x,b,y);return}}w&8?(R&16&&dt(_,g,h),k!==_&&p(d,k)):R&16?w&16?Gt(_,k,d,v,g,h,x,b,y):dt(_,g,h,!0):(R&8&&p(d,""),w&16&&We(k,d,v,g,h,x,b,y))},Je=(l,u,d,v,g,h,x,b,y)=>{l=l||ot,u=u||ot;const _=l.length,R=u.length,k=Math.min(_,R);let M;for(M=0;M<k;M++){const w=u[M]=y?Ne(u[M]):Re(u[M]);I(l[M],w,d,null,g,h,x,b,y)}_>R?dt(l,g,h,!0,!1,k):We(u,d,v,g,h,x,b,y,k)},Gt=(l,u,d,v,g,h,x,b,y)=>{let _=0;const R=u.length;let k=l.length-1,M=R-1;for(;_<=k&&_<=M;){const w=l[_],G=u[_]=y?Ne(u[_]):Re(u[_]);if(_t(w,G))I(w,G,d,null,g,h,x,b,y);else break;_++}for(;_<=k&&_<=M;){const w=l[k],G=u[M]=y?Ne(u[M]):Re(u[M]);if(_t(w,G))I(w,G,d,null,g,h,x,b,y);else break;k--,M--}if(_>k){if(_<=M){const w=M+1,G=w<R?u[w].el:v;for(;_<=M;)I(null,u[_]=y?Ne(u[_]):Re(u[_]),d,G,g,h,x,b,y),_++}}else if(_>M)for(;_<=k;)Le(l[_],g,h,!0),_++;else{const w=_,G=_,U=new Map;for(_=G;_<=M;_++){const de=u[_]=y?Ne(u[_]):Re(u[_]);de.key!=null&&U.set(de.key,_)}let B,ee=0;const se=M-G+1;let Ae=!1,Se=0;const ht=new Array(se);for(_=0;_<se;_++)ht[_]=0;for(_=w;_<=k;_++){const de=l[_];if(ee>=se){Le(de,g,h,!0);continue}let Te;if(de.key!=null)Te=U.get(de.key);else for(B=G;B<=M;B++)if(ht[B-G]===0&&_t(de,u[B])){Te=B;break}Te===void 0?Le(de,g,h,!0):(ht[Te-G]=_+1,Te>=Se?Se=Te:Ae=!0,I(de,u[Te],d,null,g,h,x,b,y),ee++)}const an=Ae?Io(ht):ot;for(B=an.length-1,_=se-1;_>=0;_--){const de=G+_,Te=u[de],ln=u[de+1],cn=de+1<R?ln.el||Di(ln):v;ht[_]===0?I(null,Te,d,cn,g,h,x,b,y):Ae&&(B<0||_!==an[B]?Ye(Te,d,cn,2):B--)}}},Ye=(l,u,d,v,g=null)=>{const{el:h,type:x,transition:b,children:y,shapeFlag:_}=l;if(_&6){Ye(l.component.subTree,u,d,v);return}if(_&128){l.suspense.move(u,d,v);return}if(_&64){x.move(l,u,d,mt);return}if(x===W){n(h,u,d);for(let k=0;k<y.length;k++)Ye(y[k],u,d,v);n(l.anchor,u,d);return}if(x===Ss){j(l,u,d);return}if(v!==2&&_&1&&b)if(v===0)b.persisted&&!h[ks]?n(h,u,d):(b.beforeEnter(h),n(h,u,d),fe(()=>b.enter(h),g));else{const{leave:k,delayLeave:M,afterLeave:w}=b,G=()=>{l.ctx.isUnmounted?i(h):n(h,u,d)},U=()=>{const B=h._isLeaving||!!h[ks];h._isLeaving&&h[ks](!0),b.persisted&&!B?G():k(h,()=>{G(),w&&w()})};M?M(h,G,U):U()}else n(h,u,d)},Le=(l,u,d,v=!1,g=!1)=>{const{type:h,props:x,ref:b,children:y,dynamicChildren:_,shapeFlag:R,patchFlag:k,dirs:M,cacheIndex:w,memo:G}=l;if(k===-2&&(g=!1),b!=null&&($e(),At(b,null,d,l,!0),He()),w!=null&&(u.renderCache[w]=void 0),R&256){u.ctx.deactivate(l);return}const U=R&1&&M,B=!St(l);let ee;if(B&&(ee=x&&x.onVnodeBeforeUnmount)&&Pe(ee,u,l),R&6)Yi(l.component,d,v);else{if(R&128){l.suspense.unmount(d,v);return}U&&Xe(l,null,u,"beforeUnmount"),R&64?l.type.remove(l,u,d,mt,v):_&&!_.hasOnce&&(h!==W||k>0&&k&64)?dt(_,u,d,!1,!0):(h===W&&k&384||!g&&R&16)&&dt(y,u,d),v&&rn(l)}const se=G!=null&&w==null;(B&&(ee=x&&x.onVnodeUnmounted)||U||se)&&fe(()=>{ee&&Pe(ee,u,l),U&&Xe(l,null,u,"unmounted"),se&&(l.el=null)},d)},rn=l=>{const{type:u,el:d,anchor:v,transition:g}=l;if(u===W){Ji(d,v);return}if(u===Ss){S(l);return}const h=()=>{i(d),g&&!g.persisted&&g.afterLeave&&g.afterLeave()};if(l.shapeFlag&1&&g&&!g.persisted){const{leave:x,delayLeave:b}=g,y=()=>x(d,h);b?b(l.el,h,y):y()}else h()},Ji=(l,u)=>{let d;for(;l!==u;)d=A(l),i(l),l=d;i(u)},Yi=(l,u,d)=>{const{bum:v,scope:g,job:h,subTree:x,um:b,m:y,a:_}=l;An(y),An(_),v&&gs(v),g.stop(),h&&(h.flags|=8,Le(x,l,u,d)),b&&fe(b,u),fe(()=>{l.isUnmounted=!0},u)},dt=(l,u,d,v=!1,g=!1,h=0)=>{for(let x=h;x<l.length;x++)Le(l[x],u,d,v,g)},$t=l=>{if(l.shapeFlag&6)return $t(l.component.subTree);if(l.shapeFlag&128)return l.suspense.next();const u=A(l.anchor||l.el),d=u&&u[Kr];return d?A(d):u};let ms=!1;const on=(l,u,d)=>{let v;l==null?u._vnode&&(Le(u._vnode,null,null,!0),v=u._vnode.component):I(u._vnode||null,l,u,null,null,null,d),u._vnode=l,ms||(ms=!0,mn(v),di(),ms=!1)},mt={p:I,um:Le,m:Ye,r:rn,mt:ds,mc:We,pc:J,pbc:ze,n:$t,o:e};return{render:on,hydrate:void 0,createApp:ho(on)}}function As({type:e,props:t},s){return s==="svg"&&e==="foreignObject"||s==="mathml"&&e==="annotation-xml"&&t&&t.encoding&&t.encoding.includes("html")?void 0:s}function Qe({effect:e,job:t},s){s?(e.flags|=32,t.flags|=4):(e.flags&=-33,t.flags&=-5)}function wo(e,t){return(!e||e&&!e.pendingBranch)&&t&&!t.persisted}function ji(e,t,s=!1){const n=e.children,i=t.children;if(E(n)&&E(i))for(let r=0;r<n.length;r++){const o=n[r];let a=i[r];a.shapeFlag&1&&!a.dynamicChildren&&((a.patchFlag<=0||a.patchFlag===32)&&(a=i[r]=Ne(i[r]),a.el=o.el),!s&&a.patchFlag!==-2&&ji(o,a)),a.type===ps&&(a.patchFlag===-1&&(a=i[r]=Ne(a)),a.el=o.el),a.type===Ue&&!a.el&&(a.el=o.el)}}function Io(e){const t=e.slice(),s=[0];let n,i,r,o,a;const c=e.length;for(n=0;n<c;n++){const f=e[n];if(f!==0){if(i=s[s.length-1],e[i]<f){t[n]=i,s.push(n);continue}for(r=0,o=s.length-1;r<o;)a=r+o>>1,e[s[a]]<f?r=a+1:o=a;f<e[s[r]]&&(r>0&&(t[n]=s[r-1]),s[r]=n)}}for(r=s.length,o=s[r-1];r-- >0;)s[r]=o,o=t[o];return s}function Ni(e){const t=e.subTree.component;if(t)return t.asyncDep&&!t.asyncResolved?t:Ni(t)}function An(e){if(e)for(let t=0;t<e.length;t++)e[t].flags|=8}function Di(e){if(e.placeholder)return e.placeholder;const t=e.component;return t?Di(t.subTree):null}const Fi=e=>e.__isSuspense;function Eo(e,t){t&&t.pendingBranch?E(e)?t.effects.push(...e):t.effects.push(e):Gr(e)}const W=Symbol.for("v-fgt"),ps=Symbol.for("v-txt"),Ue=Symbol.for("v-cmt"),Ss=Symbol.for("v-stc"),Pt=[];let me=null;function T(e=!1){Pt.push(me=e?null:[])}function Oo(){Pt.pop(),me=Pt[Pt.length-1]||null}let It=1;function Sn(e,t=!1){It+=e,e<0&&me&&t&&(me.hasOnce=!0)}function Gi(e){return e.dynamicChildren=It>0?me||ot:null,Oo(),It>0&&me&&me.push(e),e}function C(e,t,s,n,i,r){return Gi(L(e,t,s,n,i,r,!0))}function Zt(e,t,s,n,i){return Gi(Ee(e,t,s,n,i,!0))}function $i(e){return e?e.__v_isVNode===!0:!1}function _t(e,t){return e.type===t.type&&e.key===t.key}const Hi=({key:e})=>e??null,Kt=({ref:e,ref_key:t,ref_for:s})=>(typeof e=="number"&&(e=""+e),e!=null?Q(e)||oe(e)||q(e)?{i:he,r:e,k:t,f:!!s}:e:null);function L(e,t=null,s=null,n=0,i=null,r=e===W?0:1,o=!1,a=!1){const c={__v_isVNode:!0,__v_skip:!0,type:e,props:t,key:t&&Hi(t),ref:t&&Kt(t),scopeId:hi,slotScopeIds:null,children:s,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:r,patchFlag:n,dynamicProps:i,dynamicChildren:null,appContext:null,ctx:he};return a?(sn(c,s),r&128&&e.normalize(c)):s&&(c.shapeFlag|=Q(s)?8:16),It>0&&!o&&me&&(c.patchFlag>0||r&6)&&c.patchFlag!==32&&me.push(c),c}const Ee=qo;function qo(e,t=null,s=null,n=0,i=null,r=!1){if((!e||e===oo)&&(e=Ue),$i(e)){const a=pt(e,t,!0);return s&&sn(a,s),It>0&&!r&&me&&(a.shapeFlag&6?me[me.indexOf(e)]=a:me.push(a)),a.patchFlag=-2,a}if(Ko(e)&&(e=e.__vccOpts),t){t=jo(t);let{class:a,style:c}=t;a&&!Q(a)&&(t.class=Ge(a)),K(c)&&(Xs(c)&&!E(c)&&(c=ae({},c)),t.style=os(c))}const o=Q(e)?1:Fi(e)?128:Ur(e)?64:K(e)?4:q(e)?2:0;return L(e,t,s,n,i,o,r,!0)}function jo(e){return e?Xs(e)||Ri(e)?ae({},e):e:null}function pt(e,t,s=!1,n=!1){const{props:i,ref:r,patchFlag:o,children:a,transition:c}=e,f=t?No(i||{},t):i,p={__v_isVNode:!0,__v_skip:!0,type:e.type,props:f,key:f&&Hi(f),ref:t&&t.ref?s&&r?E(r)?r.concat(Kt(t)):[r,Kt(t)]:Kt(t):r,scopeId:e.scopeId,slotScopeIds:e.slotScopeIds,children:a,target:e.target,targetStart:e.targetStart,targetAnchor:e.targetAnchor,staticCount:e.staticCount,shapeFlag:e.shapeFlag,patchFlag:t&&e.type!==W?o===-1?16:o|16:o,dynamicProps:e.dynamicProps,dynamicChildren:e.dynamicChildren,appContext:e.appContext,dirs:e.dirs,transition:c,component:e.component,suspense:e.suspense,ssContent:e.ssContent&&pt(e.ssContent),ssFallback:e.ssFallback&&pt(e.ssFallback),placeholder:e.placeholder,el:e.el,anchor:e.anchor,ctx:e.ctx,ce:e.ce};return c&&n&&Zs(p,c.clone(p)),p}function Vi(e=" ",t=0){return Ee(ps,null,e,t)}function te(e="",t=!1){return t?(T(),Zt(Ue,null,e)):Ee(Ue,null,e)}function Re(e){return e==null||typeof e=="boolean"?Ee(Ue):E(e)?Ee(W,null,e.slice()):$i(e)?Ne(e):Ee(ps,null,String(e))}function Ne(e){return e.el===null&&e.patchFlag!==-1||e.memo?e:pt(e)}function sn(e,t){let s=0;const{shapeFlag:n}=e;if(t==null)t=null;else if(E(t))s=16;else if(typeof t=="object")if(n&65){const i=t.default;i&&(i._c&&(i._d=!1),sn(e,i()),i._c&&(i._d=!0));return}else{s=32;const i=t._;!i&&!Ri(t)?t._ctx=he:i===3&&he&&(he.slots._===1?t._=1:(t._=2,e.patchFlag|=1024))}else q(t)?(t={default:t,_ctx:he},s=32):(t=String(t),n&64?(s=16,t=[Vi(t)]):s=8);e.children=t,e.shapeFlag|=s}function No(...e){const t={};for(let s=0;s<e.length;s++){const n=e[s];for(const i in n)if(i==="class")t.class!==n.class&&(t.class=Ge([t.class,n.class]));else if(i==="style")t.style=os([t.style,n.style]);else if(ss(i)){const r=t[i],o=n[i];o&&r!==o&&!(E(r)&&r.includes(o))?t[i]=r?[].concat(r,o):o:o==null&&r==null&&!ns(i)&&(t[i]=o)}else i!==""&&(t[i]=n[i])}return t}function Pe(e,t,s,n=null){be(e,t,7,[s,n])}const Do=Si();let Fo=0;function Go(e,t,s){const n=e.type,i=(t?t.appContext:e.appContext)||Do,r={uid:Fo++,vnode:e,type:n,parent:t,appContext:i,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new cr(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:t?t.provides:Object.create(i.provides),ids:t?t.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:Ii(n,i),emitsOptions:Ti(n,i),emit:null,emitted:null,propsDefaults:z,inheritAttrs:n.inheritAttrs,ctx:z,data:z,props:z,attrs:z,slots:z,refs:z,setupState:z,setupContext:null,suspense:s,suspenseId:s?s.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return r.ctx={_:r},r.root=t?t.root:r,r.emit=_o.bind(null,r),e.ce&&e.ce(r),r}let pe=null;const $o=()=>pe||he;let es,Ns;{const e=rs(),t=(s,n)=>{let i;return(i=e[s])||(i=e[s]=[]),i.push(n),r=>{i.length>1?i.forEach(o=>o(r)):i[0](r)}};es=t("__VUE_INSTANCE_SETTERS__",s=>pe=s),Ns=t("__VUE_SSR_SETTERS__",s=>Et=s)}const jt=e=>{const t=pe;return es(e),e.scope.on(),()=>{e.scope.off(),es(t)}},Tn=()=>{pe&&pe.scope.off(),es(null)};function Bi(e){return e.vnode.shapeFlag&4}let Et=!1;function Ho(e,t=!1,s=!1){t&&Ns(t);const{props:n,children:i}=e.vnode,r=Bi(e);Lo(e,n,r,t),Po(e,i,s||t);const o=r?Vo(e,t):void 0;return t&&Ns(!1),o}function Vo(e,t){const s=e.type;e.accessCache=Object.create(null),e.proxy=new Proxy(e.ctx,ao);const{setup:n}=s;if(n){$e();const i=e.setupContext=n.length>1?Wo(e):null,r=jt(e),o=qt(n,e,0,[e.props,i]),a=Hn(o);if(He(),r(),(a||e.sp)&&!St(e)&&yi(e),a){if(o.then(Tn,Tn),t)return o.then(c=>{Pn(e,c)}).catch(c=>{ls(c,e,0)});e.asyncDep=o}else Pn(e,o)}else Wi(e)}function Pn(e,t,s){q(t)?e.type.__ssrInlineRender?e.ssrRender=t:e.render=t:K(t)&&(e.setupState=ui(t)),Wi(e)}function Wi(e,t,s){const n=e.type;e.render||(e.render=n.render||Ie);{const i=jt(e);$e();try{lo(e)}finally{He(),i()}}}const Bo={get(e,t){return re(e,"get",""),e[t]}};function Wo(e){const t=s=>{e.exposed=s||{}};return{attrs:new Proxy(e.attrs,Bo),slots:e.slots,emit:e.emit,expose:t}}function fs(e){return e.exposed?e.exposeProxy||(e.exposeProxy=new Proxy(ui(Mr(e.exposed)),{get(t,s){if(s in t)return t[s];if(s in Tt)return Tt[s](e)},has(t,s){return s in t||s in Tt}})):e.proxy}function Ko(e){return q(e)&&"__vccOpts"in e}const rt=(e,t)=>Or(e,t,Et),Uo="3.5.38";/**
* @vue/runtime-dom v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let Ds;const Cn=typeof window<"u"&&window.trustedTypes;if(Cn)try{Ds=Cn.createPolicy("vue",{createHTML:e=>e})}catch{}const Ki=Ds?e=>Ds.createHTML(e):e=>e,zo="http://www.w3.org/2000/svg",Jo="http://www.w3.org/1998/Math/MathML",je=typeof document<"u"?document:null,Mn=je&&je.createElement("template"),Yo={insert:(e,t,s)=>{t.insertBefore(e,s||null)},remove:e=>{const t=e.parentNode;t&&t.removeChild(e)},createElement:(e,t,s,n)=>{const i=t==="svg"?je.createElementNS(zo,e):t==="mathml"?je.createElementNS(Jo,e):s?je.createElement(e,{is:s}):je.createElement(e);return e==="select"&&n&&n.multiple!=null&&i.setAttribute("multiple",n.multiple),i},createText:e=>je.createTextNode(e),createComment:e=>je.createComment(e),setText:(e,t)=>{e.nodeValue=t},setElementText:(e,t)=>{e.textContent=t},parentNode:e=>e.parentNode,nextSibling:e=>e.nextSibling,querySelector:e=>je.querySelector(e),setScopeId(e,t){e.setAttribute(t,"")},insertStaticContent(e,t,s,n,i,r){const o=s?s.previousSibling:t.lastChild;if(i&&(i===r||i.nextSibling))for(;t.insertBefore(i.cloneNode(!0),s),!(i===r||!(i=i.nextSibling)););else{Mn.innerHTML=Ki(n==="svg"?`<svg>${e}</svg>`:n==="mathml"?`<math>${e}</math>`:e);const a=Mn.content;if(n==="svg"||n==="mathml"){const c=a.firstChild;for(;c.firstChild;)a.appendChild(c.firstChild);a.removeChild(c)}t.insertBefore(a,s)}return[o?o.nextSibling:t.firstChild,s?s.previousSibling:t.lastChild]}},Xo=Symbol("_vtc");function Qo(e,t,s){const n=e[Xo];n&&(t=(t?[t,...n]:[...n]).join(" ")),t==null?e.removeAttribute("class"):s?e.setAttribute("class",t):e.className=t}const ts=Symbol("_vod"),Ui=Symbol("_vsh"),zi={name:"show",beforeMount(e,{value:t},{transition:s}){e[ts]=e.style.display==="none"?"":e.style.display,s&&t?s.beforeEnter(e):vt(e,t)},mounted(e,{value:t},{transition:s}){s&&t&&s.enter(e)},updated(e,{value:t,oldValue:s},{transition:n}){!t!=!s&&(n?t?(n.beforeEnter(e),vt(e,!0),n.enter(e)):n.leave(e,()=>{vt(e,!1)}):vt(e,t))},beforeUnmount(e,{value:t}){vt(e,t)}};function vt(e,t){e.style.display=t?e[ts]:"none",e[Ui]=!t}const Zo=Symbol(""),ea=/(?:^|;)\s*display\s*:/;function ta(e,t,s){const n=e.style,i=Q(s);let r=!1;if(s&&!i){if(t)if(Q(t))for(const o of t.split(";")){const a=o.slice(0,o.indexOf(":")).trim();s[a]==null&&bt(n,a,"")}else for(const o in t)s[o]==null&&bt(n,o,"");for(const o in s){o==="display"&&(r=!0);const a=s[o];a!=null?na(e,o,!Q(t)&&t?t[o]:void 0,a)||bt(n,o,a):bt(n,o,"")}}else if(i){if(t!==s){const o=n[Zo];o&&(s+=";"+o),n.cssText=s,r=ea.test(s)}}else t&&e.removeAttribute("style");ts in e&&(e[ts]=r?n.display:"",e[Ui]&&(n.display="none"))}const Rn=/\s*!important$/;function bt(e,t,s){if(E(s))s.forEach(n=>bt(e,t,n));else if(s==null&&(s=""),t.startsWith("--"))e.setProperty(t,s);else{const n=sa(e,t);Rn.test(s)?e.setProperty(st(n),s.replace(Rn,""),"important"):e[n]=s}}const wn=["Webkit","Moz","ms"],Ts={};function sa(e,t){const s=Ts[t];if(s)return s;let n=_e(t);if(n!=="filter"&&n in e)return Ts[t]=n;n=Wn(n);for(let i=0;i<wn.length;i++){const r=wn[i]+n;if(r in e)return Ts[t]=r}return t}function na(e,t,s,n){return e.tagName==="TEXTAREA"&&(t==="width"||t==="height")&&Q(n)&&s===n}const In="http://www.w3.org/1999/xlink";function En(e,t,s,n,i,r=ar(t)){n&&t.startsWith("xlink:")?s==null?e.removeAttributeNS(In,t.slice(6,t.length)):e.setAttributeNS(In,t,s):s==null||r&&!Un(s)?e.removeAttribute(t):e.setAttribute(t,r?"":Oe(s)?String(s):s)}function On(e,t,s,n,i){if(t==="innerHTML"||t==="textContent"){s!=null&&(e[t]=t==="innerHTML"?Ki(s):s);return}const r=e.tagName;if(t==="value"&&r!=="PROGRESS"&&!r.includes("-")){const a=r==="OPTION"?e.getAttribute("value")||"":e.value,c=s==null?e.type==="checkbox"?"on":"":String(s);(a!==c||!("_value"in e))&&(e.value=c),s==null&&e.removeAttribute(t),e._value=s;return}let o=!1;if(s===""||s==null){const a=typeof e[t];a==="boolean"?s=Un(s):s==null&&a==="string"?(s="",o=!0):a==="number"&&(s=0,o=!0)}try{e[t]=s}catch{}o&&e.removeAttribute(i||t)}function ia(e,t,s,n){e.addEventListener(t,s,n)}function ra(e,t,s,n){e.removeEventListener(t,s,n)}const qn=Symbol("_vei");function oa(e,t,s,n,i=null){const r=e[qn]||(e[qn]={}),o=r[t];if(n&&o)o.value=n;else{const[a,c]=aa(t);if(n){const f=r[t]=ua(n,i);ia(e,a,f,c)}else o&&(ra(e,a,o,c),r[t]=void 0)}}const jn=/(?:Once|Passive|Capture)$/;function aa(e){let t;if(jn.test(e)){t={};let n;for(;n=e.match(jn);)e=e.slice(0,e.length-n[0].length),t[n[0].toLowerCase()]=!0}return[e[2]===":"?e.slice(3):st(e.slice(2)),t]}let Ps=0;const la=Promise.resolve(),ca=()=>Ps||(la.then(()=>Ps=0),Ps=Date.now());function ua(e,t){const s=n=>{if(!n._vts)n._vts=Date.now();else if(n._vts<=s.attached)return;const i=s.value;if(E(i)){const r=n.stopImmediatePropagation;n.stopImmediatePropagation=()=>{r.call(n),n._stopped=!0};const o=i.slice(),a=[n];for(let c=0;c<o.length&&!n._stopped;c++){const f=o[c];f&&be(f,t,5,a)}}else be(i,t,5,[n])};return s.value=e,s.attached=ca(),s}const Nn=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&e.charCodeAt(2)>96&&e.charCodeAt(2)<123,pa=(e,t,s,n,i,r)=>{const o=i==="svg";t==="class"?Qo(e,n,o):t==="style"?ta(e,s,n):ss(t)?ns(t)||oa(e,t,s,n,r):(t[0]==="."?(t=t.slice(1),!0):t[0]==="^"?(t=t.slice(1),!1):fa(e,t,n,o))?(On(e,t,n),!e.tagName.includes("-")&&(t==="value"||t==="checked"||t==="selected")&&En(e,t,n,o,r,t!=="value")):e._isVueCE&&(da(e,t)||e._def.__asyncLoader&&(/[A-Z]/.test(t)||!Q(n)))?On(e,_e(t),n,r,t):(t==="true-value"?e._trueValue=n:t==="false-value"&&(e._falseValue=n),En(e,t,n,o))};function fa(e,t,s,n){if(n)return!!(t==="innerHTML"||t==="textContent"||t in e&&Nn(t)&&q(s));if(t==="spellcheck"||t==="draggable"||t==="translate"||t==="autocorrect"||t==="sandbox"&&e.tagName==="IFRAME"||t==="form"||t==="list"&&e.tagName==="INPUT"||t==="type"&&e.tagName==="TEXTAREA")return!1;if(t==="width"||t==="height"){const i=e.tagName;if(i==="IMG"||i==="VIDEO"||i==="CANVAS"||i==="SOURCE")return!1}return Nn(t)&&Q(s)?!1:t in e}function da(e,t){const s=e._def.props;if(!s)return!1;const n=_e(t);return Array.isArray(s)?s.some(i=>_e(i)===n):Object.keys(s).some(i=>_e(i)===n)}const ma=ae({patchProp:pa},Yo);let Dn;function ha(){return Dn||(Dn=Mo(ma))}const ga=((...e)=>{const t=ha().createApp(...e),{mount:s}=t;return t.mount=n=>{const i=va(n);if(!i)return;const r=t._component;!q(r)&&!r.render&&!r.template&&(r.template=i.innerHTML),i.nodeType===1&&(i.textContent="");const o=s(i,!1,_a(i));return i instanceof Element&&(i.removeAttribute("v-cloak"),i.setAttribute("data-v-app","")),o},t});function _a(e){if(e instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&e instanceof MathMLElement)return"mathml"}function va(e){return Q(e)?document.querySelector(e):e}const Fs={header:{title:"AI 学习笔记",subtitle:"AI Engineering from Scratch · 从零开始"},days:[{id:1,label:"Day 1",date:"2026年6月17日 · 基础入门",locked:!0,footer:"Day 1 · 2026-06-17 · 🔒 已锁定",progress:{label:"当前进度",detail:"Phase 11 · 已学 6/22 课",percent:28,text:"~30h / 209h",desc:"环境搭建 → LLM 工程 → 工具协议 → Agent → 多智能体 → 生产部署"},sections:[{emoji:"🛠",title:"1. 环境搭建",tag:"完成",blocks:[{type:"list",items:['配置了公司的 Anthropic 兼容 API：<span class="highlight">base_url=http://llmapi.bilibili.co</span>',"安装了 Python 包：anthropic, openai, sentence-transformers, numpy","跑通了第一次 API 调用"]},{type:"code",code:'client = anthropic.Anthropic(api_key="...", base_url="http://llmapi.bilibili.co")'}]},{emoji:"📝",title:"2. Prompt 工程",tag:"Phase 11-01",blocks:[{type:"list",items:["<strong>System Message</strong> — 设置身份和全局规则","<strong>User Message</strong> — 具体任务","<strong>Assistant Prefill</strong> — 预先写回复开头，控制输出格式","角色越具体，输出质量越高"]}]},{emoji:"💡",title:"3. Few-Shot & 思维链",tag:"Phase 11-02",blocks:[{type:"table",headers:["技术","做法","适用场景"],rows:[["Few-Shot","先给 3-5 个例子再问","格式敏感任务"],["Chain-of-Thought",'加"请一步一步思考"',"数学、逻辑推理"],["Self-Consistency","跑多次取多数答案","高准确率要求"],["Tree-of-Thought","多条路径探索评估选最优","复杂规划问题"]]}]},{emoji:"📋",title:"4. 结构化输出",tag:"Phase 11-03",blocks:[{type:"list",items:["应用需要 JSON，模型给的是自然语言 → 需要告诉模型格式",'3 种方式：Prompt 说"返回JSON" → 给 JSON 模板 → JSON 模板 + try/except','<span class="highlight">try/except</span> 捕获 JSON 解析失败，兜底处理']}]},{emoji:"🔢",title:"5. Embeddings",tag:"Phase 11-04",blocks:[{type:"list",items:["<strong>Embedding</strong> = 把文字转成一串数字（向量）","意思相近的文字 → 向量距离近 → 余弦相似度高",'中文用 <span class="highlight">shibing624/text2vec-base-chinese</span>']},{type:"code",code:"相似度 = (向量A · 向量B) / (|向量A| × |向量B|)"}]},{emoji:"📐",title:"6. 上下文工程",tag:"Phase 11-05",blocks:[{type:"list",items:["上下文窗口是稀缺资源，不是越大越好","<strong>Lost-in-the-Middle</strong> — 模型最关注开头和结尾","<strong>三明治原则：</strong>重要信息放开头和结尾"]},{type:"code",code:"System → 工具定义 → 检索文档 → 对话历史 → 当前问题 → 最后指令"}]},{emoji:"📚",title:"7. RAG 检索增强生成",tag:"Phase 11-06",blocks:[{type:"list",items:["<strong>RAG 四步：</strong>文档向量化 → 问题转向量 → 搜索最相似文档 → 文档+问题一起给模型","比微调便宜百倍，数据随时更新，可追溯来源"]},{type:"code",code:"相似度 = (doc_vectors @ q_vec.T).flatten() / (norm_doc * norm_q)"}]},{emoji:"⚡",title:"8. 高级 RAG",tag:"Phase 11-07",blocks:[{type:"table",headers:["改进","做法"],rows:[["关键词提权","向量相似度 + 命中关键词加分"],["兜底搜索","向量搜不到就换关键词搜"],["误判过滤","相似度低于阈值的文档不用"]]}]},{emoji:"⚙️",title:"9. Function Calling",tag:"Phase 11-09",blocks:[{type:"list",items:['模型输出结构化 JSON 说"我要调什么函数、参数是什么"',"<strong>你的代码执行工具，模型只做决策</strong>","完整 6 步循环：定义工具 → 传给模型 → 模型决定用哪个 → 代码执行 → 结果还回 → 模型最终回答"]}]},{emoji:"💰",title:"10. 缓存与成本优化",tag:"Phase 11-11",blocks:[{type:"list",items:["40-60% 的提问是同一意思换说法 → <strong>语义缓存</strong>","问题转向量，相似度超过阈值就返回缓存结果，不调 API"]}]},{emoji:"🐍",title:"Python 基础语法（Day 1 遇到的）",blocks:[{type:"table",headers:["语法","作用","例子"],rows:[["def","定义函数","def 加法(a,b): return a+b"],["for x in 列表","遍历",'for 水果 in ["苹果"]:'],["if/else","条件判断","if 分数 > 0.8:"],["try/except","捕获错误","try: json.loads(x)"],['f"你好{名字}"',"字符串嵌入变量",'f"温度是{度}度"']]}]}]},{id:2,label:"Day 2",date:"2026年6月18日 · RAG 文档管理 + PDF 处理 + LoRA 微调",locked:!1,footer:"Day 2 · 2026-06-18 · PDF 处理 + LoRA 微调实战",keyPoint:{title:"今日核心问题",highlights:["文档中的表格和图片怎么存到 RAG 里？","怎么用 LoRA 微调模型改变它的回答风格？"],desc:"上午跑通了 RAG 文档更新方案的完整链路，下午从原理到手写代码到 Colab 实战，完整跑通了 LoRA 微调。"},sections:[{emoji:"🔄",title:"1. 文档更新了怎么办？",blocks:[{type:"table",headers:["方案","做法","适合场景"],rows:[["删旧重新编","更新文档 → 删旧向量 → 重新 encode","单篇更新，最常用"],["定时全量重建","每天凌晨全部重新向量化","文档稳定，实时性不高"],["事件驱动","文档系统主动通知（webhook）","有飞书/语雀平台"]]}]},{emoji:"🔍",title:"2. 怎么知道文档变没变？",blocks:[{type:"table",headers:["方法","粒度","速度","原理"],rows:[['<span class="highlight">mtime</span>',"整个文件","几毫秒","读文件修改时间戳"],['<span class="highlight">MD5</span>',"每个内容块","需要读内容","算文本哈希值"]]}]},{emoji:"🧩",title:'3. 文档怎么"切块"存？',blocks:[{type:"code",code:`原始文档（3000字）
...
if __name__ == "__main__":
    run_demo()
`,error:"",lineCount:511,truncated:!1}},La={class:"emoji"},Aa={key:0,class:"tag"},Sa=["innerHTML"],Ta={key:1,class:"section-subtitle"},Pa={key:2},Ca=["innerHTML"],Ma=["innerHTML"],Ra={key:4,class:"code-ref"},wa=["onClick"],Ia={class:"code-ref-arrow"},Ea={class:"code-ref-file"},Oa={key:0,class:"code-ref-meta"},qa={key:1,class:"code-ref-label"},ja={class:"code-ref-body"},Na={key:0,class:"code-ref-error"},Da={class:"code-ref-pre"},Fa={key:0,class:"code-ref-trunc"},Ga={key:5,class:"table-wrap"},$a=["innerHTML"],Ha=["innerHTML"],Va={key:6,class:"flow"},Ba={class:"label"},Wa={class:"desc"},Ka={key:7},Ua={class:"qa-q"},za={class:"qa-a"},Ja={__name:"SectionCard",props:{section:{type:Object,required:!0}},setup(e){const t=Ut({});function s(i){t.value[i]=!t.value[i]}function n(i){const r=i.lines?`${i.file}#${i.lines}`:i.file;return ka[r]||{code:"",error:`未找到源码：${i.file}（重新 build 试试）`,lineCount:0}}return(i,r)=>(T(),C("div",{class:Ge(["section",{"accent-border":e.section.accentBorder}])},[L("h2",null,[L("span",La,N(e.section.emoji),1),Vi(" "+N(e.section.title)+" ",1),e.section.tag?(T(),C("span",Aa,N(e.section.tag),1)):te("",!0)]),(T(!0),C(W,null,ie(e.section.blocks,(o,a)=>(T(),C(W,{key:a},[o.type==="text"?(T(),C("p",{key:0,class:Ge(o.style||""),innerHTML:o.text},null,10,Sa)):te("",!0),o.type==="subtitle"?(T(),C("p",Ta,N(o.text),1)):te("",!0),o.type==="list"?(T(),C("ul",Pa,[(T(!0),C(W,null,ie(o.items,(c,f)=>(T(),C("li",{key:f,innerHTML:c},null,8,Ca))),128))])):te("",!0),o.type==="code"?(T(),C("div",{key:3,class:"code",innerHTML:o.code},null,8,Ma)):te("",!0),o.type==="codeRef"?(T(),C("div",Ra,[L("button",{class:"code-ref-head",onClick:c=>s(a)},[L("span",Ia,N(t.value[a]?"▼":"▶"),1),L("span",Ea,N(o.file),1),n(o).lineCount?(T(),C("span",Oa,N(n(o).lineCount)+" 行",1)):te("",!0),o.label?(T(),C("span",qa,"— "+N(o.label),1)):te("",!0)],8,wa),gi(L("div",ja,[n(o).error?(T(),C("p",Na,N(n(o).error),1)):(T(),C(W,{key:1},[L("pre",Da,[L("code",null,N(n(o).code),1)]),n(o).truncated?(T(),C("p",Fa,"… 仅显示前若干行，完整源码见仓库 "+N(o.file),1)):te("",!0)],64))],512),[[zi,t.value[a]]])])):te("",!0),o.type==="table"?(T(),C("div",Ga,[L("table",null,[L("tr",null,[(T(!0),C(W,null,ie(o.headers,(c,f)=>(T(),C("th",{key:f,innerHTML:c},null,8,$a))),128))]),(T(!0),C(W,null,ie(o.rows,(c,f)=>(T(),C("tr",{key:f},[(T(!0),C(W,null,ie(c,(p,m)=>(T(),C("td",{key:m,innerHTML:p},null,8,Ha))),128))]))),128))])])):te("",!0),o.type==="flow"?(T(),C("div",Va,[(T(!0),C(W,null,ie(o.steps,(c,f)=>(T(),C("div",{key:f,class:"flow-step"},[L("span",Ba,N(c.label),1),r[0]||(r[0]=L("br",null,null,-1)),L("span",Wa,N(c.desc),1)]))),128))])):te("",!0),o.type==="qa"?(T(),C("div",Ka,[(T(!0),C(W,null,ie(o.items,(c,f)=>(T(),C("div",{key:f,class:"qa-item"},[L("p",Ua,[L("strong",null,"Q: "+N(c.q),1)]),L("p",za,N(c.a),1)]))),128))])):te("",!0)],64))),128))],2))}},Ya={class:"day-content"},Xa={class:"day-header"},Qa={class:"date"},Za={key:0,class:"lock-badge"},el={key:0,class:"progress-container"},tl={class:"progress-header"},sl={class:"progress-bar"},nl={class:"progress-desc"},il={key:1,class:"key-point"},rl={class:"highlight"},ol={class:"footer"},al={__name:"DayContent",props:{day:{type:Object,required:!0},active:{type:Boolean,default:!1}},setup(e){return(t,s)=>gi((T(),C("div",Ya,[L("div",Xa,[L("span",Qa,N(e.day.date),1),e.day.locked?(T(),C("span",Za,"🔒 已锁定")):te("",!0)]),e.day.progress?(T(),C("div",el,[L("div",tl,[L("span",null,N(e.day.progress.label),1),L("span",null,N(e.day.progress.detail),1)]),L("div",sl,[L("div",{class:"progress-fill",style:os({width:e.day.progress.percent+"%"})},N(e.day.progress.text),5)]),L("div",nl,N(e.day.progress.desc),1)])):te("",!0),e.day.keyPoint?(T(),C("div",il,[L("p",null,[L("strong",null,N(e.day.keyPoint.title),1)]),(T(!0),C(W,null,ie(e.day.keyPoint.highlights,(n,i)=>(T(),C("p",{key:i,style:{"font-size":"1.05rem","text-align":"center",padding:"12px 0"}},[L("span",rl,N(n),1)]))),128)),L("p",null,N(e.day.keyPoint.desc),1)])):te("",!0),(T(!0),C(W,null,ie(e.day.sections,(n,i)=>(T(),Zt(Ja,{key:i,section:n},null,8,["section"]))),128)),L("div",ol,N(e.day.footer),1)],512)),[[zi,e.active]])}},Fn=[{id:"rag-basic",title:"RAG 基本流程",description:"从文档库到 LLM 回答的完整 RAG 流程",steps:[{name:"初始化文档库",description:"准备要检索的文档列表，每个文档是一段知识",code:`文档库 = [
...
阈值 0.95 → 1条自动(10%) 9条人工   # 只放行最确定的`,highlightLines:[1,2,3],variables:[{name:"一级客服",value:"分错代价低→阈值可低(0.6~0.7)"},{name:"退款/账户",value:"分错代价高→阈值调高(0.9)"}],output:"阈值↑ 转人工↑(准但贵)；阈值↓ 自动↑(省但险)"},{name:"4. 生产级分类是分层的",description:'LLM 会"自信地错"(高置信但答错)，所以路由主力不是 LLM，而是便宜可靠的小模型 + 分层兜底。',code:`消息进来：
  ...
  仍低于阈值      → 升级人工`,highlightLines:[2,3,4,5],variables:[{name:"为啥不都用LLM",value:"路由高频调用，大LLM太贵太慢"},{name:"置信度谁更可信",value:"embedding+小模型 > LLM自报"}],output:"✅ 规则→小模型→LLM→人工，分层组合；置信度阈值是最后一道分流闸"}]}],ll=(e,t)=>{const s=e.__vccOpts||e;for(const[n,i]of t)s[n]=i;return s},cl={class:"practice-view"},ul={class:"experiment-tabs"},pl=["onClick"],fl={key:0,class:"debugger"},dl={class:"step-indicator"},ml=["onClick"],hl={class:"step-label"},gl={class:"debugger-main"},_l={class:"code-panel"},vl={class:"code-block"},yl={class:"cursor-line",ref:"cursorRef"},bl={class:"right-sidebar"},xl={class:"state-panel"},kl={class:"state-body"},Ll={class:"state-name"},Al={class:"state-value"},Sl={key:0,class:"params-panel"},Tl={class:"params-body"},Pl={class:"param-name"},Cl={class:"param-val"},Ml={class:"param-desc"},Rl={key:1,class:"sidebar-output"},wl={class:"output-text"},Il={class:"step-desc"},El={class:"debug-controls"},Ol=["disabled"],ql=["disabled"],jl=["disabled"],Nl=["disabled"],Dl={key:1,class:"empty-state"},Fl={__name:"PracticeView",setup(e){const t=Ut(null),s=Ut(0);function n(F){t.value=Fn.find(O=>O.id===F),s.value=0}const i=rt(()=>t.value?t.value.steps[s.value]:{variables:[],output:null,name:"",description:""}),r=rt(()=>t.value?i.value.code.split(`
`):[]);function o(F){const O=i.value.highlightLines;return O&&O.includes(F)}const a=rt(()=>t.value?t.value.steps.length-1:0),c=rt(()=>s.value+1<=a.value),f=rt(()=>s.value>0);function p(){s.value<a.value&&s.value++}function m(){s.value>0&&s.value--}function A(F){F>=0&&F<=a.value&&(s.value=F)}function P(){const F=Math.min(s.value+3,a.value);s.value=F}function $(){const F=Math.max(s.value-3,0);s.value=F}function I(){s.value=0}return(F,O)=>{var D;return T(),C("div",cl,[L("div",ul,[(T(!0),C(W,null,ie(Rt(Fn),j=>{var S;return T(),C("button",{key:j.id,class:Ge(["exp-btn",{active:((S=t.value)==null?void 0:S.id)===j.id}]),onClick:Z=>n(j.id)},N(j.title),11,pl)}),128))]),t.value?(T(),C("div",fl,[L("div",dl,[(T(!0),C(W,null,ie(t.value.steps,(j,S)=>(T(),C("div",{key:S,class:Ge(["step-dot",{active:s.value===S,done:s.value>S}]),onClick:Z=>A(S)},null,10,ml))),128)),L("span",hl,N(s.value+1)+" / "+N(t.value.steps.length),1)]),L("div",gl,[L("div",_l,[O[0]||(O[0]=L("div",{class:"panel-header"},"📄 代码",-1)),L("pre",vl,[(T(!0),C(W,null,ie(r.value,(j,S)=>(T(),C("code",{key:S,class:Ge({highlight:o(S+1)})},N(j),3))),128)),L("span",yl,null,512)])]),L("div",bl,[L("div",xl,[O[2]||(O[2]=L("div",{class:"panel-header"},"📊 变量状态",-1)),L("div",kl,[(T(!0),C(W,null,ie(i.value.variables,(j,S)=>(T(),C("div",{key:S,class:"state-row"},[L("span",Ll,N(j.name),1),O[1]||(O[1]=L("span",{class:"state-eq"},"=",-1)),L("span",Al,N(j.value),1)]))),128))])]),(D=i.value.params)!=null&&D.length?(T(),C("div",Sl,[O[3]||(O[3]=L("div",{class:"panel-header"},"💡 参数说明",-1)),L("div",Tl,[(T(!0),C(W,null,ie(i.value.params,(j,S)=>(T(),C("div",{key:S,class:"param-row"},[L("span",Pl,N(j.name),1),L("span",Cl,N(j.value),1),L("span",Ml,N(j.desc),1)]))),128))])])):te("",!0),i.value.output?(T(),C("div",Rl,[O[4]||(O[4]=L("div",{class:"panel-header"},"📋 输出",-1)),L("pre",wl,N(i.value.output),1)])):te("",!0),L("div",Il,[L("strong",null,N(i.value.name),1),L("p",null,N(i.value.description),1)]),L("div",El,[L("button",{class:"ctrl-btn",disabled:s.value===0,onClick:m},"◀ 上一步",8,Ol),L("button",{class:"ctrl-btn",disabled:!f.value,onClick:$},"⏪ 回退",8,ql),L("button",{class:"ctrl-btn",onClick:I},"🔄 重置"),L("button",{class:"ctrl-btn",disabled:!c.value,onClick:P},"⏭ 跳过",8,jl),L("button",{class:"ctrl-btn primary",disabled:s.value===a.value,onClick:p},"下一步 ▶",8,Nl)])])])])):(T(),C("div",Dl,[...O[5]||(O[5]=[L("p",null,"选择一个实验开始 👆",-1)])]))])}}},Gl=ll(Fl,[["__scopeId","data-v-d294aa85"]]),$l={class:"container"},Hl={class:"tabs-wrap"},Vl={class:"tabs"},Bl=["onClick"],Wl={__name:"App",setup(e){const t=Fs.days,s=Ut(t[t.length-1].id),n=[...t.map(i=>({id:i.id,label:i.label})),{id:"practice",label:"实践"}];return(i,r)=>(T(),C("div",$l,[Ee(xa),L("div",Hl,[L("div",Vl,[(T(),C(W,null,ie(n,o=>L("button",{key:o.id,class:Ge(["tab-btn",{active:s.value===o.id}]),onClick:a=>s.value=o.id},N(o.label),11,Bl)),64))])]),(T(!0),C(W,null,ie(Rt(t),o=>(T(),C(W,{key:o.id},[s.value===o.id?(T(),Zt(al,{key:0,day:o,active:!0},null,8,["day"])):te("",!0)],64))),128)),s.value==="practice"?(T(),Zt(Gl,{key:0})):te("",!0)]))}};ga(Wl).mount("#app");
